...
/**
 * Base class that represents a row from the 'vehicle_catalog' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class VehicleItem implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\VehicleItemTableMap';
    ...
    /**
     * Initializes internal state of Base\VehicleItem object.
     */
    ...
    /**
     * Compares this with another <code>VehicleItem</code> instance.  If
     * <code>obj</code> is an instance of <code>VehicleItem</code>, delegates to
     * <code>equals(VehicleItem)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|VehicleItem The current object, for fluid interface
     */
    ...
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_ID] = true;
        }
    ...
    public function setCatalog($v)
    {
        ...
        if ($this->catalog !== $v) {
            $this->catalog = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_CATALOG] = true;
        }
    ...
    public function setFromyear($v)
    {
        ...
        if ($this->fromyear !== $v) {
            $this->fromyear = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_FROMYEAR] = true;
        }
    ...
    public function setThroughyear($v)
    {
        ...
        if ($this->throughyear !== $v) {
            $this->throughyear = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_THROUGHYEAR] = true;
        }
    ...
    public function setMake($v)
    {
        ...
        if ($this->make !== $v) {
            $this->make = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_MAKE] = true;
        }
    ...
    public function setEngine($v)
    {
        ...
        if ($this->engine !== $v) {
            $this->engine = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_ENGINE] = true;
        }
    ...
    public function setModel($v)
    {
        ...
        if ($this->model !== $v) {
            $this->model = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_MODEL] = true;
        }
    ...
    public function setSubmodel($v)
    {
        ...
        if ($this->submodel !== $v) {
            $this->submodel = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_SUBMODEL] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_ITEMID] = true;
        }
    ...
    public function setnotes($v)
    {
        ...
        if ($this->notes !== $v) {
            $this->notes = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_NOTES] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[VehicleItemTableMap::COL_TIME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : VehicleItemTableMap::translateFieldName('Id', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildVehicleItemQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see VehicleItem::setDeleted()
     * @see VehicleItem::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildVehicleItemQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                VehicleItemTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_ID)) {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_THROUGHYEAR)) {
            $modifiedColumns[':p' . $index++]  = 'throughyear';
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_MAKE)) {
            $modifiedColumns[':p' . $index++]  = 'make';
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_ENGINE)) {
            $modifiedColumns[':p' . $index++]  = 'engine';
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_MODEL)) {
            $modifiedColumns[':p' . $index++]  = 'model';
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_SUBMODEL)) {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }

        $sql = sprintf(
            'INSERT INTO vehicle_catalog (%s) VALUES (%s)',
    ...
    {
        $pos = VehicleItemTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['VehicleItem'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['VehicleItem'][$this->hashCode()] = true;
        $keys = VehicleItemTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_ID)) {
            $criteria->add(VehicleItemTableMap::COL_ID, $this->id);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_CATALOG)) {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_THROUGHYEAR)) {
            $criteria->add(VehicleItemTableMap::COL_THROUGHYEAR, $this->throughyear);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_MAKE)) {
            $criteria->add(VehicleItemTableMap::COL_MAKE, $this->make);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_ENGINE)) {
            $criteria->add(VehicleItemTableMap::COL_ENGINE, $this->engine);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_MODEL)) {
            $criteria->add(VehicleItemTableMap::COL_MODEL, $this->model);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_SUBMODEL)) {
            $criteria->add(VehicleItemTableMap::COL_SUBMODEL, $this->submodel);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_ITEMID)) {
        ...
        if ($this->isColumnModified(VehicleItemTableMap::COL_DATE)) {
            $criteria->add(VehicleItemTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(VehicleItemTableMap::COL_TIME)) {
            $criteria->add(VehicleItemTableMap::COL_TIME, $this->time);
        }
    ...
    {
        $criteria = ChildVehicleItemQuery::create();
        $criteria->add(VehicleItemTableMap::COL_ID, $this->id);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \VehicleItem (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \VehicleItem Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(VehicleItemTableMap::DEFAULT_STRING_FORMAT);
    }
