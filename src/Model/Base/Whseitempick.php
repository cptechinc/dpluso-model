...
/**
 * Base class that represents a row from the 'whseitempick' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Whseitempick implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\WhseitempickTableMap';
    ...
    /**
     * Initializes internal state of Base\Whseitempick object.
     */
    ...
    /**
     * Compares this with another <code>Whseitempick</code> instance.  If
     * <code>obj</code> is an instance of <code>Whseitempick</code>, delegates to
     * <code>equals(Whseitempick)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Whseitempick The current object, for fluid interface
     */
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setOrdn($v)
    {
        ...
        if ($this->ordn !== $v) {
            $this->ordn = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_ORDN] = true;
        }
    ...
    public function setLinenbr($v)
    {
        ...
        if ($this->linenbr !== $v) {
            $this->linenbr = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_LINENBR] = true;
        }
    ...
    public function setPalletnbr($v)
    {
        ...
        if ($this->palletnbr !== $v) {
            $this->palletnbr = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_PALLETNBR] = true;
        }
    ...
    public function setBarcode($v)
    {
        ...
        if ($this->barcode !== $v) {
            $this->barcode = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_BARCODE] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[WhseitempickTableMap::COL_QTY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : WhseitempickTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : WhseitempickTableMap::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : WhseitempickTableMap::translateFieldName('Recordnumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recordnumber = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : WhseitempickTableMap::translateFieldName('Palletnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->palletnbr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : WhseitempickTableMap::translateFieldName('Barcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->barcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : WhseitempickTableMap::translateFieldName('Bin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->bin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : WhseitempickTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 9; // 9 = WhseitempickTableMap::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildWhseitempickQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Whseitempick::setDeleted()
     * @see Whseitempick::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildWhseitempickQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                WhseitempickTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(WhseitempickTableMap::COL_SESSIONID)) {
        ...
        $sql = sprintf(
            'INSERT INTO whseitempick (%s) VALUES (%s)',
    ...
    {
        $pos = WhseitempickTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Whseitempick'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Whseitempick'][$this->hashCode()] = true;
        $keys = WhseitempickTableMap::getFieldNames($keyType);
        $result = array(
            ...
            $keys[5] => $this->getPalletnbr(),
            $keys[6] => $this->getBarcode(),
            $keys[7] => $this->getBin(),
            $keys[8] => $this->getQty(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[5], $arr)) {
            $this->setPalletnbr($arr[$keys[5]]);
        }
        if (array_key_exists($keys[6], $arr)) {
            $this->setBarcode($arr[$keys[6]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(WhseitempickTableMap::COL_SESSIONID)) {
            $criteria->add(WhseitempickTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(WhseitempickTableMap::COL_ORDN)) {
    ...
    {
        $criteria = ChildWhseitempickQuery::create();
        $criteria->add(WhseitempickTableMap::COL_SESSIONID, $this->sessionid);
        $criteria->add(WhseitempickTableMap::COL_ORDN, $this->ordn);
        $criteria->add(WhseitempickTableMap::COL_ITEMID, $this->itemid);
        $criteria->add(WhseitempickTableMap::COL_RECORDNUMBER, $this->recordnumber);
    ...
    {
        return (null === $this->getSessionid()) && (null === $this->getOrdn()) && (null === $this->getItemid()) && (null === $this->getRecordnumber());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Whseitempick (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Whseitempick Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(WhseitempickTableMap::DEFAULT_STRING_FORMAT);
    }
