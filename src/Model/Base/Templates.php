...
abstract class Templates implements ActiveRecordInterface
{
    ...
    /**
     * The value for the fieldgroups_id field.
     *
     * Note: this column has a database default value of: 0
     * @var        int
     */
    protected $fieldgroups_id;
    ...
    /**
     * Get the [fieldgroups_id] column value.
     *
     * @return int
     */
    public function getFieldgroupsId()
    {
        return $this->fieldgroups_id;
    }
    ...
    public function setName($v)
    {
        ...
        if ($this->name !== $v) {
            $this->name = $v;
            $this->modifiedColumns[TemplatesTableMap::COL_NAME] = true;
        }
    ...
    /**
     * Set the value of [fieldgroups_id] column.
     *
     * @param int $v new value
     * @return $this|\Templates The current object (for fluent API support)
     */
    public function setFieldgroupsId($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }

        if ($this->fieldgroups_id !== $v) {
            $this->fieldgroups_id = $v;
            $this->modifiedColumns[TemplatesTableMap::COL_FIELDGROUPS_ID] = true;
        }
    ...
    public function setFlags($v)
    {
        ...
        if ($this->flags !== $v) {
            $this->flags = $v;
            $this->modifiedColumns[TemplatesTableMap::COL_FLAGS] = true;
        }
    ...
    public function setCacheTime($v)
    {
        ...
        if ($this->cache_time !== $v) {
            $this->cache_time = $v;
            $this->modifiedColumns[TemplatesTableMap::COL_CACHE_TIME] = true;
        }
    ...
    public function setData($v)
    {
        ...
        if ($this->data !== $v) {
            $this->data = $v;
            $this->modifiedColumns[TemplatesTableMap::COL_DATA] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : TemplatesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : TemplatesTableMap::translateFieldName('FieldgroupsId', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fieldgroups_id = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : TemplatesTableMap::translateFieldName('Flags', TableMap::TYPE_PHPNAME, $indexType)];
            $this->flags = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : TemplatesTableMap::translateFieldName('CacheTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cache_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : TemplatesTableMap::translateFieldName('Data', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = TemplatesTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(TemplatesTableMap::COL_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'name';
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_FIELDGROUPS_ID)) {
            $modifiedColumns[':p' . $index++]  = 'fieldgroups_id';
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_FLAGS)) {
            $modifiedColumns[':p' . $index++]  = 'flags';
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_CACHE_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'cache_time';
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_DATA)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'fieldgroups_id':
                        $stmt->bindValue($identifier, $this->fieldgroups_id, PDO::PARAM_INT);
                        break;
                    case 'flags':
                        $stmt->bindValue($identifier, $this->flags, PDO::PARAM_INT);
                        break;
                    case 'cache_time':
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[2], $arr)) {
            $this->setFieldgroupsId($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setFlags($arr[$keys[3]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(TemplatesTableMap::COL_NAME)) {
            $criteria->add(TemplatesTableMap::COL_NAME, $this->name);
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_FIELDGROUPS_ID)) {
            $criteria->add(TemplatesTableMap::COL_FIELDGROUPS_ID, $this->fieldgroups_id);
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_FLAGS)) {
            $criteria->add(TemplatesTableMap::COL_FLAGS, $this->flags);
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_CACHE_TIME)) {
            $criteria->add(TemplatesTableMap::COL_CACHE_TIME, $this->cache_time);
        }
        if ($this->isColumnModified(TemplatesTableMap::COL_DATA)) {
            $criteria->add(TemplatesTableMap::COL_DATA, $this->data);
        }
    ...
    public function copyInto($copyObj, $deepCopy = false, $makeNew = true)
    {
        ...
        $copyObj->setFieldgroupsId($this->getFieldgroupsId());
