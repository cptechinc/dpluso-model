...
abstract class Countries implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CountriesTableMap';
    ...
    public function setCcode($v)
    {
        ...
        if ($this->ccode !== $v) {
            $this->ccode = $v;
            $this->modifiedColumns[CountriesTableMap::COL_CCODE] = true;
        }
    ...
    public function setCallingCode($v)
    {
        ...
        if ($this->calling_code !== $v) {
            $this->calling_code = $v;
            $this->modifiedColumns[CountriesTableMap::COL_CALLING_CODE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CountriesTableMap::translateFieldName('Name', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CountriesTableMap::translateFieldName('Ccode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ccode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : CountriesTableMap::translateFieldName('CallingCode', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CountriesTableMap::COL_CCODE)) {
            $modifiedColumns[':p' . $index++]  = 'ccode';
        }
        if ($this->isColumnModified(CountriesTableMap::COL_CALLING_CODE)) {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'name':
                        ...
                        break;
                    case 'ccode':
                        $stmt->bindValue($identifier, $this->ccode, PDO::PARAM_STR);
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) {
            $this->setCcode($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setCallingCode($arr[$keys[2]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CountriesTableMap::COL_CCODE)) {
            $criteria->add(CountriesTableMap::COL_CCODE, $this->ccode);
        }
        if ($this->isColumnModified(CountriesTableMap::COL_CALLING_CODE)) {
            $criteria->add(CountriesTableMap::COL_CALLING_CODE, $this->calling_code);
        }
