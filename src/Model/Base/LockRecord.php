 ...
 */
abstract class LockRecord implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\LockRecordTableMap';
    ...
    /**
     * Initializes internal state of Base\LockRecord object.
     */
    ...
    /**
     * Compares this with another <code>LockRecord</code> instance.  If
     * <code>obj</code> is an instance of <code>LockRecord</code>, delegates to
     * <code>equals(LockRecord)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|LockRecord The current object, for fluid interface
     */
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[LockRecordTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setUserid($v)
    {
        ...
        if ($this->userid !== $v) {
            $this->userid = $v;
            $this->modifiedColumns[LockRecordTableMap::COL_USERID] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : LockRecordTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : LockRecordTableMap::translateFieldName('Userid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->userid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : LockRecordTableMap::translateFieldName('Function', TableMap::TYPE_PHPNAME, $indexType)];
            $this->function = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : LockRecordTableMap::translateFieldName('Key', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildLockRecordQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see LockRecord::setDeleted()
     * @see LockRecord::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildLockRecordQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                LockRecordTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(LockRecordTableMap::COL_SESSIONID)) {
    ...
    {
        $pos = LockRecordTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['LockRecord'][$this->hashCode()])) {
            return '*RECURSION*';
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(LockRecordTableMap::COL_SESSIONID)) {
            $criteria->add(LockRecordTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(LockRecordTableMap::COL_USERID)) {
    ...
    {
        return (null === $this->getSessionid()) && (null === $this->getUserid()) && (null === $this->getFunction()) && (null === $this->getKey());
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \LockRecord (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \LockRecord Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(LockRecordTableMap::DEFAULT_STRING_FORMAT);
    }
