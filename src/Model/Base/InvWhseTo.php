...
/**
 * Base class that represents a row from the 'inv_whse_to' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InvWhseTo implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvWhseToTableMap';
    ...
    /**
     * Initializes internal state of Base\InvWhseTo object.
     */
    ...
    /**
     * Compares this with another <code>InvWhseTo</code> instance.  If
     * <code>obj</code> is an instance of <code>InvWhseTo</code>, delegates to
     * <code>equals(InvWhseTo)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvWhseTo The current object, for fluid interface
     */
     ...
     * @return $this|\InvWhseTo The current object (for fluent API support)
     */
    public function setIntbwhseto($v)
    {
        ...
        if ($this->intbwhseto !== $v) {
            $this->intbwhseto = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSETO] = true;
        }
    ...
    public function setIntbwhsename($v)
    {
        ...
        if ($this->intbwhsename !== $v) {
            $this->intbwhsename = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSENAME] = true;
        }
    ...
    public function setIntbwhseadr1($v)
    {
        ...
        if ($this->intbwhseadr1 !== $v) {
            $this->intbwhseadr1 = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEADR1] = true;
        }
    ...
    public function setIntbwhseadr2($v)
    {
        ...
        if ($this->intbwhseadr2 !== $v) {
            $this->intbwhseadr2 = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEADR2] = true;
        }
    ...
    public function setIntbwhsecity($v)
    {
        ...
        if ($this->intbwhsecity !== $v) {
            $this->intbwhsecity = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSECITY] = true;
        }
    ...
    public function setIntbwhsestat($v)
    {
        ...
        if ($this->intbwhsestat !== $v) {
            $this->intbwhsestat = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSESTAT] = true;
        }
    ...
    public function setIntbwhsezipcode($v)
    {
        ...
        if ($this->intbwhsezipcode !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEZIPCODE] = true;
        }
    ...
    public function setIntbwhsectry($v)
    {
        ...
        if ($this->intbwhsectry !== $v) {
            $this->intbwhsectry = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSECTRY] = true;
        }
    ...
    public function setIntbwhseusehandheld($v)
    {
        ...
        if ($this->intbwhseusehandheld !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEUSEHANDHELD] = true;
        }
    ...
    public function setIntbwhsecashcust($v)
    {
        ...
        if ($this->intbwhsecashcust !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSECASHCUST] = true;
        }
    ...
    public function setIntbwhsepickdtl($v)
    {
        ...
        if ($this->intbwhsepickdtl !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPICKDTL] = true;
        }
    ...
    public function setIntbwhseprodbin($v)
    {
        ...
        if ($this->intbwhseprodbin !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPRODBIN] = true;
        }
    ...
    public function setIntbwhsepharea($v)
    {
        ...
        if ($this->intbwhsepharea !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPHAREA] = true;
        }
    ...
    public function setIntbwhsephfrst3($v)
    {
        ...
        if ($this->intbwhsephfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPHFRST3] = true;
        }
    ...
    public function setIntbwhsephlast4($v)
    {
        ...
        if ($this->intbwhsephlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPHLAST4] = true;
        }
    ...
    public function setIntbwhsephext($v)
    {
        ...
        if ($this->intbwhsephext !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPHEXT] = true;
        }
    ...
    public function setIntbwhsefaxarea($v)
    {
        ...
        if ($this->intbwhsefaxarea !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEFAXAREA] = true;
        }
    ...
    public function setIntbwhsefaxfrst3($v)
    {
        ...
        if ($this->intbwhsefaxfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEFAXFRST3] = true;
        }
    ...
    public function setIntbwhsefaxlast4($v)
    {
        ...
        if ($this->intbwhsefaxlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEFAXLAST4] = true;
        }
    ...
    public function setIntbwhseemailadr($v)
    {
        ...
        if ($this->intbwhseemailadr !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEEMAILADR] = true;
        }
    ...
    public function setIntbwhseqcrgabin($v)
    {
        ...
        if ($this->intbwhseqcrgabin !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEQCRGABIN] = true;
        }
    ...
    public function setIntbwhserfprinter1($v)
    {
        ...
        if ($this->intbwhserfprinter1 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSERFPRINTER1] = true;
        }
    ...
    public function setIntbwhserfprinter2($v)
    {
        ...
        if ($this->intbwhserfprinter2 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSERFPRINTER2] = true;
        }
    ...
    public function setIntbwhserfprinter3($v)
    {
        ...
        if ($this->intbwhserfprinter3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSERFPRINTER3] = true;
        }
    ...
    public function setIntbwhserfprinter4($v)
    {
        ...
        if ($this->intbwhserfprinter4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSERFPRINTER4] = true;
        }
    ...
    public function setIntbwhserfprinter5($v)
    {
        ...
        if ($this->intbwhserfprinter5 !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSERFPRINTER5] = true;
        }
    ...
    public function setIntbwhseprofwhse($v)
    {
        ...
        if ($this->intbwhseprofwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEPROFWHSE] = true;
        }
    ...
    public function setIntbwhseasetwhse($v)
    {
        ...
        if ($this->intbwhseasetwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEASETWHSE] = true;
        }
    ...
    public function setIntbwhseconsignwhse($v)
    {
        ...
        if ($this->intbwhseconsignwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSECONSIGNWHSE] = true;
        }
    ...
    public function setIntbwhsebinrangelist($v)
    {
        ...
        if ($this->intbwhsebinrangelist !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSEBINRANGELIST] = true;
        }
    ...
    public function setIntbwhsesupplywhse($v)
    {
        ...
        if ($this->intbwhsesupplywhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseToTableMap::COL_INTBWHSESUPPLYWHSE] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvWhseToTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseto', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseto = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseadr1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseadr2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsecity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsestat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsestat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsezipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsezipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsectry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsectry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseusehandheld', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseusehandheld = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsecashcust', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecashcust = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsepickdtl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepickdtl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseprodbin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprodbin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsepharea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepharea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsephfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsephlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsephext', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephext = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsefaxarea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxarea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsefaxfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsefaxlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseemailadr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseemailadr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseqcrgabin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseqcrgabin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhserfprinter1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhserfprinter2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhserfprinter3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhserfprinter4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhserfprinter5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseprofwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprofwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseasetwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseasetwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhseconsignwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseconsignwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsebinrangelist', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsebinrangelist = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : InvWhseToTableMap::translateFieldName('Intbwhsesupplywhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsesupplywhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : InvWhseToTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : InvWhseToTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : InvWhseToTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 34; // 34 = InvWhseToTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvWhseTo'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvWhseToQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvWhseTo::setDeleted()
     * @see InvWhseTo::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvWhseToQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvWhseToTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSETO)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseTo';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSENAME)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseName';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEADR1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr1';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEADR2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr2';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECITY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCity';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSESTAT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseStat';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseZipCode';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECTRY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCtry';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseUseHandheld';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECASHCUST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCashCust';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPICKDTL)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePickDtl';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPRODBIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProdBin';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhArea';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhFrst3';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhLast4';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHEXT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhExt';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxArea';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxFrst3';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxLast4';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEEMAILADR)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseEmailAdr';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEQCRGABIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseQcRgaBin';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter1';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter2';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter3';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter4';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER5)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter5';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPROFWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProfWhse';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEASETWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAsetWhse';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseConsignWhse';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEBINRANGELIST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseBinRangeList';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseSupplyWhse';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO inv_whse_to (%s) VALUES (%s)',
    ...
    {
        $pos = InvWhseToTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['InvWhseTo'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvWhseTo'][$this->hashCode()] = true;
        $keys = InvWhseToTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIntbwhseto(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSETO)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSETO, $this->intbwhseto);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSENAME)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSENAME, $this->intbwhsename);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEADR1)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEADR1, $this->intbwhseadr1);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEADR2)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEADR2, $this->intbwhseadr2);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECITY)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSECITY, $this->intbwhsecity);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSESTAT)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSESTAT, $this->intbwhsestat);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEZIPCODE)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEZIPCODE, $this->intbwhsezipcode);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECTRY)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSECTRY, $this->intbwhsectry);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEUSEHANDHELD, $this->intbwhseusehandheld);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECASHCUST)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSECASHCUST, $this->intbwhsecashcust);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPICKDTL)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPICKDTL, $this->intbwhsepickdtl);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPRODBIN)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPRODBIN, $this->intbwhseprodbin);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHAREA)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPHAREA, $this->intbwhsepharea);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHFRST3)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPHFRST3, $this->intbwhsephfrst3);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHLAST4)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPHLAST4, $this->intbwhsephlast4);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPHEXT)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPHEXT, $this->intbwhsephext);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXAREA)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEFAXAREA, $this->intbwhsefaxarea);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXFRST3)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEFAXFRST3, $this->intbwhsefaxfrst3);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEFAXLAST4)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEFAXLAST4, $this->intbwhsefaxlast4);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEEMAILADR)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEEMAILADR, $this->intbwhseemailadr);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEQCRGABIN)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEQCRGABIN, $this->intbwhseqcrgabin);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER1)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSERFPRINTER1, $this->intbwhserfprinter1);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER2)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSERFPRINTER2, $this->intbwhserfprinter2);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER3)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSERFPRINTER3, $this->intbwhserfprinter3);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER4)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSERFPRINTER4, $this->intbwhserfprinter4);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSERFPRINTER5)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSERFPRINTER5, $this->intbwhserfprinter5);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEPROFWHSE)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEPROFWHSE, $this->intbwhseprofwhse);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEASETWHSE)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEASETWHSE, $this->intbwhseasetwhse);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSECONSIGNWHSE, $this->intbwhseconsignwhse);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSEBINRANGELIST)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSEBINRANGELIST, $this->intbwhsebinrangelist);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $criteria->add(InvWhseToTableMap::COL_INTBWHSESUPPLYWHSE, $this->intbwhsesupplywhse);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_DATEUPDTD)) {
            $criteria->add(InvWhseToTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvWhseToTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvWhseToTableMap::COL_DUMMY)) {
            $criteria->add(InvWhseToTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvWhseToQuery::create();
        $criteria->add(InvWhseToTableMap::COL_INTBWHSETO, $this->intbwhseto);
    ...
    {
        $validPk = null !== $this->getIntbwhseto();
    ...
    /**
     * Generic method to set the primary key (intbwhseto column).
     *
    ...
    {
        return null === $this->getIntbwhseto();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvWhseTo (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvWhseTo Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(InvWhseToTableMap::DEFAULT_STRING_FORMAT);
    }
