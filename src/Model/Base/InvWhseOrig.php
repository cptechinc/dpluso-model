...
/**
 * Base class that represents a row from the 'inv_whse_orig' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InvWhseOrig implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvWhseOrigTableMap';
    ...
    /**
     * Initializes internal state of Base\InvWhseOrig object.
     */
    ...
    /**
     * Compares this with another <code>InvWhseOrig</code> instance.  If
     * <code>obj</code> is an instance of <code>InvWhseOrig</code>, delegates to
     * <code>equals(InvWhseOrig)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvWhseOrig The current object, for fluid interface
     */
     ...
     * @return $this|\InvWhseOrig The current object (for fluent API support)
     */
    public function setIntbwhseorig($v)
    {
        ...
        if ($this->intbwhseorig !== $v) {
            $this->intbwhseorig = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEORIG] = true;
        }
    ...
    public function setIntbwhsename($v)
    {
        ...
        if ($this->intbwhsename !== $v) {
            $this->intbwhsename = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSENAME] = true;
        }
    ...
    public function setIntbwhseadr1($v)
    {
        ...
        if ($this->intbwhseadr1 !== $v) {
            $this->intbwhseadr1 = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEADR1] = true;
        }
    ...
    public function setIntbwhseadr2($v)
    {
        ...
        if ($this->intbwhseadr2 !== $v) {
            $this->intbwhseadr2 = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEADR2] = true;
        }
    ...
    public function setIntbwhsecity($v)
    {
        ...
        if ($this->intbwhsecity !== $v) {
            $this->intbwhsecity = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSECITY] = true;
        }
    ...
    public function setIntbwhsestat($v)
    {
        ...
        if ($this->intbwhsestat !== $v) {
            $this->intbwhsestat = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSESTAT] = true;
        }
    ...
    public function setIntbwhsezipcode($v)
    {
        ...
        if ($this->intbwhsezipcode !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEZIPCODE] = true;
        }
    ...
    public function setIntbwhsectry($v)
    {
        ...
        if ($this->intbwhsectry !== $v) {
            $this->intbwhsectry = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSECTRY] = true;
        }
    ...
    public function setIntbwhseusehandheld($v)
    {
        ...
        if ($this->intbwhseusehandheld !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEUSEHANDHELD] = true;
        }
    ...
    public function setIntbwhsecashcust($v)
    {
        ...
        if ($this->intbwhsecashcust !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSECASHCUST] = true;
        }
    ...
    public function setIntbwhsepickdtl($v)
    {
        ...
        if ($this->intbwhsepickdtl !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPICKDTL] = true;
        }
    ...
    public function setIntbwhseprodbin($v)
    {
        ...
        if ($this->intbwhseprodbin !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPRODBIN] = true;
        }
    ...
    public function setIntbwhsepharea($v)
    {
        ...
        if ($this->intbwhsepharea !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPHAREA] = true;
        }
    ...
    public function setIntbwhsephfrst3($v)
    {
        ...
        if ($this->intbwhsephfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPHFRST3] = true;
        }
    ...
    public function setIntbwhsephlast4($v)
    {
        ...
        if ($this->intbwhsephlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPHLAST4] = true;
        }
    ...
    public function setIntbwhsephext($v)
    {
        ...
        if ($this->intbwhsephext !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPHEXT] = true;
        }
    ...
    public function setIntbwhsefaxarea($v)
    {
        ...
        if ($this->intbwhsefaxarea !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEFAXAREA] = true;
        }
    ...
    public function setIntbwhsefaxfrst3($v)
    {
        ...
        if ($this->intbwhsefaxfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEFAXFRST3] = true;
        }
    ...
    public function setIntbwhsefaxlast4($v)
    {
        ...
        if ($this->intbwhsefaxlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEFAXLAST4] = true;
        }
    ...
    public function setIntbwhseemailadr($v)
    {
        ...
        if ($this->intbwhseemailadr !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEEMAILADR] = true;
        }
    ...
    public function setIntbwhseqcrgabin($v)
    {
        ...
        if ($this->intbwhseqcrgabin !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEQCRGABIN] = true;
        }
    ...
    public function setIntbwhserfprinter1($v)
    {
        ...
        if ($this->intbwhserfprinter1 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSERFPRINTER1] = true;
        }
    ...
    public function setIntbwhserfprinter2($v)
    {
        ...
        if ($this->intbwhserfprinter2 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSERFPRINTER2] = true;
        }
    ...
    public function setIntbwhserfprinter3($v)
    {
        ...
        if ($this->intbwhserfprinter3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSERFPRINTER3] = true;
        }
    ...
    public function setIntbwhserfprinter4($v)
    {
        ...
        if ($this->intbwhserfprinter4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSERFPRINTER4] = true;
        }
    ...
    public function setIntbwhserfprinter5($v)
    {
        ...
        if ($this->intbwhserfprinter5 !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSERFPRINTER5] = true;
        }
    ...
    public function setIntbwhseprofwhse($v)
    {
        ...
        if ($this->intbwhseprofwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEPROFWHSE] = true;
        }
    ...
    public function setIntbwhseasetwhse($v)
    {
        ...
        if ($this->intbwhseasetwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEASETWHSE] = true;
        }
    ...
    public function setIntbwhseconsignwhse($v)
    {
        ...
        if ($this->intbwhseconsignwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSECONSIGNWHSE] = true;
        }
    ...
    public function setIntbwhsebinrangelist($v)
    {
        ...
        if ($this->intbwhsebinrangelist !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSEBINRANGELIST] = true;
        }
    ...
    public function setIntbwhsesupplywhse($v)
    {
        ...
        if ($this->intbwhsesupplywhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseOrigTableMap::COL_INTBWHSESUPPLYWHSE] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvWhseOrigTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseorig', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseorig = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseadr1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseadr2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsecity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsestat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsestat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsezipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsezipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsectry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsectry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseusehandheld', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseusehandheld = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsecashcust', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecashcust = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsepickdtl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepickdtl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseprodbin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprodbin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsepharea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepharea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsephfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsephlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsephext', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephext = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsefaxarea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxarea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsefaxfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsefaxlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseemailadr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseemailadr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseqcrgabin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseqcrgabin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhserfprinter1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhserfprinter2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhserfprinter3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhserfprinter4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhserfprinter5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseprofwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprofwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseasetwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseasetwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhseconsignwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseconsignwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsebinrangelist', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsebinrangelist = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : InvWhseOrigTableMap::translateFieldName('Intbwhsesupplywhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsesupplywhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : InvWhseOrigTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : InvWhseOrigTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : InvWhseOrigTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 34; // 34 = InvWhseOrigTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvWhseOrig'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvWhseOrigQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvWhseOrig::setDeleted()
     * @see InvWhseOrig::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvWhseOrigQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvWhseOrigTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEORIG)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseOrig';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSENAME)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseName';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEADR1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr1';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEADR2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr2';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECITY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCity';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSESTAT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseStat';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseZipCode';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECTRY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCtry';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseUseHandheld';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECASHCUST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCashCust';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPICKDTL)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePickDtl';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPRODBIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProdBin';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhArea';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhFrst3';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhLast4';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHEXT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhExt';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxArea';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxFrst3';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxLast4';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEEMAILADR)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseEmailAdr';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEQCRGABIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseQcRgaBin';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter1';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter2';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter3';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter4';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER5)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter5';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPROFWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProfWhse';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEASETWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAsetWhse';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseConsignWhse';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEBINRANGELIST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseBinRangeList';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseSupplyWhse';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO inv_whse_orig (%s) VALUES (%s)',
    ...
    {
        $pos = InvWhseOrigTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['InvWhseOrig'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvWhseOrig'][$this->hashCode()] = true;
        $keys = InvWhseOrigTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIntbwhseorig(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIntbwhseorig($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEORIG)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEORIG, $this->intbwhseorig);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSENAME)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSENAME, $this->intbwhsename);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEADR1)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEADR1, $this->intbwhseadr1);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEADR2)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEADR2, $this->intbwhseadr2);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECITY)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSECITY, $this->intbwhsecity);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSESTAT)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSESTAT, $this->intbwhsestat);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEZIPCODE)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEZIPCODE, $this->intbwhsezipcode);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECTRY)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSECTRY, $this->intbwhsectry);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEUSEHANDHELD, $this->intbwhseusehandheld);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECASHCUST)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSECASHCUST, $this->intbwhsecashcust);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPICKDTL)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPICKDTL, $this->intbwhsepickdtl);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPRODBIN)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPRODBIN, $this->intbwhseprodbin);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHAREA)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPHAREA, $this->intbwhsepharea);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHFRST3)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPHFRST3, $this->intbwhsephfrst3);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHLAST4)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPHLAST4, $this->intbwhsephlast4);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPHEXT)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPHEXT, $this->intbwhsephext);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXAREA)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEFAXAREA, $this->intbwhsefaxarea);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXFRST3)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEFAXFRST3, $this->intbwhsefaxfrst3);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEFAXLAST4)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEFAXLAST4, $this->intbwhsefaxlast4);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEEMAILADR)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEEMAILADR, $this->intbwhseemailadr);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEQCRGABIN)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEQCRGABIN, $this->intbwhseqcrgabin);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER1)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER1, $this->intbwhserfprinter1);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER2)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER2, $this->intbwhserfprinter2);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER3)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER3, $this->intbwhserfprinter3);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER4)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER4, $this->intbwhserfprinter4);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER5)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSERFPRINTER5, $this->intbwhserfprinter5);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEPROFWHSE)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEPROFWHSE, $this->intbwhseprofwhse);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEASETWHSE)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEASETWHSE, $this->intbwhseasetwhse);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSECONSIGNWHSE, $this->intbwhseconsignwhse);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSEBINRANGELIST)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEBINRANGELIST, $this->intbwhsebinrangelist);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $criteria->add(InvWhseOrigTableMap::COL_INTBWHSESUPPLYWHSE, $this->intbwhsesupplywhse);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_DATEUPDTD)) {
            $criteria->add(InvWhseOrigTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvWhseOrigTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvWhseOrigTableMap::COL_DUMMY)) {
            $criteria->add(InvWhseOrigTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvWhseOrigQuery::create();
        $criteria->add(InvWhseOrigTableMap::COL_INTBWHSEORIG, $this->intbwhseorig);
    ...
    {
        $validPk = null !== $this->getIntbwhseorig();
    ...
    /**
     * Generic method to set the primary key (intbwhseorig column).
     *
    ...
    {
        return null === $this->getIntbwhseorig();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvWhseOrig (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvWhseOrig Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(InvWhseOrigTableMap::DEFAULT_STRING_FORMAT);
    }
