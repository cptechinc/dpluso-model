...
/**
 * Base class that represents a row from the 'vmiorder' table.
 *
 *
 *
...
abstract class VmiOrder implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\VmiOrderTableMap';
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        $sql = sprintf(
            'INSERT INTO vmiorder (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'shiptoid':
                        ...
                        break;
                    case 'cell':
                        $stmt->bindValue($identifier, $this->cell, PDO::PARAM_STR);
                    ...
                    case 'custitemid':
                        ...
                        break;
                    case 'cases':
                        $stmt->bindValue($identifier, $this->cases, PDO::PARAM_INT);
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setCases($this->getCases());
