 ...
 */
abstract class PackSalesOrderDetail implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\PackSalesOrderDetailTableMap';
    ...
    /**
     * Initializes internal state of Base\PackSalesOrderDetail object.
     */
    ...
    /**
     * Compares this with another <code>PackSalesOrderDetail</code> instance.  If
     * <code>obj</code> is an instance of <code>PackSalesOrderDetail</code>, delegates to
     * <code>equals(PackSalesOrderDetail)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|PackSalesOrderDetail The current object, for fluid interface
     */
    ...
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setOrdernbr($v)
    {
        ...
        if ($this->ordernbr !== $v) {
            $this->ordernbr = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_ORDERNBR] = true;
        }
    ...
    public function setLinenbr($v)
    {
        ...
        if ($this->linenbr !== $v) {
            $this->linenbr = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_LINENBR] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_ITEMID] = true;
        }
    ...
    public function setLotserial($v)
    {
        ...
        if ($this->lotserial !== $v) {
            $this->lotserial = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_LOTSERIAL] = true;
        }
    ...
    public function setQtyToship($v)
    {
        ...
        if ($this->qty_toship !== $v) {
            $this->qty_toship = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_QTY_TOSHIP] = true;
        }
    ...
    public function setQtyPacked($v)
    {
        ...
        if ($this->qty_packed !== $v) {
            $this->qty_packed = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_QTY_PACKED] = true;
        }
    ...
    public function setQtyRemaining($v)
    {
        ...
        if ($this->qty_remaining !== $v) {
            ...
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_QTY_REMAINING] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[PackSalesOrderDetailTableMap::COL_TIME] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : PackSalesOrderDetailTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : PackSalesOrderDetailTableMap::translateFieldName('Ordernbr', TableMap::TYPE_PHPNAME, $indexType)];
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildPackSalesOrderDetailQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see PackSalesOrderDetail::setDeleted()
     * @see PackSalesOrderDetail::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildPackSalesOrderDetailQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                PackSalesOrderDetailTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_ORDERNBR)) {
            $modifiedColumns[':p' . $index++]  = 'ordernbr';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_LINENBR)) {
            $modifiedColumns[':p' . $index++]  = 'linenbr';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_ITEMID)) {
        ...
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_QTY_PACKED)) {
            $modifiedColumns[':p' . $index++]  = 'qty_packed';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_QTY_REMAINING)) {
            $modifiedColumns[':p' . $index++]  = 'qty_remaining';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_TIME)) {
    ...
    {
        $pos = PackSalesOrderDetailTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['PackSalesOrderDetail'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['PackSalesOrderDetail'][$this->hashCode()] = true;
        $keys = PackSalesOrderDetailTableMap::getFieldNames($keyType);
        $result = array(
     ...
     *                TableMap::TYPE_COLNAME, TableMap::TYPE_FIELDNAME, TableMap::TYPE_NUM.
     *                Defaults to TableMap::TYPE_PHPNAME.
     * @return $this|\PackSalesOrderDetail
     */
    ...
    {
        $criteria = new Criteria(PackSalesOrderDetailTableMap::DATABASE_NAME);

        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_SESSIONID)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_ORDERNBR)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_ORDERNBR, $this->ordernbr);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_LINENBR)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_LINENBR, $this->linenbr);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_ITEMID)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_ITEMID, $this->itemid);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_LOTSERIAL)) {
        ...
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_QTY_PACKED)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_QTY_PACKED, $this->qty_packed);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_QTY_REMAINING)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_QTY_REMAINING, $this->qty_remaining);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_DATE)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(PackSalesOrderDetailTableMap::COL_TIME)) {
            $criteria->add(PackSalesOrderDetailTableMap::COL_TIME, $this->time);
        }
    ...
    {
        $criteria = ChildPackSalesOrderDetailQuery::create();
        $criteria->add(PackSalesOrderDetailTableMap::COL_SESSIONID, $this->sessionid);
        $criteria->add(PackSalesOrderDetailTableMap::COL_ORDERNBR, $this->ordernbr);
        $criteria->add(PackSalesOrderDetailTableMap::COL_LINENBR, $this->linenbr);
        $criteria->add(PackSalesOrderDetailTableMap::COL_ITEMID, $this->itemid);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \PackSalesOrderDetail (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \PackSalesOrderDetail Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(PackSalesOrderDetailTableMap::DEFAULT_STRING_FORMAT);
    }
