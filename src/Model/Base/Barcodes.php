...
/**
 * Base class that represents a row from the 'barcodes' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Barcodes implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BarcodesTableMap';
    ...
    /**
     * The value for the barcodenbr field.
     *
     * @var        string
     */
    ...
    /**
     * The value for the unitqty field.
     *
     * @var        int
     */
    protected $unitqty;
    ...
    /**
     * Initializes internal state of Base\Barcodes object.
     * @see applyDefaults()
     */
    ...
    /**
     * Compares this with another <code>Barcodes</code> instance.  If
     * <code>obj</code> is an instance of <code>Barcodes</code>, delegates to
     * <code>equals(Barcodes)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Barcodes The current object, for fluid interface
     */
    ...
    /**
     * Get the [barcodenbr] column value.
     *
     * @return string
     */
    public function getBarcodenbr()
    {
        return $this->barcodenbr;
    }
    ...
    /**
     * Set the value of [barcodenbr] column.
     *
     * @param string $v new value
     * @return $this|\Barcodes The current object (for fluent API support)
     */
    public function setBarcodenbr($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }

        if ($this->barcodenbr !== $v) {
            $this->barcodenbr = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_BARCODENBR] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_ITEMID] = true;
        }
    ...
    public function setPrimary($v)
    {
        ...
        if ($this->primary !== $v) {
            $this->primary = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_PRIMARY] = true;
        }
    ...
    /**
     * Set the value of [unitqty] column.
     *
     * @param int $v new value
     * @return $this|\Barcodes The current object (for fluent API support)
     */
    public function setUnitqty($v)
    {
        if ($v !== null) {
            $v = (int) $v;
        }
        ...
        if ($this->unitqty !== $v) {
            $this->unitqty = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_UNITQTY] = true;
        }
    ...
    public function setUom($v)
    {
        ...
        if ($this->uom !== $v) {
            $this->uom = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_UOM] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[BarcodesTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : BarcodesTableMap::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->barcodenbr = (null !== $col) ? (string) $col : null;
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildBarcodesQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see Barcodes::setDeleted()
     * @see Barcodes::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildBarcodesQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                BarcodesTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(BarcodesTableMap::COL_BARCODENBR)) {
            $modifiedColumns[':p' . $index++]  = 'barcodenbr';
        }
        ...
        if ($this->isColumnModified(BarcodesTableMap::COL_UNITQTY)) {
            $modifiedColumns[':p' . $index++]  = 'unitqty';
        }
        if ($this->isColumnModified(BarcodesTableMap::COL_UOM)) {
            $modifiedColumns[':p' . $index++]  = 'uom';
        }
        if ($this->isColumnModified(BarcodesTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO barcodes (%s) VALUES (%s)',
        ...
        try {
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case 'barcodenbr':
                        $stmt->bindValue($identifier, $this->barcodenbr, PDO::PARAM_STR);
                        break;
                    case 'itemid':
                    ...
                    case 'primary':
                        ...
                        break;
                    case 'unitqty':
                        $stmt->bindValue($identifier, $this->unitqty, PDO::PARAM_INT);
                        break;
                    case 'uom':
    ...
    {
        $pos = BarcodesTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Barcodes'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Barcodes'][$this->hashCode()] = true;
        $keys = BarcodesTableMap::getFieldNames($keyType);
        $result = array(
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(BarcodesTableMap::COL_UNITQTY)) {
            $criteria->add(BarcodesTableMap::COL_UNITQTY, $this->unitqty);
        }
        if ($this->isColumnModified(BarcodesTableMap::COL_UOM)) {
            $criteria->add(BarcodesTableMap::COL_UOM, $this->uom);
        }
        if ($this->isColumnModified(BarcodesTableMap::COL_DUMMY)) {
            $criteria->add(BarcodesTableMap::COL_DUMMY, $this->dummy);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Barcodes (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Barcodes Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(BarcodesTableMap::DEFAULT_STRING_FORMAT);
    }
