...
/**
 * Base class that represents a row from the 'unitofmeasure' table.
 *
 *
 *
...
abstract class Unitofmeasure implements ActiveRecordInterface
{
    ...
    public function setCode($v)
    {
        ...
        if ($this->code !== $v) {
            $this->code = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_CODE] = true;
        }
    ...
    public function setDesc($v)
    {
        ...
        if ($this->desc !== $v) {
            $this->desc = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_DESC] = true;
        }
    ...
    public function setConversion($v)
    {
        ...
        if ($this->conversion !== $v) {
            $this->conversion = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_CONVERSION] = true;
        }
    ...
    public function setCreatedate($v)
    {
        ...
        if ($this->createdate !== $v) {
            $this->createdate = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_CREATEDATE] = true;
        }
    ...
    public function setCreatetime($v)
    {
        ...
        if ($this->createtime !== $v) {
            $this->createtime = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_CREATETIME] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[UnitofmeasureTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : UnitofmeasureTableMap::translateFieldName('Code', TableMap::TYPE_PHPNAME, $indexType)];
            $this->code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : UnitofmeasureTableMap::translateFieldName('Desc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->desc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : UnitofmeasureTableMap::translateFieldName('Conversion', TableMap::TYPE_PHPNAME, $indexType)];
            $this->conversion = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : UnitofmeasureTableMap::translateFieldName('Createdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->createdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : UnitofmeasureTableMap::translateFieldName('Createtime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->createtime = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : UnitofmeasureTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 6; // 6 = UnitofmeasureTableMap::NUM_HYDRATE_COLUMNS.
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'code';
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_DESC)) {
            $modifiedColumns[':p' . $index++]  = 'desc';
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CONVERSION)) {
            $modifiedColumns[':p' . $index++]  = 'conversion';
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CREATEDATE)) {
            $modifiedColumns[':p' . $index++]  = 'createdate';
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CREATETIME)) {
            $modifiedColumns[':p' . $index++]  = 'createtime';
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO unitofmeasure (%s) VALUES (%s)',
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CODE)) {
            $criteria->add(UnitofmeasureTableMap::COL_CODE, $this->code);
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_DESC)) {
            $criteria->add(UnitofmeasureTableMap::COL_DESC, $this->desc);
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CONVERSION)) {
            $criteria->add(UnitofmeasureTableMap::COL_CONVERSION, $this->conversion);
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CREATEDATE)) {
            $criteria->add(UnitofmeasureTableMap::COL_CREATEDATE, $this->createdate);
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_CREATETIME)) {
            $criteria->add(UnitofmeasureTableMap::COL_CREATETIME, $this->createtime);
        }
        if ($this->isColumnModified(UnitofmeasureTableMap::COL_DUMMY)) {
            $criteria->add(UnitofmeasureTableMap::COL_DUMMY, $this->dummy);
        }
