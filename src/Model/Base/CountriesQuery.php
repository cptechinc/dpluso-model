 ...
 *
 * @method     ChildCountries|null findOne(?ConnectionInterface $con = null) Return the first ChildCountries matching the query
 ...
 *
 * @method     ChildCountries|null findOneByName(string $name) Return the first ChildCountries filtered by the name column
 * @method     ChildCountries|null findOneByCcode(string $ccode) Return the first ChildCountries filtered by the ccode column
 * @method     ChildCountries|null findOneByCallingCode(string $calling_code) Return the first ChildCountries filtered by the calling_code column
 *
 ...
 *
 * @method     ChildCountries[]|Collection find(?ConnectionInterface $con = null) Return ChildCountries objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildCountries> find(?ConnectionInterface $con = null) Return ChildCountries objects based on current ModelCriteria
 *
 * @method     ChildCountries[]|Collection findByName(string|array<string> $name) Return ChildCountries objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildCountries> findByName(string|array<string> $name) Return ChildCountries objects filtered by the name column
 * @method     ChildCountries[]|Collection findByCcode(string|array<string> $ccode) Return ChildCountries objects filtered by the ccode column
 * @psalm-method Collection&\Traversable<ChildCountries> findByCcode(string|array<string> $ccode) Return ChildCountries objects filtered by the ccode column
 * @method     ChildCountries[]|Collection findByCallingCode(string|array<string> $calling_code) Return ChildCountries objects filtered by the calling_code column
 * @psalm-method Collection&\Traversable<ChildCountries> findByCallingCode(string|array<string> $calling_code) Return ChildCountries objects filtered by the calling_code column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildCountries> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class CountriesQuery extends ModelCriteria
{
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(CountriesTableMap::COL_NAME, $name, $comparison);
     ...
     * $query->filterByCcode(['foo', 'bar']); // WHERE ccode IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $ccode The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByCcode($ccode = null, ?string $comparison = null)
    {
        if (null === $comparison) {
            if (is_array($ccode)) {
                $comparison = Criteria::IN;
        ...
        $this->addUsingAlias(CountriesTableMap::COL_CCODE, $ccode, $comparison);
     ...
     * $query->filterByCallingCode(['foo', 'bar']); // WHERE calling_code IN ('foo', 'bar')
     * </code>
     *
     * @param string|string[] $callingCode The value to use as filter.
     * @param string|null $comparison Operator to use for the column comparison, defaults to Criteria::EQUAL
     *
     * @return $this The current query, for fluid interface
     */
    public function filterByCallingCode($callingCode = null, ?string $comparison = null)
    {
        if (null === $comparison) {
        ...
        $this->addUsingAlias(CountriesTableMap::COL_CALLING_CODE, $callingCode, $comparison);
