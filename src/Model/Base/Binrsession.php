...
abstract class Binrsession implements ActiveRecordInterface
{
     ...
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\BinrsessionTableMap';
     ...
     *
     * @return $this|Binrsession The current object, for fluid interface
     */
     ...
     * @return $this|\Binrsession The current object (for fluent API support)
     */
