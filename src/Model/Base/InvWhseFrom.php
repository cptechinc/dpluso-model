...
/**
 * Base class that represents a row from the 'inv_whse_from' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class InvWhseFrom implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\InvWhseFromTableMap';
    ...
    /**
     * Initializes internal state of Base\InvWhseFrom object.
     */
    ...
    /**
     * Compares this with another <code>InvWhseFrom</code> instance.  If
     * <code>obj</code> is an instance of <code>InvWhseFrom</code>, delegates to
     * <code>equals(InvWhseFrom)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|InvWhseFrom The current object, for fluid interface
     */
     ...
     * @return $this|\InvWhseFrom The current object (for fluent API support)
     */
    public function setIntbwhsefrom($v)
    {
        ...
        if ($this->intbwhsefrom !== $v) {
            $this->intbwhsefrom = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEFROM] = true;
        }
    ...
    public function setIntbwhsename($v)
    {
        ...
        if ($this->intbwhsename !== $v) {
            $this->intbwhsename = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSENAME] = true;
        }
    ...
    public function setIntbwhseadr1($v)
    {
        ...
        if ($this->intbwhseadr1 !== $v) {
            $this->intbwhseadr1 = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEADR1] = true;
        }
    ...
    public function setIntbwhseadr2($v)
    {
        ...
        if ($this->intbwhseadr2 !== $v) {
            $this->intbwhseadr2 = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEADR2] = true;
        }
    ...
    public function setIntbwhsecity($v)
    {
        ...
        if ($this->intbwhsecity !== $v) {
            $this->intbwhsecity = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSECITY] = true;
        }
    ...
    public function setIntbwhsestat($v)
    {
        ...
        if ($this->intbwhsestat !== $v) {
            $this->intbwhsestat = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSESTAT] = true;
        }
    ...
    public function setIntbwhsezipcode($v)
    {
        ...
        if ($this->intbwhsezipcode !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEZIPCODE] = true;
        }
    ...
    public function setIntbwhsectry($v)
    {
        ...
        if ($this->intbwhsectry !== $v) {
            $this->intbwhsectry = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSECTRY] = true;
        }
    ...
    public function setIntbwhseusehandheld($v)
    {
        ...
        if ($this->intbwhseusehandheld !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEUSEHANDHELD] = true;
        }
    ...
    public function setIntbwhsecashcust($v)
    {
        ...
        if ($this->intbwhsecashcust !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSECASHCUST] = true;
        }
    ...
    public function setIntbwhsepickdtl($v)
    {
        ...
        if ($this->intbwhsepickdtl !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPICKDTL] = true;
        }
    ...
    public function setIntbwhseprodbin($v)
    {
        ...
        if ($this->intbwhseprodbin !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPRODBIN] = true;
        }
    ...
    public function setIntbwhsepharea($v)
    {
        ...
        if ($this->intbwhsepharea !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPHAREA] = true;
        }
    ...
    public function setIntbwhsephfrst3($v)
    {
        ...
        if ($this->intbwhsephfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPHFRST3] = true;
        }
    ...
    public function setIntbwhsephlast4($v)
    {
        ...
        if ($this->intbwhsephlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPHLAST4] = true;
        }
    ...
    public function setIntbwhsephext($v)
    {
        ...
        if ($this->intbwhsephext !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPHEXT] = true;
        }
    ...
    public function setIntbwhsefaxarea($v)
    {
        ...
        if ($this->intbwhsefaxarea !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEFAXAREA] = true;
        }
    ...
    public function setIntbwhsefaxfrst3($v)
    {
        ...
        if ($this->intbwhsefaxfrst3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEFAXFRST3] = true;
        }
    ...
    public function setIntbwhsefaxlast4($v)
    {
        ...
        if ($this->intbwhsefaxlast4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEFAXLAST4] = true;
        }
    ...
    public function setIntbwhseemailadr($v)
    {
        ...
        if ($this->intbwhseemailadr !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEEMAILADR] = true;
        }
    ...
    public function setIntbwhseqcrgabin($v)
    {
        ...
        if ($this->intbwhseqcrgabin !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEQCRGABIN] = true;
        }
    ...
    public function setIntbwhserfprinter1($v)
    {
        ...
        if ($this->intbwhserfprinter1 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSERFPRINTER1] = true;
        }
    ...
    public function setIntbwhserfprinter2($v)
    {
        ...
        if ($this->intbwhserfprinter2 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSERFPRINTER2] = true;
        }
    ...
    public function setIntbwhserfprinter3($v)
    {
        ...
        if ($this->intbwhserfprinter3 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSERFPRINTER3] = true;
        }
    ...
    public function setIntbwhserfprinter4($v)
    {
        ...
        if ($this->intbwhserfprinter4 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSERFPRINTER4] = true;
        }
    ...
    public function setIntbwhserfprinter5($v)
    {
        ...
        if ($this->intbwhserfprinter5 !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSERFPRINTER5] = true;
        }
    ...
    public function setIntbwhseprofwhse($v)
    {
        ...
        if ($this->intbwhseprofwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEPROFWHSE] = true;
        }
    ...
    public function setIntbwhseasetwhse($v)
    {
        ...
        if ($this->intbwhseasetwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEASETWHSE] = true;
        }
    ...
    public function setIntbwhseconsignwhse($v)
    {
        ...
        if ($this->intbwhseconsignwhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSECONSIGNWHSE] = true;
        }
    ...
    public function setIntbwhsebinrangelist($v)
    {
        ...
        if ($this->intbwhsebinrangelist !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSEBINRANGELIST] = true;
        }
    ...
    public function setIntbwhsesupplywhse($v)
    {
        ...
        if ($this->intbwhsesupplywhse !== $v) {
            ...
            $this->modifiedColumns[InvWhseFromTableMap::COL_INTBWHSESUPPLYWHSE] = true;
        }
    ...
    public function setDateupdtd($v)
    {
        ...
        if ($this->dateupdtd !== $v) {
            $this->dateupdtd = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_DATEUPDTD] = true;
        }
    ...
    public function setTimeupdtd($v)
    {
        ...
        if ($this->timeupdtd !== $v) {
            $this->timeupdtd = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_TIMEUPDTD] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[InvWhseFromTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsefrom', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefrom = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseadr1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseadr2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseadr2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsecity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecity = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsestat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsestat = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsezipcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsezipcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsectry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsectry = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseusehandheld', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseusehandheld = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsecashcust', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsecashcust = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsepickdtl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepickdtl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseprodbin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprodbin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsepharea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsepharea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsephfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsephlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsephext', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsephext = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsefaxarea', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxarea = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsefaxfrst3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxfrst3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsefaxlast4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsefaxlast4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseemailadr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseemailadr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseqcrgabin', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseqcrgabin = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhserfprinter1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhserfprinter2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhserfprinter3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhserfprinter4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhserfprinter5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhserfprinter5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseprofwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseprofwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseasetwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseasetwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhseconsignwhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhseconsignwhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsebinrangelist', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsebinrangelist = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : InvWhseFromTableMap::translateFieldName('Intbwhsesupplywhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->intbwhsesupplywhse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : InvWhseFromTableMap::translateFieldName('Dateupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dateupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : InvWhseFromTableMap::translateFieldName('Timeupdtd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->timeupdtd = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : InvWhseFromTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 34; // 34 = InvWhseFromTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\InvWhseFrom'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildInvWhseFromQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see InvWhseFrom::setDeleted()
     * @see InvWhseFrom::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildInvWhseFromQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                InvWhseFromTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFROM)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFrom';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSENAME)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseName';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEADR1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr1';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEADR2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAdr2';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECITY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCity';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSESTAT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseStat';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEZIPCODE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseZipCode';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECTRY)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCtry';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseUseHandheld';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECASHCUST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseCashCust';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPICKDTL)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePickDtl';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPRODBIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProdBin';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhArea';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhFrst3';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhLast4';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHEXT)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhsePhExt';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXAREA)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxArea';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXFRST3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxFrst3';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXLAST4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseFaxLast4';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEEMAILADR)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseEmailAdr';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEQCRGABIN)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseQcRgaBin';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER1)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter1';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER2)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter2';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER3)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter3';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER4)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter4';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER5)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseRfPrinter5';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPROFWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseProfWhse';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEASETWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseAsetWhse';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseConsignWhse';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEBINRANGELIST)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseBinRangeList';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $modifiedColumns[':p' . $index++]  = 'IntbWhseSupplyWhse';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_DATEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'DateUpdtd';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_TIMEUPDTD)) {
            $modifiedColumns[':p' . $index++]  = 'TimeUpdtd';
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO inv_whse_from (%s) VALUES (%s)',
    ...
    {
        $pos = InvWhseFromTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['InvWhseFrom'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['InvWhseFrom'][$this->hashCode()] = true;
        $keys = InvWhseFromTableMap::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getIntbwhsefrom(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIntbwhsefrom($arr[$keys[0]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFROM)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEFROM, $this->intbwhsefrom);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSENAME)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSENAME, $this->intbwhsename);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEADR1)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEADR1, $this->intbwhseadr1);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEADR2)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEADR2, $this->intbwhseadr2);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECITY)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSECITY, $this->intbwhsecity);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSESTAT)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSESTAT, $this->intbwhsestat);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEZIPCODE)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEZIPCODE, $this->intbwhsezipcode);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECTRY)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSECTRY, $this->intbwhsectry);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEUSEHANDHELD)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEUSEHANDHELD, $this->intbwhseusehandheld);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECASHCUST)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSECASHCUST, $this->intbwhsecashcust);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPICKDTL)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPICKDTL, $this->intbwhsepickdtl);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPRODBIN)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPRODBIN, $this->intbwhseprodbin);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHAREA)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPHAREA, $this->intbwhsepharea);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHFRST3)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPHFRST3, $this->intbwhsephfrst3);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHLAST4)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPHLAST4, $this->intbwhsephlast4);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPHEXT)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPHEXT, $this->intbwhsephext);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXAREA)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEFAXAREA, $this->intbwhsefaxarea);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXFRST3)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEFAXFRST3, $this->intbwhsefaxfrst3);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEFAXLAST4)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEFAXLAST4, $this->intbwhsefaxlast4);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEEMAILADR)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEEMAILADR, $this->intbwhseemailadr);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEQCRGABIN)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEQCRGABIN, $this->intbwhseqcrgabin);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER1)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSERFPRINTER1, $this->intbwhserfprinter1);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER2)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSERFPRINTER2, $this->intbwhserfprinter2);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER3)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSERFPRINTER3, $this->intbwhserfprinter3);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER4)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSERFPRINTER4, $this->intbwhserfprinter4);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSERFPRINTER5)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSERFPRINTER5, $this->intbwhserfprinter5);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEPROFWHSE)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEPROFWHSE, $this->intbwhseprofwhse);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEASETWHSE)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEASETWHSE, $this->intbwhseasetwhse);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSECONSIGNWHSE)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSECONSIGNWHSE, $this->intbwhseconsignwhse);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSEBINRANGELIST)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSEBINRANGELIST, $this->intbwhsebinrangelist);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_INTBWHSESUPPLYWHSE)) {
            $criteria->add(InvWhseFromTableMap::COL_INTBWHSESUPPLYWHSE, $this->intbwhsesupplywhse);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_DATEUPDTD)) {
            $criteria->add(InvWhseFromTableMap::COL_DATEUPDTD, $this->dateupdtd);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_TIMEUPDTD)) {
            $criteria->add(InvWhseFromTableMap::COL_TIMEUPDTD, $this->timeupdtd);
        }
        if ($this->isColumnModified(InvWhseFromTableMap::COL_DUMMY)) {
            $criteria->add(InvWhseFromTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildInvWhseFromQuery::create();
        $criteria->add(InvWhseFromTableMap::COL_INTBWHSEFROM, $this->intbwhsefrom);
    ...
    {
        $validPk = null !== $this->getIntbwhsefrom();
    ...
    /**
     * Generic method to set the primary key (intbwhsefrom column).
     *
    ...
    {
        return null === $this->getIntbwhsefrom();
    }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \InvWhseFrom (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \InvWhseFrom Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(InvWhseFromTableMap::DEFAULT_STRING_FORMAT);
    }
