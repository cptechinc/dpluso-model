...
/**
 * Base class that represents a row from the 'oe_head' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class OeHead implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\OeHeadTableMap';
    ...
    /**
     * Initializes internal state of Base\OeHead object.
     */
    ...
    /**
     * Compares this with another <code>OeHead</code> instance.  If
     * <code>obj</code> is an instance of <code>OeHead</code>, delegates to
     * <code>equals(OeHead)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|OeHead The current object, for fluid interface
     */
     ...
     * @return $this|\OeHead The current object (for fluent API support)
     */
    public function setOrdernumber($v)
    {
        ...
        if ($this->ordernumber !== $v) {
            $this->ordernumber = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ORDERNUMBER] = true;
        }
    ...
    public function setStatus($v)
    {
        ...
        if ($this->status !== $v) {
            $this->status = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_STATUS] = true;
        }
    ...
    public function setHoldstatus($v)
    {
        ...
        if ($this->holdstatus !== $v) {
            $this->holdstatus = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_HOLDSTATUS] = true;
        }
    ...
    public function setCustid($v)
    {
        ...
        if ($this->custid !== $v) {
            $this->custid = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CUSTID] = true;
        }
    ...
    public function setShiptoid($v)
    {
        ...
        if ($this->shiptoid !== $v) {
            $this->shiptoid = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTOID] = true;
        }
    ...
    public function setShiptoName($v)
    {
        ...
        if ($this->shipto_name !== $v) {
            $this->shipto_name = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_NAME] = true;
        }
    ...
    public function setShiptoAddress1($v)
    {
        ...
        if ($this->shipto_address1 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_ADDRESS1] = true;
        }
    ...
    public function setShiptoAddress2($v)
    {
        ...
        if ($this->shipto_address2 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_ADDRESS2] = true;
        }
    ...
    public function setShiptoAddress3($v)
    {
        ...
        if ($this->shipto_address3 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_ADDRESS3] = true;
        }
    ...
    public function setShiptoAddress4($v)
    {
        ...
        if ($this->shipto_address4 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_ADDRESS4] = true;
        }
    ...
    public function setShiptoCity($v)
    {
        ...
        if ($this->shipto_city !== $v) {
            $this->shipto_city = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_CITY] = true;
        }
    ...
    public function setShiptoState($v)
    {
        ...
        if ($this->shipto_state !== $v) {
            $this->shipto_state = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_STATE] = true;
        }
    ...
    public function setShiptoZip($v)
    {
        ...
        if ($this->shipto_zip !== $v) {
            $this->shipto_zip = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPTO_ZIP] = true;
        }
    ...
    public function setCustpo($v)
    {
        ...
        if ($this->custpo !== $v) {
            $this->custpo = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CUSTPO] = true;
        }
    ...
    public function setOrderDate($v)
    {
        ...
        if ($this->order_date !== $v) {
            $this->order_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ORDER_DATE] = true;
        }
    ...
    public function setTermcode($v)
    {
        ...
        if ($this->termcode !== $v) {
            $this->termcode = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TERMCODE] = true;
        }
    ...
    public function setShipviacode($v)
    {
        ...
        if ($this->shipviacode !== $v) {
            $this->shipviacode = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPVIACODE] = true;
        }
    ...
    public function setInvoiceNumber($v)
    {
        ...
        if ($this->invoice_number !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_INVOICE_NUMBER] = true;
        }
    ...
    public function setInvoiceDate($v)
    {
        ...
        if ($this->invoice_date !== $v) {
            $this->invoice_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_INVOICE_DATE] = true;
        }
    ...
    public function setGenledgerPeriod($v)
    {
        ...
        if ($this->genledger_period !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_GENLEDGER_PERIOD] = true;
        }
    ...
    public function setSalesperson1($v)
    {
        ...
        if ($this->salesperson_1 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_1] = true;
        }
    ...
    public function setSalesperson1pct($v)
    {
        ...
        if ($this->salesperson_1pct !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_1PCT] = true;
        }
    ...
    public function setSalesperson2($v)
    {
        ...
        if ($this->salesperson_2 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_2] = true;
        }
    ...
    public function setSalesperson2pct($v)
    {
        ...
        if ($this->salesperson_2pct !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_2PCT] = true;
        }
    ...
    public function setSalesperson3($v)
    {
        ...
        if ($this->salesperson_3 !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_3] = true;
        }
    ...
    public function setSalesperson3pct($v)
    {
        ...
        if ($this->salesperson_3pct !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SALESPERSON_3PCT] = true;
        }
    ...
    public function setContractNbr($v)
    {
        ...
        if ($this->contract_nbr !== $v) {
            $this->contract_nbr = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CONTRACT_NBR] = true;
        }
    ...
    public function setBatchNbr($v)
    {
        ...
        if ($this->batch_nbr !== $v) {
            $this->batch_nbr = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_BATCH_NBR] = true;
        }
    ...
    public function setDropreleasehold($v)
    {
        ...
        if ($this->dropreleasehold !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DROPRELEASEHOLD] = true;
        }
    ...
    public function setSubtotalNontax($v)
    {
        ...
        if ($this->subtotal_nontax !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SUBTOTAL_NONTAX] = true;
        }
    ...
    public function setSubtotalTax($v)
    {
        ...
        if ($this->subtotal_tax !== $v) {
            $this->subtotal_tax = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SUBTOTAL_TAX] = true;
        }
    ...
    public function setTotalTax($v)
    {
        ...
        if ($this->total_tax !== $v) {
            $this->total_tax = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_TAX] = true;
        }
    ...
    public function setTotalFreight($v)
    {
        ...
        if ($this->total_freight !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_FREIGHT] = true;
        }
    ...
    public function setTotalMisc($v)
    {
        ...
        if ($this->total_misc !== $v) {
            $this->total_misc = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_MISC] = true;
        }
    ...
    public function setTotalOrder($v)
    {
        ...
        if ($this->total_order !== $v) {
            $this->total_order = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_ORDER] = true;
        }
    ...
    public function setTotalCost($v)
    {
        ...
        if ($this->total_cost !== $v) {
            $this->total_cost = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_COST] = true;
        }
    ...
    public function setLock($v)
    {
        ...
        if ($this->lock !== $v) {
            $this->lock = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_LOCK] = true;
        }
    ...
    public function setTakenDate($v)
    {
        ...
        if ($this->taken_date !== $v) {
            $this->taken_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TAKEN_DATE] = true;
        }
    ...
    public function setTakenTime($v)
    {
        ...
        if ($this->taken_time !== $v) {
            $this->taken_time = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TAKEN_TIME] = true;
        }
    ...
    public function setPickDate($v)
    {
        ...
        if ($this->pick_date !== $v) {
            $this->pick_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_DATE] = true;
        }
    ...
    public function setPickTime($v)
    {
        ...
        if ($this->pick_time !== $v) {
            $this->pick_time = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_TIME] = true;
        }
    ...
    public function setPackDate($v)
    {
        ...
        if ($this->pack_date !== $v) {
            $this->pack_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PACK_DATE] = true;
        }
    ...
    public function setPackTime($v)
    {
        ...
        if ($this->pack_time !== $v) {
            $this->pack_time = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PACK_TIME] = true;
        }
    ...
    public function setVerifyDate($v)
    {
        ...
        if ($this->verify_date !== $v) {
            $this->verify_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_VERIFY_DATE] = true;
        }
    ...
    public function setVerifyTime($v)
    {
        ...
        if ($this->verify_time !== $v) {
            $this->verify_time = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_VERIFY_TIME] = true;
        }
    ...
    public function setCreditmemo($v)
    {
        ...
        if ($this->creditmemo !== $v) {
            $this->creditmemo = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CREDITMEMO] = true;
        }
    ...
    public function setBooked($v)
    {
        ...
        if ($this->booked !== $v) {
            $this->booked = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_BOOKED] = true;
        }
    ...
    public function setOriginalWhse($v)
    {
        ...
        if ($this->original_whse !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_WHSE] = true;
        }
    ...
    public function setBilltoState($v)
    {
        ...
        if ($this->billto_state !== $v) {
            $this->billto_state = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_BILLTO_STATE] = true;
        }
    ...
    public function setShipcomplete($v)
    {
        ...
        if ($this->shipcomplete !== $v) {
            $this->shipcomplete = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIPCOMPLETE] = true;
        }
    ...
    public function setCwoFlag($v)
    {
        ...
        if ($this->cwo_flag !== $v) {
            $this->cwo_flag = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CWO_FLAG] = true;
        }
    ...
    public function setDivision($v)
    {
        ...
        if ($this->division !== $v) {
            $this->division = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_DIVISION] = true;
        }
    ...
    public function setTakenCode($v)
    {
        ...
        if ($this->taken_code !== $v) {
            $this->taken_code = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TAKEN_CODE] = true;
        }
    ...
    public function setPackCode($v)
    {
        ...
        if ($this->pack_code !== $v) {
            $this->pack_code = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PACK_CODE] = true;
        }
    ...
    public function setPickCode($v)
    {
        ...
        if ($this->pick_code !== $v) {
            $this->pick_code = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_CODE] = true;
        }
    ...
    public function setVerifyCode($v)
    {
        ...
        if ($this->verify_code !== $v) {
            $this->verify_code = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_VERIFY_CODE] = true;
        }
    ...
    public function setTotalDiscount($v)
    {
        ...
        if ($this->total_discount !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_TOTAL_DISCOUNT] = true;
        }
    ...
    public function setEdiRefererencenbr($v)
    {
        ...
        if ($this->edi_refererencenbr !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_EDI_REFERERENCENBR] = true;
        }
    ...
    public function setUserCode1($v)
    {
        ...
        if ($this->user_code1 !== $v) {
            $this->user_code1 = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_USER_CODE1] = true;
        }
    ...
    public function setUserCode2($v)
    {
        ...
        if ($this->user_code2 !== $v) {
            $this->user_code2 = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_USER_CODE2] = true;
        }
    ...
    public function setUserCode3($v)
    {
        ...
        if ($this->user_code3 !== $v) {
            $this->user_code3 = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_USER_CODE3] = true;
        }
    ...
    public function setUserCode4($v)
    {
        ...
        if ($this->user_code4 !== $v) {
            $this->user_code4 = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_USER_CODE4] = true;
        }
    ...
    public function setExchangeCountry($v)
    {
        ...
        if ($this->exchange_country !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_EXCHANGE_COUNTRY] = true;
        }
    ...
    public function setExchangeRate($v)
    {
        ...
        if ($this->exchange_rate !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_EXCHANGE_RATE] = true;
        }
    ...
    public function setWeightTotal($v)
    {
        ...
        if ($this->weight_total !== $v) {
            $this->weight_total = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_WEIGHT_TOTAL] = true;
        }
    ...
    public function setWeightOverride($v)
    {
        ...
        if ($this->weight_override !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_WEIGHT_OVERRIDE] = true;
        }
    ...
    public function setBoxCount($v)
    {
        ...
        if ($this->box_count !== $v) {
            $this->box_count = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_BOX_COUNT] = true;
        }
    ...
    public function setRequestDate($v)
    {
        ...
        if ($this->request_date !== $v) {
            $this->request_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_REQUEST_DATE] = true;
        }
    ...
    public function setCancelDate($v)
    {
        ...
        if ($this->cancel_date !== $v) {
            $this->cancel_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CANCEL_DATE] = true;
        }
    ...
    public function setLockedby($v)
    {
        ...
        if ($this->lockedby !== $v) {
            $this->lockedby = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_LOCKEDBY] = true;
        }
    ...
    public function setReleaseNumber($v)
    {
        ...
        if ($this->release_number !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_RELEASE_NUMBER] = true;
        }
    ...
    public function setWhse($v)
    {
        ...
        if ($this->whse !== $v) {
            $this->whse = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_WHSE] = true;
        }
    ...
    public function setBackorderDate($v)
    {
        ...
        if ($this->backorder_date !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_BACKORDER_DATE] = true;
        }
    ...
    public function setDeptcode($v)
    {
        ...
        if ($this->deptcode !== $v) {
            $this->deptcode = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_DEPTCODE] = true;
        }
    ...
    public function setFreightInEntered($v)
    {
        ...
        if ($this->freight_in_entered !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_FREIGHT_IN_ENTERED] = true;
        }
    ...
    public function setDropshipEntered($v)
    {
        ...
        if ($this->dropship_entered !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DROPSHIP_ENTERED] = true;
        }
    ...
    public function setErFlag($v)
    {
        ...
        if ($this->er_flag !== $v) {
            $this->er_flag = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ER_FLAG] = true;
        }
    ...
    public function setFreightIn($v)
    {
        ...
        if ($this->freight_in !== $v) {
            $this->freight_in = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_FREIGHT_IN] = true;
        }
    ...
    public function setDropship($v)
    {
        ...
        if ($this->dropship !== $v) {
            $this->dropship = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_DROPSHIP] = true;
        }
    ...
    public function setMinorder($v)
    {
        ...
        if ($this->minorder !== $v) {
            $this->minorder = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_MINORDER] = true;
        }
    ...
    public function setContractTerms($v)
    {
        ...
        if ($this->contract_terms !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_CONTRACT_TERMS] = true;
        }
    ...
    public function setDropshipBilled($v)
    {
        ...
        if ($this->dropship_billed !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DROPSHIP_BILLED] = true;
        }
    ...
    public function setOrderType($v)
    {
        ...
        if ($this->order_type !== $v) {
            $this->order_type = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ORDER_TYPE] = true;
        }
    ...
    public function setTrackingEdinumber($v)
    {
        ...
        if ($this->tracking_edinumber !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_TRACKING_EDINUMBER] = true;
        }
    ...
    public function setSource($v)
    {
        ...
        if ($this->source !== $v) {
            $this->source = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SOURCE] = true;
        }
    ...
    public function setPickFormat($v)
    {
        ...
        if ($this->pick_format !== $v) {
            $this->pick_format = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_FORMAT] = true;
        }
    ...
    public function setInvoiceFormat($v)
    {
        ...
        if ($this->invoice_format !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_INVOICE_FORMAT] = true;
        }
    ...
    public function setCashAmount($v)
    {
        ...
        if ($this->cash_amount !== $v) {
            $this->cash_amount = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CASH_AMOUNT] = true;
        }
    ...
    public function setCheckAmount($v)
    {
        ...
        if ($this->check_amount !== $v) {
            $this->check_amount = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CHECK_AMOUNT] = true;
        }
    ...
    public function setCheckNumber($v)
    {
        ...
        if ($this->check_number !== $v) {
            $this->check_number = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CHECK_NUMBER] = true;
        }
    ...
    public function setDepositAmount($v)
    {
        ...
        if ($this->deposit_amount !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DEPOSIT_AMOUNT] = true;
        }
    ...
    public function setDepositNumber($v)
    {
        ...
        if ($this->deposit_number !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DEPOSIT_NUMBER] = true;
        }
    ...
    public function setOriginalSubtotalTax($v)
    {
        ...
        if ($this->original_subtotal_tax !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_TAX] = true;
        }
    ...
    public function setOriginalSubtotalNontax($v)
    {
        ...
        if ($this->original_subtotal_nontax !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX] = true;
        }
    ...
    public function setOriginalTotalTax($v)
    {
        ...
        if ($this->original_total_tax !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_TOTAL_TAX] = true;
        }
    ...
    public function setOriginalTotal($v)
    {
        ...
        if ($this->original_total !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_TOTAL] = true;
        }
    ...
    public function setPickPrintdate($v)
    {
        ...
        if ($this->pick_printdate !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_PRINTDATE] = true;
        }
    ...
    public function setPickPrinttime($v)
    {
        ...
        if ($this->pick_printtime !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_PRINTTIME] = true;
        }
    ...
    public function setContact($v)
    {
        ...
        if ($this->contact !== $v) {
            $this->contact = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CONTACT] = true;
        }
    ...
    public function setPhoneIntl($v)
    {
        ...
        if ($this->phone_intl !== $v) {
            $this->phone_intl = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PHONE_INTL] = true;
        }
    ...
    public function setPhoneAccesscode($v)
    {
        ...
        if ($this->phone_accesscode !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_PHONE_ACCESSCODE] = true;
        }
    ...
    public function setPhoneCountrycode($v)
    {
        ...
        if ($this->phone_countrycode !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_PHONE_COUNTRYCODE] = true;
        }
    ...
    public function setPhone($v)
    {
        ...
        if ($this->phone !== $v) {
            $this->phone = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PHONE] = true;
        }
    ...
    public function setPhoneExt($v)
    {
        ...
        if ($this->phone_ext !== $v) {
            $this->phone_ext = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PHONE_EXT] = true;
        }
    ...
    public function setFaxIntl($v)
    {
        ...
        if ($this->fax_intl !== $v) {
            $this->fax_intl = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_FAX_INTL] = true;
        }
    ...
    public function setFaxAccesscode($v)
    {
        ...
        if ($this->fax_accesscode !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_FAX_ACCESSCODE] = true;
        }
    ...
    public function setFaxCountrycode($v)
    {
        ...
        if ($this->fax_countrycode !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_FAX_COUNTRYCODE] = true;
        }
    ...
    public function setFax($v)
    {
        ...
        if ($this->fax !== $v) {
            $this->fax = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_FAX] = true;
        }
    ...
    public function setShipAccount($v)
    {
        ...
        if ($this->ship_account !== $v) {
            $this->ship_account = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_SHIP_ACCOUNT] = true;
        }
    ...
    public function setChangeDue($v)
    {
        ...
        if ($this->change_due !== $v) {
            $this->change_due = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CHANGE_DUE] = true;
        }
    ...
    public function setDiscountAdditional($v)
    {
        ...
        if ($this->discount_additional !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DISCOUNT_ADDITIONAL] = true;
        }
    ...
    public function setAllShip($v)
    {
        ...
        if ($this->all_ship !== $v) {
            $this->all_ship = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ALL_SHIP] = true;
        }
    ...
    public function setCreditApplied($v)
    {
        ...
        if ($this->credit_applied !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_CREDIT_APPLIED] = true;
        }
    ...
    public function setInvoicePrintdate($v)
    {
        ...
        if ($this->invoice_printdate !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_INVOICE_PRINTDATE] = true;
        }
    ...
    public function setInvoicePrinttime($v)
    {
        ...
        if ($this->invoice_printtime !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_INVOICE_PRINTTIME] = true;
        }
    ...
    public function setDiscountFreight($v)
    {
        ...
        if ($this->discount_freight !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_DISCOUNT_FREIGHT] = true;
        }
    ...
    public function setShipCompleteoverride($v)
    {
        ...
        if ($this->ship_completeoverride !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SHIP_COMPLETEOVERRIDE] = true;
        }
    ...
    public function setContactEmail($v)
    {
        ...
        if ($this->contact_email !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_CONTACT_EMAIL] = true;
        }
    ...
    public function setManualFreight($v)
    {
        ...
        if ($this->manual_freight !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_MANUAL_FREIGHT] = true;
        }
    ...
    public function setInternalFreight($v)
    {
        ...
        if ($this->internal_freight !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_INTERNAL_FREIGHT] = true;
        }
    ...
    public function setCostFreight($v)
    {
        ...
        if ($this->cost_freight !== $v) {
            $this->cost_freight = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_COST_FREIGHT] = true;
        }
    ...
    public function setRoute($v)
    {
        ...
        if ($this->route !== $v) {
            $this->route = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ROUTE] = true;
        }
    ...
    public function setRouteSeq($v)
    {
        ...
        if ($this->route_seq !== $v) {
            $this->route_seq = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ROUTE_SEQ] = true;
        }
    ...
    public function setEdi855sent($v)
    {
        ...
        if ($this->edi_855sent !== $v) {
            $this->edi_855sent = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_EDI_855SENT] = true;
        }
    ...
    public function setFreight3rdparty($v)
    {
        ...
        if ($this->freight_3rdparty !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_FREIGHT_3RDPARTY] = true;
        }
    ...
    public function setFob($v)
    {
        ...
        if ($this->fob !== $v) {
            $this->fob = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_FOB] = true;
        }
    ...
    public function setConfirmImage($v)
    {
        ...
        if ($this->confirm_image !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_CONFIRM_IMAGE] = true;
        }
    ...
    public function setCstkConsign($v)
    {
        ...
        if ($this->cstk_consign !== $v) {
            $this->cstk_consign = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CSTK_CONSIGN] = true;
        }
    ...
    public function setManufacturer($v)
    {
        ...
        if ($this->manufacturer !== $v) {
            $this->manufacturer = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_MANUFACTURER] = true;
        }
    ...
    public function setPickQueue($v)
    {
        ...
        if ($this->pick_queue !== $v) {
            $this->pick_queue = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_PICK_QUEUE] = true;
        }
    ...
    public function setArriveDate($v)
    {
        ...
        if ($this->arrive_date !== $v) {
            $this->arrive_date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_ARRIVE_DATE] = true;
        }
    ...
    public function setSurchargeStatus($v)
    {
        ...
        if ($this->surcharge_status !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_SURCHARGE_STATUS] = true;
        }
    ...
    public function setFreightGroup($v)
    {
        ...
        if ($this->freight_group !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_FREIGHT_GROUP] = true;
        }
    ...
    public function setCommOverride($v)
    {
        ...
        if ($this->comm_override !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_COMM_OVERRIDE] = true;
        }
    ...
    public function setChargeSplit($v)
    {
        ...
        if ($this->charge_split !== $v) {
            $this->charge_split = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_CHARGE_SPLIT] = true;
        }
    ...
    public function setCreditcartApproved($v)
    {
        ...
        if ($this->creditcart_approved !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_CREDITCART_APPROVED] = true;
        }
    ...
    public function setOriginalOrdernumber($v)
    {
        ...
        if ($this->original_ordernumber !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_ORIGINAL_ORDERNUMBER] = true;
        }
    ...
    public function setHasNotes($v)
    {
        ...
        if ($this->has_notes !== $v) {
            $this->has_notes = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_HAS_NOTES] = true;
        }
    ...
    public function setHasDocuments($v)
    {
        ...
        if ($this->has_documents !== $v) {
            ...
            $this->modifiedColumns[OeHeadTableMap::COL_HAS_DOCUMENTS] = true;
        }
    ...
    public function setHasTracking($v)
    {
        ...
        if ($this->has_tracking !== $v) {
            $this->has_tracking = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_HAS_TRACKING] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_TIME] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[OeHeadTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : OeHeadTableMap::translateFieldName('Ordernumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ordernumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : OeHeadTableMap::translateFieldName('Status', TableMap::TYPE_PHPNAME, $indexType)];
            $this->status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : OeHeadTableMap::translateFieldName('Holdstatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->holdstatus = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : OeHeadTableMap::translateFieldName('Custid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : OeHeadTableMap::translateFieldName('Shiptoid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shiptoid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : OeHeadTableMap::translateFieldName('ShiptoName', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_name = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : OeHeadTableMap::translateFieldName('ShiptoAddress1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_address1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : OeHeadTableMap::translateFieldName('ShiptoAddress2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_address2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : OeHeadTableMap::translateFieldName('ShiptoAddress3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_address3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : OeHeadTableMap::translateFieldName('ShiptoAddress4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_address4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : OeHeadTableMap::translateFieldName('ShiptoCity', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_city = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : OeHeadTableMap::translateFieldName('ShiptoState', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : OeHeadTableMap::translateFieldName('ShiptoZip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipto_zip = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : OeHeadTableMap::translateFieldName('Custpo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->custpo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : OeHeadTableMap::translateFieldName('OrderDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : OeHeadTableMap::translateFieldName('Termcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->termcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : OeHeadTableMap::translateFieldName('Shipviacode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipviacode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : OeHeadTableMap::translateFieldName('InvoiceNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_number = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : OeHeadTableMap::translateFieldName('InvoiceDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : OeHeadTableMap::translateFieldName('GenledgerPeriod', TableMap::TYPE_PHPNAME, $indexType)];
            $this->genledger_period = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : OeHeadTableMap::translateFieldName('Salesperson1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : OeHeadTableMap::translateFieldName('Salesperson1pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_1pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : OeHeadTableMap::translateFieldName('Salesperson2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : OeHeadTableMap::translateFieldName('Salesperson2pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_2pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : OeHeadTableMap::translateFieldName('Salesperson3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : OeHeadTableMap::translateFieldName('Salesperson3pct', TableMap::TYPE_PHPNAME, $indexType)];
            $this->salesperson_3pct = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : OeHeadTableMap::translateFieldName('ContractNbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contract_nbr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : OeHeadTableMap::translateFieldName('BatchNbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->batch_nbr = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : OeHeadTableMap::translateFieldName('Dropreleasehold', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dropreleasehold = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : OeHeadTableMap::translateFieldName('SubtotalNontax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal_nontax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : OeHeadTableMap::translateFieldName('SubtotalTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->subtotal_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : OeHeadTableMap::translateFieldName('TotalTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : OeHeadTableMap::translateFieldName('TotalFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : OeHeadTableMap::translateFieldName('TotalMisc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_misc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : OeHeadTableMap::translateFieldName('TotalOrder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_order = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : OeHeadTableMap::translateFieldName('TotalCost', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_cost = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : OeHeadTableMap::translateFieldName('Lock', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lock = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : OeHeadTableMap::translateFieldName('TakenDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taken_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : OeHeadTableMap::translateFieldName('TakenTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taken_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : OeHeadTableMap::translateFieldName('PickDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : OeHeadTableMap::translateFieldName('PickTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : OeHeadTableMap::translateFieldName('PackDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pack_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : OeHeadTableMap::translateFieldName('PackTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pack_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : OeHeadTableMap::translateFieldName('VerifyDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verify_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : OeHeadTableMap::translateFieldName('VerifyTime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verify_time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : OeHeadTableMap::translateFieldName('Creditmemo', TableMap::TYPE_PHPNAME, $indexType)];
            $this->creditmemo = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : OeHeadTableMap::translateFieldName('Booked', TableMap::TYPE_PHPNAME, $indexType)];
            $this->booked = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : OeHeadTableMap::translateFieldName('OriginalWhse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : OeHeadTableMap::translateFieldName('BilltoState', TableMap::TYPE_PHPNAME, $indexType)];
            $this->billto_state = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : OeHeadTableMap::translateFieldName('Shipcomplete', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shipcomplete = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : OeHeadTableMap::translateFieldName('CwoFlag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cwo_flag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : OeHeadTableMap::translateFieldName('Division', TableMap::TYPE_PHPNAME, $indexType)];
            $this->division = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : OeHeadTableMap::translateFieldName('TakenCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->taken_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 53 + $startcol : OeHeadTableMap::translateFieldName('PackCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pack_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 54 + $startcol : OeHeadTableMap::translateFieldName('PickCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 55 + $startcol : OeHeadTableMap::translateFieldName('VerifyCode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->verify_code = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 56 + $startcol : OeHeadTableMap::translateFieldName('TotalDiscount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->total_discount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 57 + $startcol : OeHeadTableMap::translateFieldName('EdiRefererencenbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->edi_refererencenbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 58 + $startcol : OeHeadTableMap::translateFieldName('UserCode1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_code1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 59 + $startcol : OeHeadTableMap::translateFieldName('UserCode2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_code2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 60 + $startcol : OeHeadTableMap::translateFieldName('UserCode3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_code3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 61 + $startcol : OeHeadTableMap::translateFieldName('UserCode4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->user_code4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 62 + $startcol : OeHeadTableMap::translateFieldName('ExchangeCountry', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exchange_country = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 63 + $startcol : OeHeadTableMap::translateFieldName('ExchangeRate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->exchange_rate = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 64 + $startcol : OeHeadTableMap::translateFieldName('WeightTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weight_total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 65 + $startcol : OeHeadTableMap::translateFieldName('WeightOverride', TableMap::TYPE_PHPNAME, $indexType)];
            $this->weight_override = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 66 + $startcol : OeHeadTableMap::translateFieldName('BoxCount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->box_count = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 67 + $startcol : OeHeadTableMap::translateFieldName('RequestDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->request_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 68 + $startcol : OeHeadTableMap::translateFieldName('CancelDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cancel_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 69 + $startcol : OeHeadTableMap::translateFieldName('Lockedby', TableMap::TYPE_PHPNAME, $indexType)];
            $this->lockedby = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 70 + $startcol : OeHeadTableMap::translateFieldName('ReleaseNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->release_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 71 + $startcol : OeHeadTableMap::translateFieldName('Whse', TableMap::TYPE_PHPNAME, $indexType)];
            $this->whse = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 72 + $startcol : OeHeadTableMap::translateFieldName('BackorderDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->backorder_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 73 + $startcol : OeHeadTableMap::translateFieldName('Deptcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deptcode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 74 + $startcol : OeHeadTableMap::translateFieldName('FreightInEntered', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight_in_entered = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 75 + $startcol : OeHeadTableMap::translateFieldName('DropshipEntered', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dropship_entered = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 76 + $startcol : OeHeadTableMap::translateFieldName('ErFlag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->er_flag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 77 + $startcol : OeHeadTableMap::translateFieldName('FreightIn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight_in = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 78 + $startcol : OeHeadTableMap::translateFieldName('Dropship', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dropship = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 79 + $startcol : OeHeadTableMap::translateFieldName('Minorder', TableMap::TYPE_PHPNAME, $indexType)];
            $this->minorder = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 80 + $startcol : OeHeadTableMap::translateFieldName('ContractTerms', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contract_terms = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 81 + $startcol : OeHeadTableMap::translateFieldName('DropshipBilled', TableMap::TYPE_PHPNAME, $indexType)];
            $this->dropship_billed = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 82 + $startcol : OeHeadTableMap::translateFieldName('OrderType', TableMap::TYPE_PHPNAME, $indexType)];
            $this->order_type = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 83 + $startcol : OeHeadTableMap::translateFieldName('TrackingEdinumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->tracking_edinumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 84 + $startcol : OeHeadTableMap::translateFieldName('Source', TableMap::TYPE_PHPNAME, $indexType)];
            $this->source = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 85 + $startcol : OeHeadTableMap::translateFieldName('PickFormat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_format = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 86 + $startcol : OeHeadTableMap::translateFieldName('InvoiceFormat', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_format = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 87 + $startcol : OeHeadTableMap::translateFieldName('CashAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cash_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 88 + $startcol : OeHeadTableMap::translateFieldName('CheckAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->check_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 89 + $startcol : OeHeadTableMap::translateFieldName('CheckNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->check_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 90 + $startcol : OeHeadTableMap::translateFieldName('DepositAmount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deposit_amount = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 91 + $startcol : OeHeadTableMap::translateFieldName('DepositNumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->deposit_number = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 92 + $startcol : OeHeadTableMap::translateFieldName('OriginalSubtotalTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_subtotal_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 93 + $startcol : OeHeadTableMap::translateFieldName('OriginalSubtotalNontax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_subtotal_nontax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 94 + $startcol : OeHeadTableMap::translateFieldName('OriginalTotalTax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_total_tax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 95 + $startcol : OeHeadTableMap::translateFieldName('OriginalTotal', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_total = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 96 + $startcol : OeHeadTableMap::translateFieldName('PickPrintdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_printdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 97 + $startcol : OeHeadTableMap::translateFieldName('PickPrinttime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_printtime = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 98 + $startcol : OeHeadTableMap::translateFieldName('Contact', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 99 + $startcol : OeHeadTableMap::translateFieldName('PhoneIntl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_intl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 100 + $startcol : OeHeadTableMap::translateFieldName('PhoneAccesscode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_accesscode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 101 + $startcol : OeHeadTableMap::translateFieldName('PhoneCountrycode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_countrycode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 102 + $startcol : OeHeadTableMap::translateFieldName('Phone', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 103 + $startcol : OeHeadTableMap::translateFieldName('PhoneExt', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phone_ext = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 104 + $startcol : OeHeadTableMap::translateFieldName('FaxIntl', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fax_intl = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 105 + $startcol : OeHeadTableMap::translateFieldName('FaxAccesscode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fax_accesscode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 106 + $startcol : OeHeadTableMap::translateFieldName('FaxCountrycode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fax_countrycode = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 107 + $startcol : OeHeadTableMap::translateFieldName('Fax', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fax = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 108 + $startcol : OeHeadTableMap::translateFieldName('ShipAccount', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ship_account = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 109 + $startcol : OeHeadTableMap::translateFieldName('ChangeDue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->change_due = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 110 + $startcol : OeHeadTableMap::translateFieldName('DiscountAdditional', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_additional = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 111 + $startcol : OeHeadTableMap::translateFieldName('AllShip', TableMap::TYPE_PHPNAME, $indexType)];
            $this->all_ship = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 112 + $startcol : OeHeadTableMap::translateFieldName('CreditApplied', TableMap::TYPE_PHPNAME, $indexType)];
            $this->credit_applied = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 113 + $startcol : OeHeadTableMap::translateFieldName('InvoicePrintdate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_printdate = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 114 + $startcol : OeHeadTableMap::translateFieldName('InvoicePrinttime', TableMap::TYPE_PHPNAME, $indexType)];
            $this->invoice_printtime = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 115 + $startcol : OeHeadTableMap::translateFieldName('DiscountFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->discount_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 116 + $startcol : OeHeadTableMap::translateFieldName('ShipCompleteoverride', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ship_completeoverride = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 117 + $startcol : OeHeadTableMap::translateFieldName('ContactEmail', TableMap::TYPE_PHPNAME, $indexType)];
            $this->contact_email = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 118 + $startcol : OeHeadTableMap::translateFieldName('ManualFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manual_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 119 + $startcol : OeHeadTableMap::translateFieldName('InternalFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->internal_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 120 + $startcol : OeHeadTableMap::translateFieldName('CostFreight', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cost_freight = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 121 + $startcol : OeHeadTableMap::translateFieldName('Route', TableMap::TYPE_PHPNAME, $indexType)];
            $this->route = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 122 + $startcol : OeHeadTableMap::translateFieldName('RouteSeq', TableMap::TYPE_PHPNAME, $indexType)];
            $this->route_seq = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 123 + $startcol : OeHeadTableMap::translateFieldName('Edi855sent', TableMap::TYPE_PHPNAME, $indexType)];
            $this->edi_855sent = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 124 + $startcol : OeHeadTableMap::translateFieldName('Freight3rdparty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight_3rdparty = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 125 + $startcol : OeHeadTableMap::translateFieldName('Fob', TableMap::TYPE_PHPNAME, $indexType)];
            $this->fob = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 126 + $startcol : OeHeadTableMap::translateFieldName('ConfirmImage', TableMap::TYPE_PHPNAME, $indexType)];
            $this->confirm_image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 127 + $startcol : OeHeadTableMap::translateFieldName('CstkConsign', TableMap::TYPE_PHPNAME, $indexType)];
            $this->cstk_consign = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 128 + $startcol : OeHeadTableMap::translateFieldName('Manufacturer', TableMap::TYPE_PHPNAME, $indexType)];
            $this->manufacturer = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 129 + $startcol : OeHeadTableMap::translateFieldName('PickQueue', TableMap::TYPE_PHPNAME, $indexType)];
            $this->pick_queue = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 130 + $startcol : OeHeadTableMap::translateFieldName('ArriveDate', TableMap::TYPE_PHPNAME, $indexType)];
            $this->arrive_date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 131 + $startcol : OeHeadTableMap::translateFieldName('SurchargeStatus', TableMap::TYPE_PHPNAME, $indexType)];
            $this->surcharge_status = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 132 + $startcol : OeHeadTableMap::translateFieldName('FreightGroup', TableMap::TYPE_PHPNAME, $indexType)];
            $this->freight_group = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 133 + $startcol : OeHeadTableMap::translateFieldName('CommOverride', TableMap::TYPE_PHPNAME, $indexType)];
            $this->comm_override = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 134 + $startcol : OeHeadTableMap::translateFieldName('ChargeSplit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->charge_split = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 135 + $startcol : OeHeadTableMap::translateFieldName('CreditcartApproved', TableMap::TYPE_PHPNAME, $indexType)];
            $this->creditcart_approved = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 136 + $startcol : OeHeadTableMap::translateFieldName('OriginalOrdernumber', TableMap::TYPE_PHPNAME, $indexType)];
            $this->original_ordernumber = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 137 + $startcol : OeHeadTableMap::translateFieldName('HasNotes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_notes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 138 + $startcol : OeHeadTableMap::translateFieldName('HasDocuments', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_documents = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 139 + $startcol : OeHeadTableMap::translateFieldName('HasTracking', TableMap::TYPE_PHPNAME, $indexType)];
            $this->has_tracking = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 140 + $startcol : OeHeadTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 141 + $startcol : OeHeadTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 142 + $startcol : OeHeadTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 143; // 143 = OeHeadTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\OeHead'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildOeHeadQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
     ...
     * @return void
     * @throws PropelException
     * @see OeHead::setDeleted()
     * @see OeHead::isDeleted()
     */
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildOeHeadQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                OeHeadTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDERNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'ordernumber';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'status';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HOLDSTATUS)) {
            $modifiedColumns[':p' . $index++]  = 'holdstatus';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CUSTID)) {
            $modifiedColumns[':p' . $index++]  = 'custid';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTOID)) {
            $modifiedColumns[':p' . $index++]  = 'shiptoid';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_NAME)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_name';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS1)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_address1';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS2)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_address2';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS3)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_address3';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS4)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_address4';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_CITY)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_city';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_state';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ZIP)) {
            $modifiedColumns[':p' . $index++]  = 'shipto_zip';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CUSTPO)) {
            $modifiedColumns[':p' . $index++]  = 'custpo';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'order_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TERMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'termcode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPVIACODE)) {
            $modifiedColumns[':p' . $index++]  = 'shipviacode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_number';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_GENLEDGER_PERIOD)) {
            $modifiedColumns[':p' . $index++]  = 'genledger_period';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_1)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_1';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_1PCT)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_1pct';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_2)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_2';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_2PCT)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_2pct';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_3)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_3';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_3PCT)) {
            $modifiedColumns[':p' . $index++]  = 'salesperson_3pct';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTRACT_NBR)) {
            $modifiedColumns[':p' . $index++]  = 'contract_nbr';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BATCH_NBR)) {
            $modifiedColumns[':p' . $index++]  = 'batch_nbr';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPRELEASEHOLD)) {
            $modifiedColumns[':p' . $index++]  = 'dropreleasehold';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SUBTOTAL_NONTAX)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal_nontax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SUBTOTAL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'subtotal_tax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'total_tax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'total_freight';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_MISC)) {
            $modifiedColumns[':p' . $index++]  = 'total_misc';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_ORDER)) {
            $modifiedColumns[':p' . $index++]  = 'total_order';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_COST)) {
            $modifiedColumns[':p' . $index++]  = 'total_cost';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_LOCK)) {
            $modifiedColumns[':p' . $index++]  = 'lock';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'taken_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'taken_time';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'pick_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'pick_time';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'pack_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'pack_time';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'verify_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'verify_time';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDITMEMO)) {
            $modifiedColumns[':p' . $index++]  = 'creditmemo';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BOOKED)) {
            $modifiedColumns[':p' . $index++]  = 'booked';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'original_whse';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BILLTO_STATE)) {
            $modifiedColumns[':p' . $index++]  = 'billto_state';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPCOMPLETE)) {
            $modifiedColumns[':p' . $index++]  = 'shipcomplete';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CWO_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'cwo_flag';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DIVISION)) {
            $modifiedColumns[':p' . $index++]  = 'division';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'taken_code';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'pack_code';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'pick_code';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_CODE)) {
            $modifiedColumns[':p' . $index++]  = 'verify_code';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_DISCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'total_discount';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EDI_REFERERENCENBR)) {
            $modifiedColumns[':p' . $index++]  = 'edi_refererencenbr';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE1)) {
            $modifiedColumns[':p' . $index++]  = 'user_code1';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE2)) {
            $modifiedColumns[':p' . $index++]  = 'user_code2';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE3)) {
            $modifiedColumns[':p' . $index++]  = 'user_code3';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE4)) {
            $modifiedColumns[':p' . $index++]  = 'user_code4';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EXCHANGE_COUNTRY)) {
            $modifiedColumns[':p' . $index++]  = 'exchange_country';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EXCHANGE_RATE)) {
            $modifiedColumns[':p' . $index++]  = 'exchange_rate';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WEIGHT_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'weight_total';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WEIGHT_OVERRIDE)) {
            $modifiedColumns[':p' . $index++]  = 'weight_override';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BOX_COUNT)) {
            $modifiedColumns[':p' . $index++]  = 'box_count';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_REQUEST_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'request_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CANCEL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'cancel_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_LOCKEDBY)) {
            $modifiedColumns[':p' . $index++]  = 'lockedby';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_RELEASE_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'release_number';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WHSE)) {
            $modifiedColumns[':p' . $index++]  = 'whse';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BACKORDER_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'backorder_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPTCODE)) {
            $modifiedColumns[':p' . $index++]  = 'deptcode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_IN_ENTERED)) {
            $modifiedColumns[':p' . $index++]  = 'freight_in_entered';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP_ENTERED)) {
            $modifiedColumns[':p' . $index++]  = 'dropship_entered';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ER_FLAG)) {
            $modifiedColumns[':p' . $index++]  = 'er_flag';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_IN)) {
            $modifiedColumns[':p' . $index++]  = 'freight_in';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP)) {
            $modifiedColumns[':p' . $index++]  = 'dropship';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MINORDER)) {
            $modifiedColumns[':p' . $index++]  = 'minorder';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTRACT_TERMS)) {
            $modifiedColumns[':p' . $index++]  = 'contract_terms';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP_BILLED)) {
            $modifiedColumns[':p' . $index++]  = 'dropship_billed';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDER_TYPE)) {
            $modifiedColumns[':p' . $index++]  = 'order_type';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TRACKING_EDINUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'tracking_edinumber';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SOURCE)) {
            $modifiedColumns[':p' . $index++]  = 'source';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_FORMAT)) {
            $modifiedColumns[':p' . $index++]  = 'pick_format';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_FORMAT)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_format';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CASH_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'cash_amount';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHECK_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'check_amount';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHECK_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'check_number';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPOSIT_AMOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'deposit_amount';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPOSIT_NUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'deposit_number';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'original_subtotal_tax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX)) {
            $modifiedColumns[':p' . $index++]  = 'original_subtotal_nontax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_TOTAL_TAX)) {
            $modifiedColumns[':p' . $index++]  = 'original_total_tax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_TOTAL)) {
            $modifiedColumns[':p' . $index++]  = 'original_total';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_PRINTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'pick_printdate';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_PRINTTIME)) {
            $modifiedColumns[':p' . $index++]  = 'pick_printtime';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTACT)) {
            $modifiedColumns[':p' . $index++]  = 'contact';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_INTL)) {
            $modifiedColumns[':p' . $index++]  = 'phone_intl';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_ACCESSCODE)) {
            $modifiedColumns[':p' . $index++]  = 'phone_accesscode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_COUNTRYCODE)) {
            $modifiedColumns[':p' . $index++]  = 'phone_countrycode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE)) {
            $modifiedColumns[':p' . $index++]  = 'phone';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_EXT)) {
            $modifiedColumns[':p' . $index++]  = 'phone_ext';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_INTL)) {
            $modifiedColumns[':p' . $index++]  = 'fax_intl';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_ACCESSCODE)) {
            $modifiedColumns[':p' . $index++]  = 'fax_accesscode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_COUNTRYCODE)) {
            $modifiedColumns[':p' . $index++]  = 'fax_countrycode';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX)) {
            $modifiedColumns[':p' . $index++]  = 'fax';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIP_ACCOUNT)) {
            $modifiedColumns[':p' . $index++]  = 'ship_account';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHANGE_DUE)) {
            $modifiedColumns[':p' . $index++]  = 'change_due';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DISCOUNT_ADDITIONAL)) {
            $modifiedColumns[':p' . $index++]  = 'discount_additional';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ALL_SHIP)) {
            $modifiedColumns[':p' . $index++]  = 'all_ship';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDIT_APPLIED)) {
            $modifiedColumns[':p' . $index++]  = 'credit_applied';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_PRINTDATE)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_printdate';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_PRINTTIME)) {
            $modifiedColumns[':p' . $index++]  = 'invoice_printtime';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DISCOUNT_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'discount_freight';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIP_COMPLETEOVERRIDE)) {
            $modifiedColumns[':p' . $index++]  = 'ship_completeoverride';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTACT_EMAIL)) {
            $modifiedColumns[':p' . $index++]  = 'contact_email';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MANUAL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'manual_freight';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INTERNAL_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'internal_freight';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_COST_FREIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'cost_freight';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ROUTE)) {
            $modifiedColumns[':p' . $index++]  = 'route';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ROUTE_SEQ)) {
            $modifiedColumns[':p' . $index++]  = 'route_seq';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EDI_855SENT)) {
            $modifiedColumns[':p' . $index++]  = 'edi_855sent';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_3RDPARTY)) {
            $modifiedColumns[':p' . $index++]  = 'freight_3rdparty';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FOB)) {
            $modifiedColumns[':p' . $index++]  = 'fob';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONFIRM_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'confirm_image';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CSTK_CONSIGN)) {
            $modifiedColumns[':p' . $index++]  = 'cstk_consign';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MANUFACTURER)) {
            $modifiedColumns[':p' . $index++]  = 'manufacturer';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_QUEUE)) {
            $modifiedColumns[':p' . $index++]  = 'pick_queue';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ARRIVE_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'arrive_date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SURCHARGE_STATUS)) {
            $modifiedColumns[':p' . $index++]  = 'surcharge_status';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_GROUP)) {
            $modifiedColumns[':p' . $index++]  = 'freight_group';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_COMM_OVERRIDE)) {
            $modifiedColumns[':p' . $index++]  = 'comm_override';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHARGE_SPLIT)) {
            $modifiedColumns[':p' . $index++]  = 'charge_split';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDITCART_APPROVED)) {
            $modifiedColumns[':p' . $index++]  = 'creditcart_approved';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_ORDERNUMBER)) {
            $modifiedColumns[':p' . $index++]  = 'original_ordernumber';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_NOTES)) {
            $modifiedColumns[':p' . $index++]  = 'has_notes';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_DOCUMENTS)) {
            $modifiedColumns[':p' . $index++]  = 'has_documents';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_TRACKING)) {
            $modifiedColumns[':p' . $index++]  = 'has_tracking';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO oe_head (%s) VALUES (%s)',
    ...
    {
        $pos = OeHeadTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['OeHead'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['OeHead'][$this->hashCode()] = true;
        $keys = OeHeadTableMap::getFieldNames($keyType);
        $result = array(
            ...
            $keys[29] => $this->getSubtotalNontax(),
            $keys[30] => $this->getSubtotalTax(),
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[29], $arr)) {
            $this->setSubtotalNontax($arr[$keys[29]]);
        }
        if (array_key_exists($keys[30], $arr)) {
            $this->setSubtotalTax($arr[$keys[30]]);
        }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDERNUMBER)) {
            $criteria->add(OeHeadTableMap::COL_ORDERNUMBER, $this->ordernumber);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_STATUS)) {
            $criteria->add(OeHeadTableMap::COL_STATUS, $this->status);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HOLDSTATUS)) {
            $criteria->add(OeHeadTableMap::COL_HOLDSTATUS, $this->holdstatus);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CUSTID)) {
            $criteria->add(OeHeadTableMap::COL_CUSTID, $this->custid);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTOID)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTOID, $this->shiptoid);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_NAME)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_NAME, $this->shipto_name);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS1)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_ADDRESS1, $this->shipto_address1);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS2)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_ADDRESS2, $this->shipto_address2);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS3)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_ADDRESS3, $this->shipto_address3);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ADDRESS4)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_ADDRESS4, $this->shipto_address4);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_CITY)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_CITY, $this->shipto_city);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_STATE)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_STATE, $this->shipto_state);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPTO_ZIP)) {
            $criteria->add(OeHeadTableMap::COL_SHIPTO_ZIP, $this->shipto_zip);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CUSTPO)) {
            $criteria->add(OeHeadTableMap::COL_CUSTPO, $this->custpo);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDER_DATE)) {
            $criteria->add(OeHeadTableMap::COL_ORDER_DATE, $this->order_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TERMCODE)) {
            $criteria->add(OeHeadTableMap::COL_TERMCODE, $this->termcode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPVIACODE)) {
            $criteria->add(OeHeadTableMap::COL_SHIPVIACODE, $this->shipviacode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_NUMBER)) {
            $criteria->add(OeHeadTableMap::COL_INVOICE_NUMBER, $this->invoice_number);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_DATE)) {
            $criteria->add(OeHeadTableMap::COL_INVOICE_DATE, $this->invoice_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_GENLEDGER_PERIOD)) {
            $criteria->add(OeHeadTableMap::COL_GENLEDGER_PERIOD, $this->genledger_period);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_1)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_1, $this->salesperson_1);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_1PCT)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_1PCT, $this->salesperson_1pct);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_2)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_2, $this->salesperson_2);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_2PCT)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_2PCT, $this->salesperson_2pct);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_3)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_3, $this->salesperson_3);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SALESPERSON_3PCT)) {
            $criteria->add(OeHeadTableMap::COL_SALESPERSON_3PCT, $this->salesperson_3pct);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTRACT_NBR)) {
            $criteria->add(OeHeadTableMap::COL_CONTRACT_NBR, $this->contract_nbr);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BATCH_NBR)) {
            $criteria->add(OeHeadTableMap::COL_BATCH_NBR, $this->batch_nbr);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPRELEASEHOLD)) {
            $criteria->add(OeHeadTableMap::COL_DROPRELEASEHOLD, $this->dropreleasehold);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SUBTOTAL_NONTAX)) {
            $criteria->add(OeHeadTableMap::COL_SUBTOTAL_NONTAX, $this->subtotal_nontax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SUBTOTAL_TAX)) {
            $criteria->add(OeHeadTableMap::COL_SUBTOTAL_TAX, $this->subtotal_tax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_TAX)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_TAX, $this->total_tax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_FREIGHT)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_FREIGHT, $this->total_freight);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_MISC)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_MISC, $this->total_misc);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_ORDER)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_ORDER, $this->total_order);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_COST)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_COST, $this->total_cost);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_LOCK)) {
            $criteria->add(OeHeadTableMap::COL_LOCK, $this->lock);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_DATE)) {
            $criteria->add(OeHeadTableMap::COL_TAKEN_DATE, $this->taken_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_TIME)) {
            $criteria->add(OeHeadTableMap::COL_TAKEN_TIME, $this->taken_time);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_DATE)) {
            $criteria->add(OeHeadTableMap::COL_PICK_DATE, $this->pick_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_TIME)) {
            $criteria->add(OeHeadTableMap::COL_PICK_TIME, $this->pick_time);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_DATE)) {
            $criteria->add(OeHeadTableMap::COL_PACK_DATE, $this->pack_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_TIME)) {
            $criteria->add(OeHeadTableMap::COL_PACK_TIME, $this->pack_time);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_DATE)) {
            $criteria->add(OeHeadTableMap::COL_VERIFY_DATE, $this->verify_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_TIME)) {
            $criteria->add(OeHeadTableMap::COL_VERIFY_TIME, $this->verify_time);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDITMEMO)) {
            $criteria->add(OeHeadTableMap::COL_CREDITMEMO, $this->creditmemo);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BOOKED)) {
            $criteria->add(OeHeadTableMap::COL_BOOKED, $this->booked);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_WHSE)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_WHSE, $this->original_whse);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BILLTO_STATE)) {
            $criteria->add(OeHeadTableMap::COL_BILLTO_STATE, $this->billto_state);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIPCOMPLETE)) {
            $criteria->add(OeHeadTableMap::COL_SHIPCOMPLETE, $this->shipcomplete);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CWO_FLAG)) {
            $criteria->add(OeHeadTableMap::COL_CWO_FLAG, $this->cwo_flag);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DIVISION)) {
            $criteria->add(OeHeadTableMap::COL_DIVISION, $this->division);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TAKEN_CODE)) {
            $criteria->add(OeHeadTableMap::COL_TAKEN_CODE, $this->taken_code);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PACK_CODE)) {
            $criteria->add(OeHeadTableMap::COL_PACK_CODE, $this->pack_code);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_CODE)) {
            $criteria->add(OeHeadTableMap::COL_PICK_CODE, $this->pick_code);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_VERIFY_CODE)) {
            $criteria->add(OeHeadTableMap::COL_VERIFY_CODE, $this->verify_code);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TOTAL_DISCOUNT)) {
            $criteria->add(OeHeadTableMap::COL_TOTAL_DISCOUNT, $this->total_discount);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EDI_REFERERENCENBR)) {
            $criteria->add(OeHeadTableMap::COL_EDI_REFERERENCENBR, $this->edi_refererencenbr);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE1)) {
            $criteria->add(OeHeadTableMap::COL_USER_CODE1, $this->user_code1);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE2)) {
            $criteria->add(OeHeadTableMap::COL_USER_CODE2, $this->user_code2);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE3)) {
            $criteria->add(OeHeadTableMap::COL_USER_CODE3, $this->user_code3);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_USER_CODE4)) {
            $criteria->add(OeHeadTableMap::COL_USER_CODE4, $this->user_code4);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EXCHANGE_COUNTRY)) {
            $criteria->add(OeHeadTableMap::COL_EXCHANGE_COUNTRY, $this->exchange_country);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EXCHANGE_RATE)) {
            $criteria->add(OeHeadTableMap::COL_EXCHANGE_RATE, $this->exchange_rate);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WEIGHT_TOTAL)) {
            $criteria->add(OeHeadTableMap::COL_WEIGHT_TOTAL, $this->weight_total);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WEIGHT_OVERRIDE)) {
            $criteria->add(OeHeadTableMap::COL_WEIGHT_OVERRIDE, $this->weight_override);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BOX_COUNT)) {
            $criteria->add(OeHeadTableMap::COL_BOX_COUNT, $this->box_count);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_REQUEST_DATE)) {
            $criteria->add(OeHeadTableMap::COL_REQUEST_DATE, $this->request_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CANCEL_DATE)) {
            $criteria->add(OeHeadTableMap::COL_CANCEL_DATE, $this->cancel_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_LOCKEDBY)) {
            $criteria->add(OeHeadTableMap::COL_LOCKEDBY, $this->lockedby);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_RELEASE_NUMBER)) {
            $criteria->add(OeHeadTableMap::COL_RELEASE_NUMBER, $this->release_number);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_WHSE)) {
            $criteria->add(OeHeadTableMap::COL_WHSE, $this->whse);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_BACKORDER_DATE)) {
            $criteria->add(OeHeadTableMap::COL_BACKORDER_DATE, $this->backorder_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPTCODE)) {
            $criteria->add(OeHeadTableMap::COL_DEPTCODE, $this->deptcode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_IN_ENTERED)) {
            $criteria->add(OeHeadTableMap::COL_FREIGHT_IN_ENTERED, $this->freight_in_entered);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP_ENTERED)) {
            $criteria->add(OeHeadTableMap::COL_DROPSHIP_ENTERED, $this->dropship_entered);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ER_FLAG)) {
            $criteria->add(OeHeadTableMap::COL_ER_FLAG, $this->er_flag);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_IN)) {
            $criteria->add(OeHeadTableMap::COL_FREIGHT_IN, $this->freight_in);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP)) {
            $criteria->add(OeHeadTableMap::COL_DROPSHIP, $this->dropship);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MINORDER)) {
            $criteria->add(OeHeadTableMap::COL_MINORDER, $this->minorder);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTRACT_TERMS)) {
            $criteria->add(OeHeadTableMap::COL_CONTRACT_TERMS, $this->contract_terms);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DROPSHIP_BILLED)) {
            $criteria->add(OeHeadTableMap::COL_DROPSHIP_BILLED, $this->dropship_billed);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORDER_TYPE)) {
            $criteria->add(OeHeadTableMap::COL_ORDER_TYPE, $this->order_type);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TRACKING_EDINUMBER)) {
            $criteria->add(OeHeadTableMap::COL_TRACKING_EDINUMBER, $this->tracking_edinumber);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SOURCE)) {
            $criteria->add(OeHeadTableMap::COL_SOURCE, $this->source);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_FORMAT)) {
            $criteria->add(OeHeadTableMap::COL_PICK_FORMAT, $this->pick_format);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_FORMAT)) {
            $criteria->add(OeHeadTableMap::COL_INVOICE_FORMAT, $this->invoice_format);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CASH_AMOUNT)) {
            $criteria->add(OeHeadTableMap::COL_CASH_AMOUNT, $this->cash_amount);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHECK_AMOUNT)) {
            $criteria->add(OeHeadTableMap::COL_CHECK_AMOUNT, $this->check_amount);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHECK_NUMBER)) {
            $criteria->add(OeHeadTableMap::COL_CHECK_NUMBER, $this->check_number);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPOSIT_AMOUNT)) {
            $criteria->add(OeHeadTableMap::COL_DEPOSIT_AMOUNT, $this->deposit_amount);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DEPOSIT_NUMBER)) {
            $criteria->add(OeHeadTableMap::COL_DEPOSIT_NUMBER, $this->deposit_number);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_TAX)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_TAX, $this->original_subtotal_tax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_SUBTOTAL_NONTAX, $this->original_subtotal_nontax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_TOTAL_TAX)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_TOTAL_TAX, $this->original_total_tax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_TOTAL)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_TOTAL, $this->original_total);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_PRINTDATE)) {
            $criteria->add(OeHeadTableMap::COL_PICK_PRINTDATE, $this->pick_printdate);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_PRINTTIME)) {
            $criteria->add(OeHeadTableMap::COL_PICK_PRINTTIME, $this->pick_printtime);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTACT)) {
            $criteria->add(OeHeadTableMap::COL_CONTACT, $this->contact);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_INTL)) {
            $criteria->add(OeHeadTableMap::COL_PHONE_INTL, $this->phone_intl);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_ACCESSCODE)) {
            $criteria->add(OeHeadTableMap::COL_PHONE_ACCESSCODE, $this->phone_accesscode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_COUNTRYCODE)) {
            $criteria->add(OeHeadTableMap::COL_PHONE_COUNTRYCODE, $this->phone_countrycode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE)) {
            $criteria->add(OeHeadTableMap::COL_PHONE, $this->phone);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PHONE_EXT)) {
            $criteria->add(OeHeadTableMap::COL_PHONE_EXT, $this->phone_ext);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_INTL)) {
            $criteria->add(OeHeadTableMap::COL_FAX_INTL, $this->fax_intl);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_ACCESSCODE)) {
            $criteria->add(OeHeadTableMap::COL_FAX_ACCESSCODE, $this->fax_accesscode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX_COUNTRYCODE)) {
            $criteria->add(OeHeadTableMap::COL_FAX_COUNTRYCODE, $this->fax_countrycode);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FAX)) {
            $criteria->add(OeHeadTableMap::COL_FAX, $this->fax);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIP_ACCOUNT)) {
            $criteria->add(OeHeadTableMap::COL_SHIP_ACCOUNT, $this->ship_account);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHANGE_DUE)) {
            $criteria->add(OeHeadTableMap::COL_CHANGE_DUE, $this->change_due);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DISCOUNT_ADDITIONAL)) {
            $criteria->add(OeHeadTableMap::COL_DISCOUNT_ADDITIONAL, $this->discount_additional);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ALL_SHIP)) {
            $criteria->add(OeHeadTableMap::COL_ALL_SHIP, $this->all_ship);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDIT_APPLIED)) {
            $criteria->add(OeHeadTableMap::COL_CREDIT_APPLIED, $this->credit_applied);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_PRINTDATE)) {
            $criteria->add(OeHeadTableMap::COL_INVOICE_PRINTDATE, $this->invoice_printdate);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INVOICE_PRINTTIME)) {
            $criteria->add(OeHeadTableMap::COL_INVOICE_PRINTTIME, $this->invoice_printtime);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DISCOUNT_FREIGHT)) {
            $criteria->add(OeHeadTableMap::COL_DISCOUNT_FREIGHT, $this->discount_freight);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SHIP_COMPLETEOVERRIDE)) {
            $criteria->add(OeHeadTableMap::COL_SHIP_COMPLETEOVERRIDE, $this->ship_completeoverride);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONTACT_EMAIL)) {
            $criteria->add(OeHeadTableMap::COL_CONTACT_EMAIL, $this->contact_email);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MANUAL_FREIGHT)) {
            $criteria->add(OeHeadTableMap::COL_MANUAL_FREIGHT, $this->manual_freight);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_INTERNAL_FREIGHT)) {
            $criteria->add(OeHeadTableMap::COL_INTERNAL_FREIGHT, $this->internal_freight);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_COST_FREIGHT)) {
            $criteria->add(OeHeadTableMap::COL_COST_FREIGHT, $this->cost_freight);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ROUTE)) {
            $criteria->add(OeHeadTableMap::COL_ROUTE, $this->route);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ROUTE_SEQ)) {
            $criteria->add(OeHeadTableMap::COL_ROUTE_SEQ, $this->route_seq);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_EDI_855SENT)) {
            $criteria->add(OeHeadTableMap::COL_EDI_855SENT, $this->edi_855sent);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_3RDPARTY)) {
            $criteria->add(OeHeadTableMap::COL_FREIGHT_3RDPARTY, $this->freight_3rdparty);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FOB)) {
            $criteria->add(OeHeadTableMap::COL_FOB, $this->fob);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CONFIRM_IMAGE)) {
            $criteria->add(OeHeadTableMap::COL_CONFIRM_IMAGE, $this->confirm_image);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CSTK_CONSIGN)) {
            $criteria->add(OeHeadTableMap::COL_CSTK_CONSIGN, $this->cstk_consign);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_MANUFACTURER)) {
            $criteria->add(OeHeadTableMap::COL_MANUFACTURER, $this->manufacturer);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_PICK_QUEUE)) {
            $criteria->add(OeHeadTableMap::COL_PICK_QUEUE, $this->pick_queue);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ARRIVE_DATE)) {
            $criteria->add(OeHeadTableMap::COL_ARRIVE_DATE, $this->arrive_date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_SURCHARGE_STATUS)) {
            $criteria->add(OeHeadTableMap::COL_SURCHARGE_STATUS, $this->surcharge_status);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_FREIGHT_GROUP)) {
            $criteria->add(OeHeadTableMap::COL_FREIGHT_GROUP, $this->freight_group);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_COMM_OVERRIDE)) {
            $criteria->add(OeHeadTableMap::COL_COMM_OVERRIDE, $this->comm_override);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CHARGE_SPLIT)) {
            $criteria->add(OeHeadTableMap::COL_CHARGE_SPLIT, $this->charge_split);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_CREDITCART_APPROVED)) {
            $criteria->add(OeHeadTableMap::COL_CREDITCART_APPROVED, $this->creditcart_approved);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_ORIGINAL_ORDERNUMBER)) {
            $criteria->add(OeHeadTableMap::COL_ORIGINAL_ORDERNUMBER, $this->original_ordernumber);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_NOTES)) {
            $criteria->add(OeHeadTableMap::COL_HAS_NOTES, $this->has_notes);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_DOCUMENTS)) {
            $criteria->add(OeHeadTableMap::COL_HAS_DOCUMENTS, $this->has_documents);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_HAS_TRACKING)) {
            $criteria->add(OeHeadTableMap::COL_HAS_TRACKING, $this->has_tracking);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DATE)) {
            $criteria->add(OeHeadTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_TIME)) {
            $criteria->add(OeHeadTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(OeHeadTableMap::COL_DUMMY)) {
            $criteria->add(OeHeadTableMap::COL_DUMMY, $this->dummy);
        }
    ...
    {
        $criteria = ChildOeHeadQuery::create();
        $criteria->add(OeHeadTableMap::COL_ORDERNUMBER, $this->ordernumber);
     ...
     * objects.
     *
     * @param      object $copyObj An object of \OeHead (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \OeHead Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(OeHeadTableMap::DEFAULT_STRING_FORMAT);
    }
