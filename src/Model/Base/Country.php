...
abstract class Country implements ActiveRecordInterface
{
     ...
     * @var string
     */
    public const TABLE_MAP = '\\Map\\CountryTableMap';
    ...
    /**
     * The value for the nicename field.
     *
     * @var        string
     */
    protected $nicename;
    ...
    /**
     * The value for the phonecode field.
     *
     * @var        int
     */
    protected $phonecode;
    ...
    /**
     * Get the [phonecode] column value.
     *
     * @return int
     */
    ...
    public function setIso($v)
    {
        ...
        if ($this->iso !== $v) {
            $this->iso = $v;
            $this->modifiedColumns[CountryTableMap::COL_ISO] = true;
        }
    ...
    /**
     * Set the value of [nicename] column.
     *
     * @param string $v New value
     * @return $this The current object (for fluent API support)
     */
    public function setNicename($v)
    {
        if ($v !== null) {
            $v = (string) $v;
        }
        ...
        if ($this->nicename !== $v) {
            $this->nicename = $v;
            $this->modifiedColumns[CountryTableMap::COL_NICENAME] = true;
        }
    ...
    public function setNumcode($v)
    {
        ...
        if ($this->numcode !== $v) {
            $this->numcode = $v;
            $this->modifiedColumns[CountryTableMap::COL_NUMCODE] = true;
        }
    ...
    /**
     * Set the value of [phonecode] column.
     *
    ...
    public function setPhonecode($v)
    {
        ...
        if ($this->phonecode !== $v) {
            $this->phonecode = $v;
            $this->modifiedColumns[CountryTableMap::COL_PHONECODE] = true;
        }
    ...
    public function hydrate(array $row, int $startcol = 0, bool $rehydrate = false, string $indexType = TableMap::TYPE_NUM): int
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : CountryTableMap::translateFieldName('Iso', TableMap::TYPE_PHPNAME, $indexType)];
            $this->iso = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : CountryTableMap::translateFieldName('Iso2', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : CountryTableMap::translateFieldName('Nicename', TableMap::TYPE_PHPNAME, $indexType)];
            $this->nicename = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : CountryTableMap::translateFieldName('Numcode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->numcode = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : CountryTableMap::translateFieldName('Phonecode', TableMap::TYPE_PHPNAME, $indexType)];
            $this->phonecode = (null !== $col) ? (int) $col : null;
    ...
    protected function doInsert(ConnectionInterface $con): void
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_ISO)) {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_NICENAME)) {
            $modifiedColumns[':p' . $index++]  = 'nicename';
        }
        if ($this->isColumnModified(CountryTableMap::COL_NUMCODE)) {
            $modifiedColumns[':p' . $index++]  = 'numcode';
        }
        if ($this->isColumnModified(CountryTableMap::COL_PHONECODE)) {
            $modifiedColumns[':p' . $index++]  = 'phonecode';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    ...
                    case 'name':
                        ...
                        break;
                    case 'nicename':
                        $stmt->bindValue($identifier, $this->nicename, PDO::PARAM_STR);

                        break;
                    case 'numcode':
                        $stmt->bindValue($identifier, $this->numcode, PDO::PARAM_INT);

                        break;
                    case 'phonecode':
                        $stmt->bindValue($identifier, $this->phonecode, PDO::PARAM_INT);
    ...
    public function toArray(string $keyType = TableMap::TYPE_PHPNAME, bool $includeLazyLoadColumns = true, array $alreadyDumpedObjects = []): array
    {
        ...
        $result = [
            ...
            $keys[1] => $this->getIso2(),
            $keys[2] => $this->getName(),
            $keys[3] => $this->getNicename(),
            $keys[4] => $this->getNumcode(),
            $keys[5] => $this->getPhonecode(),
        ];
    ...
    public function fromArray(array $arr, string $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[0], $arr)) {
            $this->setIso($arr[$keys[0]]);
        }
        if (array_key_exists($keys[1], $arr)) {
            $this->setIso2($arr[$keys[1]]);
        }
        if (array_key_exists($keys[2], $arr)) {
            $this->setName($arr[$keys[2]]);
        }
        if (array_key_exists($keys[3], $arr)) {
            $this->setNicename($arr[$keys[3]]);
        }
        if (array_key_exists($keys[4], $arr)) {
            $this->setNumcode($arr[$keys[4]]);
        }
        if (array_key_exists($keys[5], $arr)) {
            $this->setPhonecode($arr[$keys[5]]);
        }
    ...
    public function buildCriteria(): Criteria
    {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_ISO)) {
            $criteria->add(CountryTableMap::COL_ISO, $this->iso);
        }
        if ($this->isColumnModified(CountryTableMap::COL_ISO2)) {
        ...
        if ($this->isColumnModified(CountryTableMap::COL_NICENAME)) {
            $criteria->add(CountryTableMap::COL_NICENAME, $this->nicename);
        }
        if ($this->isColumnModified(CountryTableMap::COL_NUMCODE)) {
            $criteria->add(CountryTableMap::COL_NUMCODE, $this->numcode);
        }
        if ($this->isColumnModified(CountryTableMap::COL_PHONECODE)) {
            $criteria->add(CountryTableMap::COL_PHONECODE, $this->phonecode);
        }
    ...
    public function copyInto(object $copyObj, bool $deepCopy = false, bool $makeNew = true): void
    {
        ...
        $copyObj->setNicename($this->getNicename());
        $copyObj->setNumcode($this->getNumcode());
