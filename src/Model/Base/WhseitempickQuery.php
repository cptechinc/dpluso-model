...
abstract class WhseitempickQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT sessionid, ordn, linenbr, itemid, recordnumber, palletnbr, barcode, bin, qty FROM whseitempick WHERE sessionid = :p0 AND ordn = :p1 AND itemid = :p2 AND recordnumber = :p3';
        try {
