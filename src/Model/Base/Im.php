...
/**
 * Base class that represents a row from the 'im' table.
 *
 *
 *
 * @package    propel.generator..Base
 */
abstract class Im implements ActiveRecordInterface
{
    /**
     * TableMap class name
     */
    const TABLE_MAP = '\\Map\\ImTableMap';
    ...
    /**
     * Initializes internal state of Base\Im object.
     */
    ...
    /**
     * Compares this with another <code>Im</code> instance.  If
     * <code>obj</code> is an instance of <code>Im</code>, delegates to
     * <code>equals(Im)</code>.  Otherwise, returns <code>false</code>.
     *
     ...
     *
     * @return $this|Im The current object, for fluid interface
     */
     ...
     * @return $this|\Im The current object (for fluent API support)
     */
    public function setSessionid($v)
    {
        ...
        if ($this->sessionid !== $v) {
            $this->sessionid = $v;
            $this->modifiedColumns[ImTableMap::COL_SESSIONID] = true;
        }
    ...
    public function setRecordno($v)
    {
        ...
        if ($this->recordno !== $v) {
            $this->recordno = $v;
            $this->modifiedColumns[ImTableMap::COL_RECORDNO] = true;
        }
    ...
    public function setDate($v)
    {
        ...
        if ($this->date !== $v) {
            $this->date = $v;
            $this->modifiedColumns[ImTableMap::COL_DATE] = true;
        }
    ...
    public function setTime($v)
    {
        ...
        if ($this->time !== $v) {
            $this->time = $v;
            $this->modifiedColumns[ImTableMap::COL_TIME] = true;
        }
    ...
    public function setItemid($v)
    {
        ...
        if ($this->itemid !== $v) {
            $this->itemid = $v;
            $this->modifiedColumns[ImTableMap::COL_ITEMID] = true;
        }
    ...
    public function setPrice($v)
    {
        ...
        if ($this->price !== $v) {
            $this->price = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICE] = true;
        }
    ...
    public function setQty($v)
    {
        ...
        if ($this->qty !== $v) {
            $this->qty = $v;
            $this->modifiedColumns[ImTableMap::COL_QTY] = true;
        }
    ...
    public function setPriceqty1($v)
    {
        ...
        if ($this->priceqty1 !== $v) {
            $this->priceqty1 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY1] = true;
        }
    ...
    public function setPriceqty2($v)
    {
        ...
        if ($this->priceqty2 !== $v) {
            $this->priceqty2 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY2] = true;
        }
    ...
    public function setPriceqty3($v)
    {
        ...
        if ($this->priceqty3 !== $v) {
            $this->priceqty3 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY3] = true;
        }
    ...
    public function setPriceqty4($v)
    {
        ...
        if ($this->priceqty4 !== $v) {
            $this->priceqty4 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY4] = true;
        }
    ...
    public function setPriceqty5($v)
    {
        ...
        if ($this->priceqty5 !== $v) {
            $this->priceqty5 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY5] = true;
        }
    ...
    public function setPriceqty6($v)
    {
        ...
        if ($this->priceqty6 !== $v) {
            $this->priceqty6 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEQTY6] = true;
        }
    ...
    public function setPriceprice1($v)
    {
        ...
        if ($this->priceprice1 !== $v) {
            $this->priceprice1 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE1] = true;
        }
    ...
    public function setPriceprice2($v)
    {
        ...
        if ($this->priceprice2 !== $v) {
            $this->priceprice2 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE2] = true;
        }
    ...
    public function setPriceprice3($v)
    {
        ...
        if ($this->priceprice3 !== $v) {
            $this->priceprice3 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE3] = true;
        }
    ...
    public function setPriceprice4($v)
    {
        ...
        if ($this->priceprice4 !== $v) {
            $this->priceprice4 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE4] = true;
        }
    ...
    public function setPriceprice5($v)
    {
        ...
        if ($this->priceprice5 !== $v) {
            $this->priceprice5 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE5] = true;
        }
    ...
    public function setPriceprice6($v)
    {
        ...
        if ($this->priceprice6 !== $v) {
            $this->priceprice6 = $v;
            $this->modifiedColumns[ImTableMap::COL_PRICEPRICE6] = true;
        }
    ...
    public function setUnit($v)
    {
        ...
        if ($this->unit !== $v) {
            $this->unit = $v;
            $this->modifiedColumns[ImTableMap::COL_UNIT] = true;
        }
    ...
    public function setListprice($v)
    {
        ...
        if ($this->listprice !== $v) {
            $this->listprice = $v;
            $this->modifiedColumns[ImTableMap::COL_LISTPRICE] = true;
        }
    ...
    public function setName1($v)
    {
        ...
        if ($this->name1 !== $v) {
            $this->name1 = $v;
            $this->modifiedColumns[ImTableMap::COL_NAME1] = true;
        }
    ...
    public function setName2($v)
    {
        ...
        if ($this->name2 !== $v) {
            $this->name2 = $v;
            $this->modifiedColumns[ImTableMap::COL_NAME2] = true;
        }
    ...
    public function setShortdesc($v)
    {
        ...
        if ($this->shortdesc !== $v) {
            $this->shortdesc = $v;
            $this->modifiedColumns[ImTableMap::COL_SHORTDESC] = true;
        }
    ...
    public function setImage($v)
    {
        ...
        if ($this->image !== $v) {
            $this->image = $v;
            $this->modifiedColumns[ImTableMap::COL_IMAGE] = true;
        }
    ...
    public function setFamilyid($v)
    {
        ...
        if ($this->familyid !== $v) {
            $this->familyid = $v;
            $this->modifiedColumns[ImTableMap::COL_FAMILYID] = true;
        }
    ...
    public function setErmes($v)
    {
        ...
        if ($this->ermes !== $v) {
            $this->ermes = $v;
            $this->modifiedColumns[ImTableMap::COL_ERMES] = true;
        }
    ...
    public function setSpeca($v)
    {
        ...
        if ($this->speca !== $v) {
            $this->speca = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECA] = true;
        }
    ...
    public function setSpecb($v)
    {
        ...
        if ($this->specb !== $v) {
            $this->specb = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECB] = true;
        }
    ...
    public function setSpecc($v)
    {
        ...
        if ($this->specc !== $v) {
            $this->specc = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECC] = true;
        }
    ...
    public function setSpecd($v)
    {
        ...
        if ($this->specd !== $v) {
            $this->specd = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECD] = true;
        }
    ...
    public function setSpece($v)
    {
        ...
        if ($this->spece !== $v) {
            $this->spece = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECE] = true;
        }
    ...
    public function setSpecf($v)
    {
        ...
        if ($this->specf !== $v) {
            $this->specf = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECF] = true;
        }
    ...
    public function setSpecg($v)
    {
        ...
        if ($this->specg !== $v) {
            $this->specg = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECG] = true;
        }
    ...
    public function setSpech($v)
    {
        ...
        if ($this->spech !== $v) {
            $this->spech = $v;
            $this->modifiedColumns[ImTableMap::COL_SPECH] = true;
        }
    ...
    public function setLongdesc($v)
    {
        ...
        if ($this->longdesc !== $v) {
            $this->longdesc = $v;
            $this->modifiedColumns[ImTableMap::COL_LONGDESC] = true;
        }
    ...
    public function setOrderno($v)
    {
        ...
        if ($this->orderno !== $v) {
            $this->orderno = $v;
            $this->modifiedColumns[ImTableMap::COL_ORDERNO] = true;
        }
    ...
    public function setName3($v)
    {
        ...
        if ($this->name3 !== $v) {
            $this->name3 = $v;
            $this->modifiedColumns[ImTableMap::COL_NAME3] = true;
        }
    ...
    public function setName4($v)
    {
        ...
        if ($this->name4 !== $v) {
            $this->name4 = $v;
            $this->modifiedColumns[ImTableMap::COL_NAME4] = true;
        }
    ...
    public function setThumb($v)
    {
        ...
        if ($this->thumb !== $v) {
            $this->thumb = $v;
            $this->modifiedColumns[ImTableMap::COL_THUMB] = true;
        }
    ...
    public function setWidth($v)
    {
        ...
        if ($this->width !== $v) {
            $this->width = $v;
            $this->modifiedColumns[ImTableMap::COL_WIDTH] = true;
        }
    ...
    public function setHeight($v)
    {
        ...
        if ($this->height !== $v) {
            $this->height = $v;
            $this->modifiedColumns[ImTableMap::COL_HEIGHT] = true;
        }
    ...
    public function setFamilydes($v)
    {
        ...
        if ($this->familydes !== $v) {
            $this->familydes = $v;
            $this->modifiedColumns[ImTableMap::COL_FAMILYDES] = true;
        }
    ...
    public function setKeywords($v)
    {
        ...
        if ($this->keywords !== $v) {
            $this->keywords = $v;
            $this->modifiedColumns[ImTableMap::COL_KEYWORDS] = true;
        }
    ...
    public function setVpn($v)
    {
        ...
        if ($this->vpn !== $v) {
            $this->vpn = $v;
            $this->modifiedColumns[ImTableMap::COL_VPN] = true;
        }
    ...
    public function setUomdesc($v)
    {
        ...
        if ($this->uomdesc !== $v) {
            $this->uomdesc = $v;
            $this->modifiedColumns[ImTableMap::COL_UOMDESC] = true;
        }
    ...
    public function setVidinffg($v)
    {
        ...
        if ($this->vidinffg !== $v) {
            $this->vidinffg = $v;
            $this->modifiedColumns[ImTableMap::COL_VIDINFFG] = true;
        }
    ...
    public function setVidinflk($v)
    {
        ...
        if ($this->vidinflk !== $v) {
            $this->vidinflk = $v;
            $this->modifiedColumns[ImTableMap::COL_VIDINFLK] = true;
        }
    ...
    public function setAdditemflag($v)
    {
        ...
        if ($this->additemflag !== $v) {
            $this->additemflag = $v;
            $this->modifiedColumns[ImTableMap::COL_ADDITEMFLAG] = true;
        }
    ...
    public function setSchemafam($v)
    {
        ...
        if ($this->schemafam !== $v) {
            $this->schemafam = $v;
            $this->modifiedColumns[ImTableMap::COL_SCHEMAFAM] = true;
        }
    ...
    public function setProp65($v)
    {
        ...
        if ($this->prop65 !== $v) {
            $this->prop65 = $v;
            $this->modifiedColumns[ImTableMap::COL_PROP65] = true;
        }
    ...
    public function setLeadfree($v)
    {
        ...
        if ($this->leadfree !== $v) {
            $this->leadfree = $v;
            $this->modifiedColumns[ImTableMap::COL_LEADFREE] = true;
        }
    ...
    public function setDummy($v)
    {
        ...
        if ($this->dummy !== $v) {
            $this->dummy = $v;
            $this->modifiedColumns[ImTableMap::COL_DUMMY] = true;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 0 + $startcol : ImTableMap::translateFieldName('Sessionid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->sessionid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 1 + $startcol : ImTableMap::translateFieldName('Recordno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->recordno = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 2 + $startcol : ImTableMap::translateFieldName('Date', TableMap::TYPE_PHPNAME, $indexType)];
            $this->date = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 3 + $startcol : ImTableMap::translateFieldName('Time', TableMap::TYPE_PHPNAME, $indexType)];
            $this->time = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 4 + $startcol : ImTableMap::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 5 + $startcol : ImTableMap::translateFieldName('Price', TableMap::TYPE_PHPNAME, $indexType)];
            $this->price = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : ImTableMap::translateFieldName('Qty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : ImTableMap::translateFieldName('Priceqty1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : ImTableMap::translateFieldName('Priceqty2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : ImTableMap::translateFieldName('Priceqty3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty3 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : ImTableMap::translateFieldName('Priceqty4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty4 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : ImTableMap::translateFieldName('Priceqty5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty5 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : ImTableMap::translateFieldName('Priceqty6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceqty6 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : ImTableMap::translateFieldName('Priceprice1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : ImTableMap::translateFieldName('Priceprice2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : ImTableMap::translateFieldName('Priceprice3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : ImTableMap::translateFieldName('Priceprice4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : ImTableMap::translateFieldName('Priceprice5', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice5 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : ImTableMap::translateFieldName('Priceprice6', TableMap::TYPE_PHPNAME, $indexType)];
            $this->priceprice6 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : ImTableMap::translateFieldName('Unit', TableMap::TYPE_PHPNAME, $indexType)];
            $this->unit = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : ImTableMap::translateFieldName('Listprice', TableMap::TYPE_PHPNAME, $indexType)];
            $this->listprice = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : ImTableMap::translateFieldName('Name1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 22 + $startcol : ImTableMap::translateFieldName('Name2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 23 + $startcol : ImTableMap::translateFieldName('Shortdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->shortdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 24 + $startcol : ImTableMap::translateFieldName('Image', TableMap::TYPE_PHPNAME, $indexType)];
            $this->image = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 25 + $startcol : ImTableMap::translateFieldName('Familyid', TableMap::TYPE_PHPNAME, $indexType)];
            $this->familyid = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 26 + $startcol : ImTableMap::translateFieldName('Ermes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->ermes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 27 + $startcol : ImTableMap::translateFieldName('Speca', TableMap::TYPE_PHPNAME, $indexType)];
            $this->speca = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 28 + $startcol : ImTableMap::translateFieldName('Specb', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specb = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 29 + $startcol : ImTableMap::translateFieldName('Specc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 30 + $startcol : ImTableMap::translateFieldName('Specd', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specd = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 31 + $startcol : ImTableMap::translateFieldName('Spece', TableMap::TYPE_PHPNAME, $indexType)];
            $this->spece = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 32 + $startcol : ImTableMap::translateFieldName('Specf', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specf = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 33 + $startcol : ImTableMap::translateFieldName('Specg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->specg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 34 + $startcol : ImTableMap::translateFieldName('Spech', TableMap::TYPE_PHPNAME, $indexType)];
            $this->spech = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 35 + $startcol : ImTableMap::translateFieldName('Longdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->longdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 36 + $startcol : ImTableMap::translateFieldName('Orderno', TableMap::TYPE_PHPNAME, $indexType)];
            $this->orderno = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 37 + $startcol : ImTableMap::translateFieldName('Name3', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name3 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 38 + $startcol : ImTableMap::translateFieldName('Name4', TableMap::TYPE_PHPNAME, $indexType)];
            $this->name4 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 39 + $startcol : ImTableMap::translateFieldName('Thumb', TableMap::TYPE_PHPNAME, $indexType)];
            $this->thumb = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 40 + $startcol : ImTableMap::translateFieldName('Width', TableMap::TYPE_PHPNAME, $indexType)];
            $this->width = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 41 + $startcol : ImTableMap::translateFieldName('Height', TableMap::TYPE_PHPNAME, $indexType)];
            $this->height = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 42 + $startcol : ImTableMap::translateFieldName('Familydes', TableMap::TYPE_PHPNAME, $indexType)];
            $this->familydes = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 43 + $startcol : ImTableMap::translateFieldName('Keywords', TableMap::TYPE_PHPNAME, $indexType)];
            $this->keywords = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 44 + $startcol : ImTableMap::translateFieldName('Vpn', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vpn = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 45 + $startcol : ImTableMap::translateFieldName('Uomdesc', TableMap::TYPE_PHPNAME, $indexType)];
            $this->uomdesc = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 46 + $startcol : ImTableMap::translateFieldName('Vidinffg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vidinffg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 47 + $startcol : ImTableMap::translateFieldName('Vidinflk', TableMap::TYPE_PHPNAME, $indexType)];
            $this->vidinflk = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 48 + $startcol : ImTableMap::translateFieldName('Additemflag', TableMap::TYPE_PHPNAME, $indexType)];
            $this->additemflag = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 49 + $startcol : ImTableMap::translateFieldName('Schemafam', TableMap::TYPE_PHPNAME, $indexType)];
            $this->schemafam = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 50 + $startcol : ImTableMap::translateFieldName('Prop65', TableMap::TYPE_PHPNAME, $indexType)];
            $this->prop65 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 51 + $startcol : ImTableMap::translateFieldName('Leadfree', TableMap::TYPE_PHPNAME, $indexType)];
            $this->leadfree = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 52 + $startcol : ImTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 53; // 53 = ImTableMap::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException(sprintf('Error populating %s object', '\\Im'), 0, $e);
        }
    }
    ...
    public function reload($deep = false, ConnectionInterface $con = null)
    {
        ...
        $dataFetcher = ChildImQuery::create(null, $this->buildPkeyCriteria())->setFormatter(ModelCriteria::FORMAT_STATEMENT)->find($con);
    ...
    public function delete(ConnectionInterface $con = null)
    {
        ...
        $con->transaction(function () use ($con) {
            $deleteQuery = ChildImQuery::create()
    ...
    public function save(ConnectionInterface $con = null)
    {
        ...
        return $con->transaction(function () use ($con) {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                ImTableMap::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
    ...
    protected function doInsert(ConnectionInterface $con)
    {
        ...
        if ($this->isColumnModified(ImTableMap::COL_SESSIONID)) {
            $modifiedColumns[':p' . $index++]  = 'sessionid';
        }
        if ($this->isColumnModified(ImTableMap::COL_RECORDNO)) {
            $modifiedColumns[':p' . $index++]  = 'recordno';
        }
        if ($this->isColumnModified(ImTableMap::COL_DATE)) {
            $modifiedColumns[':p' . $index++]  = 'date';
        }
        if ($this->isColumnModified(ImTableMap::COL_TIME)) {
            $modifiedColumns[':p' . $index++]  = 'time';
        }
        if ($this->isColumnModified(ImTableMap::COL_ITEMID)) {
            $modifiedColumns[':p' . $index++]  = 'itemid';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICE)) {
            $modifiedColumns[':p' . $index++]  = 'price';
        }
        if ($this->isColumnModified(ImTableMap::COL_QTY)) {
            $modifiedColumns[':p' . $index++]  = 'qty';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY1)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty1';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY2)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty2';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY3)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty3';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY4)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty4';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY5)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty5';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY6)) {
            $modifiedColumns[':p' . $index++]  = 'priceqty6';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE1)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice1';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE2)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice2';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE3)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice3';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE4)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice4';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE5)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice5';
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE6)) {
            $modifiedColumns[':p' . $index++]  = 'priceprice6';
        }
        if ($this->isColumnModified(ImTableMap::COL_UNIT)) {
            $modifiedColumns[':p' . $index++]  = 'unit';
        }
        if ($this->isColumnModified(ImTableMap::COL_LISTPRICE)) {
            $modifiedColumns[':p' . $index++]  = 'listprice';
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME1)) {
            $modifiedColumns[':p' . $index++]  = 'name1';
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME2)) {
            $modifiedColumns[':p' . $index++]  = 'name2';
        }
        if ($this->isColumnModified(ImTableMap::COL_SHORTDESC)) {
            $modifiedColumns[':p' . $index++]  = 'shortdesc';
        }
        if ($this->isColumnModified(ImTableMap::COL_IMAGE)) {
            $modifiedColumns[':p' . $index++]  = 'image';
        }
        if ($this->isColumnModified(ImTableMap::COL_FAMILYID)) {
            $modifiedColumns[':p' . $index++]  = 'familyid';
        }
        if ($this->isColumnModified(ImTableMap::COL_ERMES)) {
            $modifiedColumns[':p' . $index++]  = 'ermes';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECA)) {
            $modifiedColumns[':p' . $index++]  = 'speca';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECB)) {
            $modifiedColumns[':p' . $index++]  = 'specb';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECC)) {
            $modifiedColumns[':p' . $index++]  = 'specc';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECD)) {
            $modifiedColumns[':p' . $index++]  = 'specd';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECE)) {
            $modifiedColumns[':p' . $index++]  = 'spece';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECF)) {
            $modifiedColumns[':p' . $index++]  = 'specf';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECG)) {
            $modifiedColumns[':p' . $index++]  = 'specg';
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECH)) {
            $modifiedColumns[':p' . $index++]  = 'spech';
        }
        if ($this->isColumnModified(ImTableMap::COL_LONGDESC)) {
            $modifiedColumns[':p' . $index++]  = 'longdesc';
        }
        if ($this->isColumnModified(ImTableMap::COL_ORDERNO)) {
            $modifiedColumns[':p' . $index++]  = 'orderno';
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME3)) {
            $modifiedColumns[':p' . $index++]  = 'name3';
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME4)) {
            $modifiedColumns[':p' . $index++]  = 'name4';
        }
        if ($this->isColumnModified(ImTableMap::COL_THUMB)) {
            $modifiedColumns[':p' . $index++]  = 'thumb';
        }
        if ($this->isColumnModified(ImTableMap::COL_WIDTH)) {
            $modifiedColumns[':p' . $index++]  = 'width';
        }
        if ($this->isColumnModified(ImTableMap::COL_HEIGHT)) {
            $modifiedColumns[':p' . $index++]  = 'height';
        }
        if ($this->isColumnModified(ImTableMap::COL_FAMILYDES)) {
            $modifiedColumns[':p' . $index++]  = 'familydes';
        }
        if ($this->isColumnModified(ImTableMap::COL_KEYWORDS)) {
            $modifiedColumns[':p' . $index++]  = 'keywords';
        }
        if ($this->isColumnModified(ImTableMap::COL_VPN)) {
            $modifiedColumns[':p' . $index++]  = 'vpn';
        }
        if ($this->isColumnModified(ImTableMap::COL_UOMDESC)) {
            $modifiedColumns[':p' . $index++]  = 'uomdesc';
        }
        if ($this->isColumnModified(ImTableMap::COL_VIDINFFG)) {
            $modifiedColumns[':p' . $index++]  = 'vidinffg';
        }
        if ($this->isColumnModified(ImTableMap::COL_VIDINFLK)) {
            $modifiedColumns[':p' . $index++]  = 'vidinflk';
        }
        if ($this->isColumnModified(ImTableMap::COL_ADDITEMFLAG)) {
            $modifiedColumns[':p' . $index++]  = 'additemflag';
        }
        if ($this->isColumnModified(ImTableMap::COL_SCHEMAFAM)) {
            $modifiedColumns[':p' . $index++]  = 'schemafam';
        }
        if ($this->isColumnModified(ImTableMap::COL_PROP65)) {
            $modifiedColumns[':p' . $index++]  = 'prop65';
        }
        if ($this->isColumnModified(ImTableMap::COL_LEADFREE)) {
            $modifiedColumns[':p' . $index++]  = 'leadfree';
        }
        if ($this->isColumnModified(ImTableMap::COL_DUMMY)) {
            $modifiedColumns[':p' . $index++]  = 'dummy';
        }

        $sql = sprintf(
            'INSERT INTO im (%s) VALUES (%s)',
    ...
    {
        $pos = ImTableMap::translateFieldName($name, $type, TableMap::TYPE_NUM);
    ...
    public function toArray($keyType = TableMap::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array())
    {
        ...
        if (isset($alreadyDumpedObjects['Im'][$this->hashCode()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Im'][$this->hashCode()] = true;
        $keys = ImTableMap::getFieldNames($keyType);
        $result = array(
            ...
            $keys[50] => $this->getProp65(),
            $keys[51] => $this->getLeadfree(),
            $keys[52] => $this->getDummy(),
        );
    ...
    public function fromArray($arr, $keyType = TableMap::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[50], $arr)) {
            $this->setProp65($arr[$keys[50]]);
        }
        if (array_key_exists($keys[51], $arr)) {
            $this->setLeadfree($arr[$keys[51]]);
        }
        if (array_key_exists($keys[52], $arr)) {
            $this->setDummy($arr[$keys[52]]);
        }
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ImTableMap::COL_SESSIONID)) {
            $criteria->add(ImTableMap::COL_SESSIONID, $this->sessionid);
        }
        if ($this->isColumnModified(ImTableMap::COL_RECORDNO)) {
            $criteria->add(ImTableMap::COL_RECORDNO, $this->recordno);
        }
        if ($this->isColumnModified(ImTableMap::COL_DATE)) {
            $criteria->add(ImTableMap::COL_DATE, $this->date);
        }
        if ($this->isColumnModified(ImTableMap::COL_TIME)) {
            $criteria->add(ImTableMap::COL_TIME, $this->time);
        }
        if ($this->isColumnModified(ImTableMap::COL_ITEMID)) {
            $criteria->add(ImTableMap::COL_ITEMID, $this->itemid);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICE)) {
            $criteria->add(ImTableMap::COL_PRICE, $this->price);
        }
        if ($this->isColumnModified(ImTableMap::COL_QTY)) {
            $criteria->add(ImTableMap::COL_QTY, $this->qty);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY1)) {
            $criteria->add(ImTableMap::COL_PRICEQTY1, $this->priceqty1);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY2)) {
            $criteria->add(ImTableMap::COL_PRICEQTY2, $this->priceqty2);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY3)) {
            $criteria->add(ImTableMap::COL_PRICEQTY3, $this->priceqty3);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY4)) {
            $criteria->add(ImTableMap::COL_PRICEQTY4, $this->priceqty4);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY5)) {
            $criteria->add(ImTableMap::COL_PRICEQTY5, $this->priceqty5);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEQTY6)) {
            $criteria->add(ImTableMap::COL_PRICEQTY6, $this->priceqty6);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE1)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE1, $this->priceprice1);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE2)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE2, $this->priceprice2);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE3)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE3, $this->priceprice3);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE4)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE4, $this->priceprice4);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE5)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE5, $this->priceprice5);
        }
        if ($this->isColumnModified(ImTableMap::COL_PRICEPRICE6)) {
            $criteria->add(ImTableMap::COL_PRICEPRICE6, $this->priceprice6);
        }
        if ($this->isColumnModified(ImTableMap::COL_UNIT)) {
            $criteria->add(ImTableMap::COL_UNIT, $this->unit);
        }
        if ($this->isColumnModified(ImTableMap::COL_LISTPRICE)) {
            $criteria->add(ImTableMap::COL_LISTPRICE, $this->listprice);
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME1)) {
            $criteria->add(ImTableMap::COL_NAME1, $this->name1);
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME2)) {
            $criteria->add(ImTableMap::COL_NAME2, $this->name2);
        }
        if ($this->isColumnModified(ImTableMap::COL_SHORTDESC)) {
            $criteria->add(ImTableMap::COL_SHORTDESC, $this->shortdesc);
        }
        if ($this->isColumnModified(ImTableMap::COL_IMAGE)) {
            $criteria->add(ImTableMap::COL_IMAGE, $this->image);
        }
        if ($this->isColumnModified(ImTableMap::COL_FAMILYID)) {
            $criteria->add(ImTableMap::COL_FAMILYID, $this->familyid);
        }
        if ($this->isColumnModified(ImTableMap::COL_ERMES)) {
            $criteria->add(ImTableMap::COL_ERMES, $this->ermes);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECA)) {
            $criteria->add(ImTableMap::COL_SPECA, $this->speca);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECB)) {
            $criteria->add(ImTableMap::COL_SPECB, $this->specb);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECC)) {
            $criteria->add(ImTableMap::COL_SPECC, $this->specc);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECD)) {
            $criteria->add(ImTableMap::COL_SPECD, $this->specd);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECE)) {
            $criteria->add(ImTableMap::COL_SPECE, $this->spece);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECF)) {
            $criteria->add(ImTableMap::COL_SPECF, $this->specf);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECG)) {
            $criteria->add(ImTableMap::COL_SPECG, $this->specg);
        }
        if ($this->isColumnModified(ImTableMap::COL_SPECH)) {
            $criteria->add(ImTableMap::COL_SPECH, $this->spech);
        }
        if ($this->isColumnModified(ImTableMap::COL_LONGDESC)) {
            $criteria->add(ImTableMap::COL_LONGDESC, $this->longdesc);
        }
        if ($this->isColumnModified(ImTableMap::COL_ORDERNO)) {
            $criteria->add(ImTableMap::COL_ORDERNO, $this->orderno);
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME3)) {
            $criteria->add(ImTableMap::COL_NAME3, $this->name3);
        }
        if ($this->isColumnModified(ImTableMap::COL_NAME4)) {
            $criteria->add(ImTableMap::COL_NAME4, $this->name4);
        }
        if ($this->isColumnModified(ImTableMap::COL_THUMB)) {
            $criteria->add(ImTableMap::COL_THUMB, $this->thumb);
        }
        if ($this->isColumnModified(ImTableMap::COL_WIDTH)) {
            $criteria->add(ImTableMap::COL_WIDTH, $this->width);
        }
        if ($this->isColumnModified(ImTableMap::COL_HEIGHT)) {
            $criteria->add(ImTableMap::COL_HEIGHT, $this->height);
        }
        if ($this->isColumnModified(ImTableMap::COL_FAMILYDES)) {
            $criteria->add(ImTableMap::COL_FAMILYDES, $this->familydes);
        }
        if ($this->isColumnModified(ImTableMap::COL_KEYWORDS)) {
            $criteria->add(ImTableMap::COL_KEYWORDS, $this->keywords);
        }
        if ($this->isColumnModified(ImTableMap::COL_VPN)) {
            $criteria->add(ImTableMap::COL_VPN, $this->vpn);
        }
        if ($this->isColumnModified(ImTableMap::COL_UOMDESC)) {
            $criteria->add(ImTableMap::COL_UOMDESC, $this->uomdesc);
        }
        if ($this->isColumnModified(ImTableMap::COL_VIDINFFG)) {
            $criteria->add(ImTableMap::COL_VIDINFFG, $this->vidinffg);
        }
        if ($this->isColumnModified(ImTableMap::COL_VIDINFLK)) {
            $criteria->add(ImTableMap::COL_VIDINFLK, $this->vidinflk);
        }
        if ($this->isColumnModified(ImTableMap::COL_ADDITEMFLAG)) {
            $criteria->add(ImTableMap::COL_ADDITEMFLAG, $this->additemflag);
        }
        if ($this->isColumnModified(ImTableMap::COL_SCHEMAFAM)) {
            $criteria->add(ImTableMap::COL_SCHEMAFAM, $this->schemafam);
        }
        if ($this->isColumnModified(ImTableMap::COL_PROP65)) {
            $criteria->add(ImTableMap::COL_PROP65, $this->prop65);
        }
        if ($this->isColumnModified(ImTableMap::COL_LEADFREE)) {
            $criteria->add(ImTableMap::COL_LEADFREE, $this->leadfree);
        }
        if ($this->isColumnModified(ImTableMap::COL_DUMMY)) {
            $criteria->add(ImTableMap::COL_DUMMY, $this->dummy);
        }
     ...
     * objects.
     *
     * @param      object $copyObj An object of \Im (or compatible) type.
     ...
     *
     * @param  boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return \Im Clone of current object.
     * @throws PropelException
     */
    ...
    {
        return (string) $this->exportTo(ImTableMap::DEFAULT_STRING_FORMAT);
    }
