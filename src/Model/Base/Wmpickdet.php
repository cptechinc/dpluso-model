...
abstract class Wmpickdet implements ActiveRecordInterface
{
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false, $indexType = TableMap::TYPE_NUM)
    {
        try {
            ...
            $col = $row[TableMap::TYPE_NUM == $indexType ? 6 + $startcol : WmpickdetTableMap::translateFieldName('Itemnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 7 + $startcol : WmpickdetTableMap::translateFieldName('Itemdesc1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemdesc1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 8 + $startcol : WmpickdetTableMap::translateFieldName('Itemdesc2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->itemdesc2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 9 + $startcol : WmpickdetTableMap::translateFieldName('Qtyordered', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyordered = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 10 + $startcol : WmpickdetTableMap::translateFieldName('Qtypulled', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtypulled = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 11 + $startcol : WmpickdetTableMap::translateFieldName('Qtyremaining', TableMap::TYPE_PHPNAME, $indexType)];
            $this->qtyremaining = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 12 + $startcol : WmpickdetTableMap::translateFieldName('Binnbr', TableMap::TYPE_PHPNAME, $indexType)];
            $this->binnbr = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 13 + $startcol : WmpickdetTableMap::translateFieldName('Caseqty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->caseqty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 14 + $startcol : WmpickdetTableMap::translateFieldName('Innerpack', TableMap::TYPE_PHPNAME, $indexType)];
            $this->innerpack = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 15 + $startcol : WmpickdetTableMap::translateFieldName('Binqty', TableMap::TYPE_PHPNAME, $indexType)];
            $this->binqty = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 16 + $startcol : WmpickdetTableMap::translateFieldName('Overbin1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->overbin1 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 17 + $startcol : WmpickdetTableMap::translateFieldName('Overbinqty1', TableMap::TYPE_PHPNAME, $indexType)];
            $this->overbinqty1 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 18 + $startcol : WmpickdetTableMap::translateFieldName('Overbin2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->overbin2 = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 19 + $startcol : WmpickdetTableMap::translateFieldName('Overbinqty2', TableMap::TYPE_PHPNAME, $indexType)];
            $this->overbinqty2 = (null !== $col) ? (int) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 20 + $startcol : WmpickdetTableMap::translateFieldName('Statusmsg', TableMap::TYPE_PHPNAME, $indexType)];
            $this->statusmsg = (null !== $col) ? (string) $col : null;

            $col = $row[TableMap::TYPE_NUM == $indexType ? 21 + $startcol : WmpickdetTableMap::translateFieldName('Dummy', TableMap::TYPE_PHPNAME, $indexType)];
            ...
            return $startcol + 22; // 22 = WmpickdetTableMap::NUM_HYDRATE_COLUMNS.
