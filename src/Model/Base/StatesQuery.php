 ...
 *
 * @method     ChildStates|null findOne(?ConnectionInterface $con = null) Return the first ChildStates matching the query
 ...
 *
 * @method     ChildStates|null findOneById(int $id) Return the first ChildStates filtered by the id column
 * @method     ChildStates|null findOneByName(string $name) Return the first ChildStates filtered by the name column
 * @method     ChildStates|null findOneByAbbreviation(string $abbreviation) Return the first ChildStates filtered by the abbreviation column
 *
 ...
 *
 * @method     ChildStates[]|Collection find(?ConnectionInterface $con = null) Return ChildStates objects based on current ModelCriteria
 * @psalm-method Collection&\Traversable<ChildStates> find(?ConnectionInterface $con = null) Return ChildStates objects based on current ModelCriteria
 *
 * @method     ChildStates[]|Collection findById(int|array<int> $id) Return ChildStates objects filtered by the id column
 * @psalm-method Collection&\Traversable<ChildStates> findById(int|array<int> $id) Return ChildStates objects filtered by the id column
 * @method     ChildStates[]|Collection findByName(string|array<string> $name) Return ChildStates objects filtered by the name column
 * @psalm-method Collection&\Traversable<ChildStates> findByName(string|array<string> $name) Return ChildStates objects filtered by the name column
 * @method     ChildStates[]|Collection findByAbbreviation(string|array<string> $abbreviation) Return ChildStates objects filtered by the abbreviation column
 * @psalm-method Collection&\Traversable<ChildStates> findByAbbreviation(string|array<string> $abbreviation) Return ChildStates objects filtered by the abbreviation column
 *
 ...
 * @psalm-method \Propel\Runtime\Util\PropelModelPager&\Traversable<ChildStates> paginate($page = 1, $maxPerPage = 10, ?ConnectionInterface $con = null) Issue a SELECT query based on the current ModelCriteria and uses a page and a maximum number of results per page to compute an offset and a limit
 */
abstract class StatesQuery extends ModelCriteria
{
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        $this->addUsingAlias(StatesTableMap::COL_ID, $key, Criteria::EQUAL);
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        $this->addUsingAlias(StatesTableMap::COL_ID, $keys, Criteria::IN);
    ...
    public function filterById($id = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(StatesTableMap::COL_ID, $id, $comparison);
    ...
    public function filterByName($name = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(StatesTableMap::COL_NAME, $name, $comparison);
    ...
    public function filterByAbbreviation($abbreviation = null, ?string $comparison = null)
    {
        ...
        $this->addUsingAlias(StatesTableMap::COL_ABBREVIATION, $abbreviation, $comparison);
