...
class TemplatesTableMap extends TableMap
{
    ...
    /**
     * the column name for the fieldgroups_id field
     */
    const COL_FIELDGROUPS_ID = 'templates.fieldgroups_id';

    /**
     * the column name for the flags field
     */
    const COL_FLAGS = 'templates.flags';

    /**
     * the column name for the cache_time field
     */
    const COL_CACHE_TIME = 'templates.cache_time';

    /**
     * the column name for the data field
     */
    const COL_DATA = 'templates.data';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Id', 'Name', 'FieldgroupsId', 'Flags', 'CacheTime', 'Data', ),
        self::TYPE_CAMELNAME     => array('id', 'name', 'fieldgroupsId', 'flags', 'cacheTime', 'data', ),
        self::TYPE_COLNAME       => array(TemplatesTableMap::COL_ID, TemplatesTableMap::COL_NAME, TemplatesTableMap::COL_FIELDGROUPS_ID, TemplatesTableMap::COL_FLAGS, TemplatesTableMap::COL_CACHE_TIME, TemplatesTableMap::COL_DATA, ),
        self::TYPE_FIELDNAME     => array('id', 'name', 'fieldgroups_id', 'flags', 'cache_time', 'data', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Id' => 0, 'Name' => 1, 'FieldgroupsId' => 2, 'Flags' => 3, 'CacheTime' => 4, 'Data' => 5, ),
        self::TYPE_CAMELNAME     => array('id' => 0, 'name' => 1, 'fieldgroupsId' => 2, 'flags' => 3, 'cacheTime' => 4, 'data' => 5, ),
        self::TYPE_COLNAME       => array(TemplatesTableMap::COL_ID => 0, TemplatesTableMap::COL_NAME => 1, TemplatesTableMap::COL_FIELDGROUPS_ID => 2, TemplatesTableMap::COL_FLAGS => 3, TemplatesTableMap::COL_CACHE_TIME => 4, TemplatesTableMap::COL_DATA => 5, ),
        self::TYPE_FIELDNAME     => array('id' => 0, 'name' => 1, 'fieldgroups_id' => 2, 'flags' => 3, 'cache_time' => 4, 'data' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('fieldgroups_id', 'FieldgroupsId', 'INTEGER', true, 10, 0);
        $this->addColumn('flags', 'Flags', 'INTEGER', true, null, 0);
        $this->addColumn('cache_time', 'CacheTime', 'SMALLINT', true, 9, 0);
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TemplatesTableMap::COL_NAME);
            $criteria->addSelectColumn(TemplatesTableMap::COL_FIELDGROUPS_ID);
            $criteria->addSelectColumn(TemplatesTableMap::COL_FLAGS);
            $criteria->addSelectColumn(TemplatesTableMap::COL_CACHE_TIME);
            $criteria->addSelectColumn(TemplatesTableMap::COL_DATA);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.fieldgroups_id');
