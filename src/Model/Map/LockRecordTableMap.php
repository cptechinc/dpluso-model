...
class LockRecordTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.LockRecordTableMap';
     ...
     */
    public const TABLE_NAME = 'lockrecord';

    /**
     * The PHP name of this class (PascalCase)
     */
    public const TABLE_PHP_NAME = 'LockRecord';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\LockRecord';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'LockRecord';
     ...
     */
    public const COL_FUNCTIONID = 'lockrecord.functionid';

    /**
     * the column name for the keyid field
     */
    public const COL_KEYID = 'lockrecord.keyid';

    /**
     * the column name for the userid field
     */
    public const COL_USERID = 'lockrecord.userid';

    /**
     * the column name for the lockdate field
     */
    public const COL_LOCKDATE = 'lockrecord.lockdate';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Functionid', 'Keyid', 'Userid', 'Lockdate', ],
        self::TYPE_CAMELNAME     => ['functionid', 'keyid', 'userid', 'lockdate', ],
        self::TYPE_COLNAME       => [LockRecordTableMap::COL_FUNCTIONID, LockRecordTableMap::COL_KEYID, LockRecordTableMap::COL_USERID, LockRecordTableMap::COL_LOCKDATE, ],
        self::TYPE_FIELDNAME     => ['functionid', 'keyid', 'userid', 'lockdate', ],
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Functionid' => 0, 'Keyid' => 1, 'Userid' => 2, 'Lockdate' => 3, ],
        self::TYPE_CAMELNAME     => ['functionid' => 0, 'keyid' => 1, 'userid' => 2, 'lockdate' => 3, ],
        self::TYPE_COLNAME       => [LockRecordTableMap::COL_FUNCTIONID => 0, LockRecordTableMap::COL_KEYID => 1, LockRecordTableMap::COL_USERID => 2, LockRecordTableMap::COL_LOCKDATE => 3, ],
        self::TYPE_FIELDNAME     => ['functionid' => 0, 'keyid' => 1, 'userid' => 2, 'lockdate' => 3, ],
        self::TYPE_NUM           => [0, 1, 2, 3, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'LockRecord.Functionid' => 'FUNCTIONID',
        'functionid' => 'FUNCTIONID',
        'lockRecord.functionid' => 'FUNCTIONID',
        'LockRecordTableMap::COL_FUNCTIONID' => 'FUNCTIONID',
        'COL_FUNCTIONID' => 'FUNCTIONID',
        'lockrecord.functionid' => 'FUNCTIONID',
        'Keyid' => 'KEYID',
        'LockRecord.Keyid' => 'KEYID',
        'keyid' => 'KEYID',
        'lockRecord.keyid' => 'KEYID',
        'LockRecordTableMap::COL_KEYID' => 'KEYID',
        'COL_KEYID' => 'KEYID',
        'lockrecord.keyid' => 'KEYID',
        'Userid' => 'USERID',
        ...
        'userid' => 'USERID',
        'lockRecord.userid' => 'USERID',
        'LockRecordTableMap::COL_USERID' => 'USERID',
        'COL_USERID' => 'USERID',
        'lockrecord.userid' => 'USERID',
        'Lockdate' => 'LOCKDATE',
        ...
        'lockdate' => 'LOCKDATE',
        'lockRecord.lockdate' => 'LOCKDATE',
        'LockRecordTableMap::COL_LOCKDATE' => 'LOCKDATE',
     ...
     * @return void
     */
    public static function addInstanceToPool(LockRecord $obj, ?string $key = null): void
    {
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(LockRecordTableMap::COL_FUNCTIONID);
            $criteria->removeSelectColumn(LockRecordTableMap::COL_KEYID);
            $criteria->removeSelectColumn(LockRecordTableMap::COL_USERID);
            $criteria->removeSelectColumn(LockRecordTableMap::COL_LOCKDATE);
        } else {
            $criteria->removeSelectColumn($alias . '.functionid');
            $criteria->removeSelectColumn($alias . '.keyid');
            $criteria->removeSelectColumn($alias . '.userid');
            $criteria->removeSelectColumn($alias . '.lockdate');
        }
    }
