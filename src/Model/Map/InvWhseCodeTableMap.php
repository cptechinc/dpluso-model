 ...
 *
 */
class InvWhseCodeTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.InvWhseCodeTableMap';
     ...
     */
    const OM_CLASS = '\\InvWhseCode';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'InvWhseCode';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(InvWhseCodeTableMap::COL_INTBWHSE, InvWhseCodeTableMap::COL_INTBWHSENAME, InvWhseCodeTableMap::COL_INTBWHSEADR1, InvWhseCodeTableMap::COL_INTBWHSEADR2, InvWhseCodeTableMap::COL_INTBWHSECITY, InvWhseCodeTableMap::COL_INTBWHSESTAT, InvWhseCodeTableMap::COL_INTBWHSEZIPCODE, InvWhseCodeTableMap::COL_INTBWHSECTRY, InvWhseCodeTableMap::COL_INTBWHSEUSEHANDHELD, InvWhseCodeTableMap::COL_INTBWHSECASHCUST, InvWhseCodeTableMap::COL_INTBWHSEPICKDTL, InvWhseCodeTableMap::COL_INTBWHSEPRODBIN, InvWhseCodeTableMap::COL_INTBWHSEPHAREA, InvWhseCodeTableMap::COL_INTBWHSEPHFRST3, InvWhseCodeTableMap::COL_INTBWHSEPHLAST4, InvWhseCodeTableMap::COL_INTBWHSEPHEXT, InvWhseCodeTableMap::COL_INTBWHSEFAXAREA, InvWhseCodeTableMap::COL_INTBWHSEFAXFRST3, InvWhseCodeTableMap::COL_INTBWHSEFAXLAST4, InvWhseCodeTableMap::COL_INTBWHSEEMAILADR, InvWhseCodeTableMap::COL_INTBWHSEQCRGABIN, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER1, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER2, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER3, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER4, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER5, InvWhseCodeTableMap::COL_INTBWHSEPROFWHSE, InvWhseCodeTableMap::COL_INTBWHSEASETWHSE, InvWhseCodeTableMap::COL_INTBWHSECONSIGNWHSE, InvWhseCodeTableMap::COL_INTBWHSEBINRANGELIST, InvWhseCodeTableMap::COL_INTBWHSESUPPLYWHSE, InvWhseCodeTableMap::COL_DATEUPDTD, InvWhseCodeTableMap::COL_TIMEUPDTD, InvWhseCodeTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(InvWhseCodeTableMap::COL_INTBWHSE => 0, InvWhseCodeTableMap::COL_INTBWHSENAME => 1, InvWhseCodeTableMap::COL_INTBWHSEADR1 => 2, InvWhseCodeTableMap::COL_INTBWHSEADR2 => 3, InvWhseCodeTableMap::COL_INTBWHSECITY => 4, InvWhseCodeTableMap::COL_INTBWHSESTAT => 5, InvWhseCodeTableMap::COL_INTBWHSEZIPCODE => 6, InvWhseCodeTableMap::COL_INTBWHSECTRY => 7, InvWhseCodeTableMap::COL_INTBWHSEUSEHANDHELD => 8, InvWhseCodeTableMap::COL_INTBWHSECASHCUST => 9, InvWhseCodeTableMap::COL_INTBWHSEPICKDTL => 10, InvWhseCodeTableMap::COL_INTBWHSEPRODBIN => 11, InvWhseCodeTableMap::COL_INTBWHSEPHAREA => 12, InvWhseCodeTableMap::COL_INTBWHSEPHFRST3 => 13, InvWhseCodeTableMap::COL_INTBWHSEPHLAST4 => 14, InvWhseCodeTableMap::COL_INTBWHSEPHEXT => 15, InvWhseCodeTableMap::COL_INTBWHSEFAXAREA => 16, InvWhseCodeTableMap::COL_INTBWHSEFAXFRST3 => 17, InvWhseCodeTableMap::COL_INTBWHSEFAXLAST4 => 18, InvWhseCodeTableMap::COL_INTBWHSEEMAILADR => 19, InvWhseCodeTableMap::COL_INTBWHSEQCRGABIN => 20, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER1 => 21, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER2 => 22, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER3 => 23, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER4 => 24, InvWhseCodeTableMap::COL_INTBWHSERFPRINTER5 => 25, InvWhseCodeTableMap::COL_INTBWHSEPROFWHSE => 26, InvWhseCodeTableMap::COL_INTBWHSEASETWHSE => 27, InvWhseCodeTableMap::COL_INTBWHSECONSIGNWHSE => 28, InvWhseCodeTableMap::COL_INTBWHSEBINRANGELIST => 29, InvWhseCodeTableMap::COL_INTBWHSESUPPLYWHSE => 30, InvWhseCodeTableMap::COL_DATEUPDTD => 31, InvWhseCodeTableMap::COL_TIMEUPDTD => 32, InvWhseCodeTableMap::COL_DUMMY => 33, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('InvWhseCode');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\InvWhseCode');
        $this->setPackage('');
    ...
    {
        return $withPrefix ? InvWhseCodeTableMap::CLASS_DEFAULT : InvWhseCodeTableMap::OM_CLASS;
    }
     ...
     * @return array           (InvWhseCode object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = InvWhseCodeTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = InvWhseCodeTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + InvWhseCodeTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = InvWhseCodeTableMap::OM_CLASS;
            /** @var InvWhseCode $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            InvWhseCodeTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = InvWhseCodeTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = InvWhseCodeTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSENAME);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEADR1);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEADR2);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSECITY);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSESTAT);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEZIPCODE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSECTRY);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEUSEHANDHELD);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSECASHCUST);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPICKDTL);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPRODBIN);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPHAREA);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPHFRST3);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPHLAST4);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPHEXT);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEFAXAREA);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEFAXFRST3);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEFAXLAST4);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEEMAILADR);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEQCRGABIN);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSERFPRINTER1);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSERFPRINTER2);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSERFPRINTER3);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSERFPRINTER4);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSERFPRINTER5);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEPROFWHSE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEASETWHSE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSECONSIGNWHSE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSEBINRANGELIST);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_INTBWHSESUPPLYWHSE);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_DATEUPDTD);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_TIMEUPDTD);
            $criteria->addSelectColumn(InvWhseCodeTableMap::COL_DUMMY);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(InvWhseCodeTableMap::DATABASE_NAME)->getTable(InvWhseCodeTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(InvWhseCodeTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(InvWhseCodeTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new InvWhseCodeTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a InvWhseCode or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or InvWhseCode object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \InvWhseCode) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(InvWhseCodeTableMap::DATABASE_NAME);
            $criteria->add(InvWhseCodeTableMap::COL_INTBWHSE, (array) $values, Criteria::IN);
        }

        $query = InvWhseCodeQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            InvWhseCodeTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                InvWhseCodeTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return InvWhseCodeQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a InvWhseCode or Criteria object.
     *
     * @param mixed               $criteria Criteria or InvWhseCode object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from InvWhseCode object
        }
...
//
InvWhseCodeTableMap::buildTableMap();
