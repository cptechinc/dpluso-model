...
class CountriesTableMap extends TableMap
{
     ...
     */
    const COL_CCODE = 'countries.ccode';

    /**
     * the column name for the calling_code field
     */
    const COL_CALLING_CODE = 'countries.calling_code';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Name', 'Ccode', 'CallingCode', ),
        self::TYPE_CAMELNAME     => array('name', 'ccode', 'callingCode', ),
        self::TYPE_COLNAME       => array(CountriesTableMap::COL_NAME, CountriesTableMap::COL_CCODE, CountriesTableMap::COL_CALLING_CODE, ),
        self::TYPE_FIELDNAME     => array('name', 'ccode', 'calling_code', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Name' => 0, 'Ccode' => 1, 'CallingCode' => 2, ),
        self::TYPE_CAMELNAME     => array('name' => 0, 'ccode' => 1, 'callingCode' => 2, ),
        self::TYPE_COLNAME       => array(CountriesTableMap::COL_NAME => 0, CountriesTableMap::COL_CCODE => 1, CountriesTableMap::COL_CALLING_CODE => 2, ),
        self::TYPE_FIELDNAME     => array('name' => 0, 'ccode' => 1, 'calling_code' => 2, ),
        self::TYPE_NUM           => array(0, 1, 2, )
    );
