...
class CountriesTableMap extends TableMap
{
     ...
     */
    public const CLASS_NAME = '.Map.CountriesTableMap';
     ...
     */
    public const TABLE_PHP_NAME = 'Countries';

    /**
     * The related Propel class for this table
     */
    public const OM_CLASS = '\\Countries';

    /**
     * A class that can be returned by this tableMap
     */
    public const CLASS_DEFAULT = 'Countries';
     ...
     */
    public const COL_NAME = 'countries.name';

    /**
     * the column name for the ccode field
     */
    public const COL_CCODE = 'countries.ccode';

    /**
     * the column name for the calling_code field
     */
    public const COL_CALLING_CODE = 'countries.calling_code';
    ...
    protected static $fieldNames = [
        self::TYPE_PHPNAME       => ['Name', 'Ccode', 'CallingCode', ],
        self::TYPE_CAMELNAME     => ['name', 'ccode', 'callingCode', ],
        self::TYPE_COLNAME       => [CountriesTableMap::COL_NAME, CountriesTableMap::COL_CCODE, CountriesTableMap::COL_CALLING_CODE, ],
        self::TYPE_FIELDNAME     => ['name', 'ccode', 'calling_code', ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected static $fieldKeys = [
        self::TYPE_PHPNAME       => ['Name' => 0, 'Ccode' => 1, 'CallingCode' => 2, ],
        self::TYPE_CAMELNAME     => ['name' => 0, 'ccode' => 1, 'callingCode' => 2, ],
        self::TYPE_COLNAME       => [CountriesTableMap::COL_NAME => 0, CountriesTableMap::COL_CCODE => 1, CountriesTableMap::COL_CALLING_CODE => 2, ],
        self::TYPE_FIELDNAME     => ['name' => 0, 'ccode' => 1, 'calling_code' => 2, ],
        self::TYPE_NUM           => [0, 1, 2, ]
    ];
    ...
    protected $normalizedColumnNameMap = [
        ...
        'name' => 'NAME',
        'countries.name' => 'NAME',
        'CountriesTableMap::COL_NAME' => 'NAME',
        'COL_NAME' => 'NAME',
        'Ccode' => 'CCODE',
        'Countries.Ccode' => 'CCODE',
        'ccode' => 'CCODE',
        'countries.ccode' => 'CCODE',
        'CountriesTableMap::COL_CCODE' => 'CCODE',
        'COL_CCODE' => 'CCODE',
        'CallingCode' => 'CALLING_CODE',
        'Countries.CallingCode' => 'CALLING_CODE',
        'callingCode' => 'CALLING_CODE',
        'countries.callingCode' => 'CALLING_CODE',
        'CountriesTableMap::COL_CALLING_CODE' => 'CALLING_CODE',
        'COL_CALLING_CODE' => 'CALLING_CODE',
        'calling_code' => 'CALLING_CODE',
        'countries.calling_code' => 'CALLING_CODE',
    ];
    ...
    public function initialize(): void
    {
        ...
        $this->addColumn('ccode', 'Ccode', 'CHAR', true, 3, '""');
        $this->addColumn('calling_code', 'CallingCode', 'VARCHAR', false, 8, null);
    }
    ...
    public static function addSelectColumns(Criteria $criteria, ?string $alias = null): void
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CountriesTableMap::COL_CCODE);
            $criteria->addSelectColumn(CountriesTableMap::COL_CALLING_CODE);
        } else {
            $criteria->addSelectColumn($alias . '.name');
            $criteria->addSelectColumn($alias . '.ccode');
    ...
    {
        if (null === $alias) {
            $criteria->removeSelectColumn(CountriesTableMap::COL_NAME);
            $criteria->removeSelectColumn(CountriesTableMap::COL_CCODE);
            $criteria->removeSelectColumn(CountriesTableMap::COL_CALLING_CODE);
        } else {
            $criteria->removeSelectColumn($alias . '.name');
            $criteria->removeSelectColumn($alias . '.ccode');
            $criteria->removeSelectColumn($alias . '.calling_code');
        }
    }
