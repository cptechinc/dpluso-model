...
/**
 * This class defines the structure of the 'tableformatter' table.
 *
 *
 *
...
class TableformatterTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('Tableformatter');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Tableformatter');
        $this->setPackage('');
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = TableformatterTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + TableformatterTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = TableformatterTableMap::OM_CLASS;
            /** @var Tableformatter $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = TableformatterTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = TableformatterTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(TableformatterTableMap::COL_USER);
            $criteria->addSelectColumn(TableformatterTableMap::COL_FORMATTERTYPE);
            $criteria->addSelectColumn(TableformatterTableMap::COL_DATA);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.user');
            $criteria->addSelectColumn($alias . '.formattertype');
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Tableformatter) { // it's a model object
            // create criteria based on pk values
            $criteria = $values->buildPkeyCriteria();
        } else { // it's a primary key, or an array of pks
            $criteria = new Criteria(TableformatterTableMap::DATABASE_NAME);
            $criteria->add(TableformatterTableMap::COL_ID, (array) $values, Criteria::IN);
        }

        $query = TableformatterQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            TableformatterTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                TableformatterTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from Tableformatter object
        }

        if ($criteria->containsKey(TableformatterTableMap::COL_ID) && $criteria->keyContainsValue(TableformatterTableMap::COL_ID) ) {
