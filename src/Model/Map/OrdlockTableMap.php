...
/**
 * This class defines the structure of the 'ordlock' table.
 *
 *
 *
...
class OrdlockTableMap extends TableMap
{
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('Ordlock');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\Ordlock');
        $this->setPackage('');
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Ordlock) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Ordlock object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if (null !== ($obj = OrdlockTableMap::getInstanceFromPool($key))) {
            ...
            $col = $offset + OrdlockTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = OrdlockTableMap::OM_CLASS;
            /** @var Ordlock $obj */
            $obj = new $cls();
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = OrdlockTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = OrdlockTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(OrdlockTableMap::COL_RECNO);
            $criteria->addSelectColumn(OrdlockTableMap::COL_DATE);
            $criteria->addSelectColumn(OrdlockTableMap::COL_TIME);
            $criteria->addSelectColumn(OrdlockTableMap::COL_ORDERNO);
            $criteria->addSelectColumn(OrdlockTableMap::COL_USERID);
            $criteria->addSelectColumn(OrdlockTableMap::COL_ERRORMSG);
            $criteria->addSelectColumn(OrdlockTableMap::COL_DUMMY);
        } else {
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \Ordlock) { // it's a model object
            ...
            foreach ($values as $value) {
                ...
                $criterion->addAnd($criteria->getNewCriterion(OrdlockTableMap::COL_RECNO, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = OrdlockQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            OrdlockTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                OrdlockTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from Ordlock object
        }
