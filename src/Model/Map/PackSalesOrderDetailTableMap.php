...
use \PackSalesOrderDetail;
use \PackSalesOrderDetailQuery;
 ...
 *
 */
class PackSalesOrderDetailTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PackSalesOrderDetailTableMap';
     ...
     */
    const OM_CLASS = '\\PackSalesOrderDetail';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PackSalesOrderDetail';
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('PackSalesOrderDetail');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\PackSalesOrderDetail');
        $this->setPackage('');
     ...
     * and findPk*() calls.
     *
     * @param \PackSalesOrderDetail $obj A \PackSalesOrderDetail object.
     ...
     *
     * @param mixed $value A \PackSalesOrderDetail object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \PackSalesOrderDetail) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \PackSalesOrderDetail object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? PackSalesOrderDetailTableMap::CLASS_DEFAULT : PackSalesOrderDetailTableMap::OM_CLASS;
    }
     ...
     * @return array           (PackSalesOrderDetail object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = PackSalesOrderDetailTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = PackSalesOrderDetailTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + PackSalesOrderDetailTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PackSalesOrderDetailTableMap::OM_CLASS;
            /** @var PackSalesOrderDetail $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            PackSalesOrderDetailTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = PackSalesOrderDetailTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = PackSalesOrderDetailTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PackSalesOrderDetailTableMap::COL_SESSIONID);
            $criteria->addSelectColumn(PackSalesOrderDetailTableMap::COL_ORDERNBR);
            ...
            $criteria->addSelectColumn(PackSalesOrderDetailTableMap::COL_DATE);
            $criteria->addSelectColumn(PackSalesOrderDetailTableMap::COL_TIME);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(PackSalesOrderDetailTableMap::DATABASE_NAME)->getTable(PackSalesOrderDetailTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(PackSalesOrderDetailTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(PackSalesOrderDetailTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new PackSalesOrderDetailTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a PackSalesOrderDetail or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or PackSalesOrderDetail object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PackSalesOrderDetail) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(PackSalesOrderDetailTableMap::COL_SESSIONID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(PackSalesOrderDetailTableMap::COL_ORDERNBR, $value[1]));
                $criterion->addAnd($criteria->getNewCriterion(PackSalesOrderDetailTableMap::COL_LINENBR, $value[2]));
                $criterion->addAnd($criteria->getNewCriterion(PackSalesOrderDetailTableMap::COL_ITEMID, $value[3]));
                $criterion->addAnd($criteria->getNewCriterion(PackSalesOrderDetailTableMap::COL_LOTSERIAL, $value[4]));
                $criteria->addOr($criterion);
            }
        }

        $query = PackSalesOrderDetailQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            PackSalesOrderDetailTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                PackSalesOrderDetailTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return PackSalesOrderDetailQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a PackSalesOrderDetail or Criteria object.
     *
     * @param mixed               $criteria Criteria or PackSalesOrderDetail object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from PackSalesOrderDetail object
        }
...
//
PackSalesOrderDetailTableMap::buildTableMap();
