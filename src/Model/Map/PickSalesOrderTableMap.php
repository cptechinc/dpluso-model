 ...
 *
 */
class PickSalesOrderTableMap extends TableMap
{
     ...
     */
    const CLASS_NAME = '.Map.PickSalesOrderTableMap';
     ...
     */
    const OM_CLASS = '\\PickSalesOrder';

    /**
     * A class that can be returned by this tableMap
     */
    const CLASS_DEFAULT = 'PickSalesOrder';
    ...
    protected static $fieldNames = array (
        ...
        self::TYPE_COLNAME       => array(PickSalesOrderTableMap::COL_ORDERNBR, PickSalesOrderTableMap::COL_RECNO, PickSalesOrderTableMap::COL_DATE, PickSalesOrderTableMap::COL_TIME, PickSalesOrderTableMap::COL_CUSTOMERID, PickSalesOrderTableMap::COL_CUSTOMERNAME, PickSalesOrderTableMap::COL_STATUSMSG, PickSalesOrderTableMap::COL_LASTPALLETNBR, PickSalesOrderTableMap::COL_FUNCTION, PickSalesOrderTableMap::COL_DUMMY, ),
    ...
    protected static $fieldKeys = array (
        ...
        self::TYPE_COLNAME       => array(PickSalesOrderTableMap::COL_ORDERNBR => 0, PickSalesOrderTableMap::COL_RECNO => 1, PickSalesOrderTableMap::COL_DATE => 2, PickSalesOrderTableMap::COL_TIME => 3, PickSalesOrderTableMap::COL_CUSTOMERID => 4, PickSalesOrderTableMap::COL_CUSTOMERNAME => 5, PickSalesOrderTableMap::COL_STATUSMSG => 6, PickSalesOrderTableMap::COL_LASTPALLETNBR => 7, PickSalesOrderTableMap::COL_FUNCTION => 8, PickSalesOrderTableMap::COL_DUMMY => 9, ),
    ...
    public function initialize()
    {
        ...
        $this->setPhpName('PickSalesOrder');
        $this->setIdentifierQuoting(false);
        $this->setClassName('\\PickSalesOrder');
        $this->setPackage('');
     ...
     * and findPk*() calls.
     *
     * @param \PickSalesOrder $obj A \PickSalesOrder object.
     ...
     *
     * @param mixed $value A \PickSalesOrder object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \PickSalesOrder) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \PickSalesOrder object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        return $withPrefix ? PickSalesOrderTableMap::CLASS_DEFAULT : PickSalesOrderTableMap::OM_CLASS;
    }
     ...
     * @return array           (PickSalesOrder object, last column rank)
     */
    public static function populateObject($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        $key = PickSalesOrderTableMap::getPrimaryKeyHashFromRow($row, $offset, $indexType);
        if (null !== ($obj = PickSalesOrderTableMap::getInstanceFromPool($key))) {
            // We no longer rehydrate the object, since this can cause data loss.
            // See http://www.propelorm.org/ticket/509
            // $obj->hydrate($row, $offset, true); // rehydrate
            $col = $offset + PickSalesOrderTableMap::NUM_HYDRATE_COLUMNS;
        } else {
            $cls = PickSalesOrderTableMap::OM_CLASS;
            /** @var PickSalesOrder $obj */
            $obj = new $cls();
            $col = $obj->hydrate($row, $offset, false, $indexType);
            PickSalesOrderTableMap::addInstanceToPool($obj, $key);
        }
    ...
    public static function populateObjects(DataFetcherInterface $dataFetcher)
    {
        ...
        while ($row = $dataFetcher->fetch()) {
            $key = PickSalesOrderTableMap::getPrimaryKeyHashFromRow($row, 0, $dataFetcher->getIndexType());
            if (null !== ($obj = PickSalesOrderTableMap::getInstanceFromPool($key))) {
                // We no longer rehydrate the object, since this can cause data loss.
                // See http://www.propelorm.org/ticket/509
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_ORDERNBR);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_RECNO);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_DATE);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_TIME);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_CUSTOMERID);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_CUSTOMERNAME);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_STATUSMSG);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_LASTPALLETNBR);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_FUNCTION);
            $criteria->addSelectColumn(PickSalesOrderTableMap::COL_DUMMY);
        } else {
    ...
    {
        return Propel::getServiceContainer()->getDatabaseMap(PickSalesOrderTableMap::DATABASE_NAME)->getTable(PickSalesOrderTableMap::TABLE_NAME);
    }
    ...
    {
        $dbMap = Propel::getServiceContainer()->getDatabaseMap(PickSalesOrderTableMap::DATABASE_NAME);
        if (!$dbMap->hasTable(PickSalesOrderTableMap::TABLE_NAME)) {
            $dbMap->addTableObject(new PickSalesOrderTableMap());
        }
    }

    /**
     * Performs a DELETE on the database, given a PickSalesOrder or Criteria object OR a primary key value.
     *
     * @param mixed               $values Criteria or PickSalesOrder object or primary key or array of primary keys
     ...
     */
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            // rename for clarity
            $criteria = $values;
        } elseif ($values instanceof \PickSalesOrder) { // it's a model object
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(PickSalesOrderTableMap::COL_ORDERNBR, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(PickSalesOrderTableMap::COL_RECNO, $value[1]));
                $criteria->addOr($criterion);
            }
        }

        $query = PickSalesOrderQuery::create()->mergeWith($criteria);

        if ($values instanceof Criteria) {
            PickSalesOrderTableMap::clearInstancePool();
        } elseif (!is_object($values)) { // it's a primary key, or an array of pks
            foreach ((array) $values as $singleval) {
                PickSalesOrderTableMap::removeInstanceFromPool($singleval);
            }
        }
    ...
    {
        return PickSalesOrderQuery::create()->doDeleteAll($con);
    }

    /**
     * Performs an INSERT on the database, given a PickSalesOrder or Criteria object.
     *
     * @param mixed               $criteria Criteria or PickSalesOrder object containing data that is used to create the INSERT statement.
    ...
    public static function doInsert($criteria, ConnectionInterface $con = null)
    {
        ...
        if ($criteria instanceof Criteria) {
            ...
            $criteria = $criteria->buildCriteria(); // build Criteria from PickSalesOrder object
        }
...
} // PickSalesOrderTableMap
// This is the static code needed to register the TableMap for this table with the main Propel class.
//
PickSalesOrderTableMap::buildTableMap();
