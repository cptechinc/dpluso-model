...
class CountryTableMap extends TableMap
{
     ...
     */
    const COL_ISO = 'country.iso';

    /**
     * the column name for the iso2 field
     */
    const COL_ISO2 = 'country.iso2';
     ...
     */
    const COL_NICENAME = 'country.nicename';

    /**
     * the column name for the numcode field
     */
    const COL_NUMCODE = 'country.numcode';

    /**
     * the column name for the phonecode field
     */
    const COL_PHONECODE = 'country.phonecode';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Iso', 'Iso2', 'Name', 'Nicename', 'Numcode', 'Phonecode', ),
        self::TYPE_CAMELNAME     => array('iso', 'iso2', 'name', 'nicename', 'numcode', 'phonecode', ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ISO, CountryTableMap::COL_ISO2, CountryTableMap::COL_NAME, CountryTableMap::COL_NICENAME, CountryTableMap::COL_NUMCODE, CountryTableMap::COL_PHONECODE, ),
        self::TYPE_FIELDNAME     => array('iso', 'iso2', 'name', 'nicename', 'numcode', 'phonecode', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Iso' => 0, 'Iso2' => 1, 'Name' => 2, 'Nicename' => 3, 'Numcode' => 4, 'Phonecode' => 5, ),
        self::TYPE_CAMELNAME     => array('iso' => 0, 'iso2' => 1, 'name' => 2, 'nicename' => 3, 'numcode' => 4, 'phonecode' => 5, ),
        self::TYPE_COLNAME       => array(CountryTableMap::COL_ISO => 0, CountryTableMap::COL_ISO2 => 1, CountryTableMap::COL_NAME => 2, CountryTableMap::COL_NICENAME => 3, CountryTableMap::COL_NUMCODE => 4, CountryTableMap::COL_PHONECODE => 5, ),
        self::TYPE_FIELDNAME     => array('iso' => 0, 'iso2' => 1, 'name' => 2, 'nicename' => 3, 'numcode' => 4, 'phonecode' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
