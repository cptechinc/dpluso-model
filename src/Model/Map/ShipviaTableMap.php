...
/**
 * This class defines the structure of the 'shipvia' table.
 *
 *
 *
...
class ShipviaTableMap extends TableMap
{
     ...
     */
    const COL_SESSIONID = 'shipvia.sessionid';

    /**
     * the column name for the recno field
     */
    const COL_RECNO = 'shipvia.recno';

    /**
     * the column name for the date field
     */
    const COL_DATE = 'shipvia.date';

    /**
     * the column name for the time field
     */
    const COL_TIME = 'shipvia.time';

    /**
     * the column name for the code field
     */
    const COL_CODE = 'shipvia.code';

    /**
     * the column name for the via field
     */
    const COL_VIA = 'shipvia.via';

    /**
     * the column name for the dummy field
     */
    const COL_DUMMY = 'shipvia.dummy';
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Sessionid', 'Recno', 'Date', 'Time', 'Code', 'Via', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('sessionid', 'recno', 'date', 'time', 'code', 'via', 'dummy', ),
        self::TYPE_COLNAME       => array(ShipviaTableMap::COL_SESSIONID, ShipviaTableMap::COL_RECNO, ShipviaTableMap::COL_DATE, ShipviaTableMap::COL_TIME, ShipviaTableMap::COL_CODE, ShipviaTableMap::COL_VIA, ShipviaTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('sessionid', 'recno', 'date', 'time', 'code', 'via', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Sessionid' => 0, 'Recno' => 1, 'Date' => 2, 'Time' => 3, 'Code' => 4, 'Via' => 5, 'Dummy' => 6, ),
        self::TYPE_CAMELNAME     => array('sessionid' => 0, 'recno' => 1, 'date' => 2, 'time' => 3, 'code' => 4, 'via' => 5, 'dummy' => 6, ),
        self::TYPE_COLNAME       => array(ShipviaTableMap::COL_SESSIONID => 0, ShipviaTableMap::COL_RECNO => 1, ShipviaTableMap::COL_DATE => 2, ShipviaTableMap::COL_TIME => 3, ShipviaTableMap::COL_CODE => 4, ShipviaTableMap::COL_VIA => 5, ShipviaTableMap::COL_DUMMY => 6, ),
        self::TYPE_FIELDNAME     => array('sessionid' => 0, 'recno' => 1, 'date' => 2, 'time' => 3, 'code' => 4, 'via' => 5, 'dummy' => 6, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, 6, )
    );
    ...
    public function initialize()
    {
        ...
        $this->addColumn('via', 'Via', 'VARCHAR', false, 30, null);
     ...
     * and findPk*() calls.
     *
     * @param \Shipvia $obj A \Shipvia object.
     ...
     *
     * @param mixed $value A \Shipvia object or a primary key value.
     */
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Shipvia) {
                ...
                $e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or \Shipvia object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value, true)));
                throw $e;
            }
    ...
    {
        if (null === $alias) {
            $criteria->addSelectColumn(ShipviaTableMap::COL_SESSIONID);
            $criteria->addSelectColumn(ShipviaTableMap::COL_RECNO);
            $criteria->addSelectColumn(ShipviaTableMap::COL_DATE);
            $criteria->addSelectColumn(ShipviaTableMap::COL_TIME);
            $criteria->addSelectColumn(ShipviaTableMap::COL_CODE);
            $criteria->addSelectColumn(ShipviaTableMap::COL_VIA);
            ...
            $criteria->addSelectColumn($alias . '.via');
     ...
     public static function doDelete($values, ConnectionInterface $con = null)
     {
        ...
        if ($values instanceof Criteria) {
            ...
            foreach ($values as $value) {
                $criterion = $criteria->getNewCriterion(ShipviaTableMap::COL_SESSIONID, $value[0]);
                $criterion->addAnd($criteria->getNewCriterion(ShipviaTableMap::COL_RECNO, $value[1]));
