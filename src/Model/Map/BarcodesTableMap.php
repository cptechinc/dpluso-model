...
class BarcodesTableMap extends TableMap
{
    ...
    protected static $fieldNames = array (
        self::TYPE_PHPNAME       => array('Barcodenbr', 'Itemid', 'Primary', 'Unitqty', 'Uom', 'Dummy', ),
        self::TYPE_CAMELNAME     => array('barcodenbr', 'itemid', 'primary', 'unitqty', 'uom', 'dummy', ),
        self::TYPE_COLNAME       => array(BarcodesTableMap::COL_BARCODENBR, BarcodesTableMap::COL_ITEMID, BarcodesTableMap::COL_PRIMARY, BarcodesTableMap::COL_UNITQTY, BarcodesTableMap::COL_UOM, BarcodesTableMap::COL_DUMMY, ),
        self::TYPE_FIELDNAME     => array('barcodenbr', 'itemid', 'primary', 'unitqty', 'uom', 'dummy', ),
    ...
    protected static $fieldKeys = array (
        self::TYPE_PHPNAME       => array('Barcodenbr' => 0, 'Itemid' => 1, 'Primary' => 2, 'Unitqty' => 3, 'Uom' => 4, 'Dummy' => 5, ),
        self::TYPE_CAMELNAME     => array('barcodenbr' => 0, 'itemid' => 1, 'primary' => 2, 'unitqty' => 3, 'uom' => 4, 'dummy' => 5, ),
        self::TYPE_COLNAME       => array(BarcodesTableMap::COL_BARCODENBR => 0, BarcodesTableMap::COL_ITEMID => 1, BarcodesTableMap::COL_PRIMARY => 2, BarcodesTableMap::COL_UNITQTY => 3, BarcodesTableMap::COL_UOM => 4, BarcodesTableMap::COL_DUMMY => 5, ),
        self::TYPE_FIELDNAME     => array('barcodenbr' => 0, 'itemid' => 1, 'primary' => 2, 'unitqty' => 3, 'uom' => 4, 'dummy' => 5, ),
        self::TYPE_NUM           => array(0, 1, 2, 3, 4, 5, )
    );
    ...
    public static function addInstanceToPool($obj, $key = null)
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (null === $key) {
                $key = serialize([(null === $obj->getBarcodenbr() || is_scalar($obj->getBarcodenbr()) || is_callable([$obj->getBarcodenbr(), '__toString']) ? (string) $obj->getBarcodenbr() : $obj->getBarcodenbr()), (null === $obj->getItemid() || is_scalar($obj->getItemid()) || is_callable([$obj->getItemid(), '__toString']) ? (string) $obj->getItemid() : $obj->getItemid())]);
            } // if key === null
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && null !== $value) {
            if (is_object($value) && $value instanceof \Barcodes) {
                $key = serialize([(null === $value->getBarcodenbr() || is_scalar($value->getBarcodenbr()) || is_callable([$value->getBarcodenbr(), '__toString']) ? (string) $value->getBarcodenbr() : $value->getBarcodenbr()), (null === $value->getItemid() || is_scalar($value->getItemid()) || is_callable([$value->getItemid(), '__toString']) ? (string) $value->getItemid() : $value->getItemid())]);
    ...
    public static function getPrimaryKeyHashFromRow($row, $offset = 0, $indexType = TableMap::TYPE_NUM)
    {
        ...
        if ($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)] === null && $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)] === null) {
            return null;
        }

        return serialize([(null === $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 0 + $offset : static::translateFieldName('Barcodenbr', TableMap::TYPE_PHPNAME, $indexType)]), (null === $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)] || is_scalar($row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)]) || is_callable([$row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)], '__toString']) ? (string) $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)] : $row[TableMap::TYPE_NUM == $indexType ? 1 + $offset : static::translateFieldName('Itemid', TableMap::TYPE_PHPNAME, $indexType)])]);
    }
