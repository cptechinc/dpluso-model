...
/**
 * This class defines the structure of the 'prntctrl' table.
 *
 *
 *
...
class PrntctrlTableMap extends TableMap
{
     ...
     */
    const COL_ID = 'prntctrl.id';

    /**
     * the column name for the desc field
     */
    const COL_DESC = 'prntctrl.desc';

    /**
     * the column name for the whse field
     */
    const COL_WHSE = 'prntctrl.whse';
    ...
    public function initialize()
    {
        ...
        // columns
        $this->addPrimaryKey('id', 'Id', 'VARCHAR', true, 30, null);
        $this->addColumn('desc', 'Desc', 'VARCHAR', false, 50, null);
        $this->addColumn('whse', 'Whse', 'VARCHAR', false, 6, null);
    } // initialize()
